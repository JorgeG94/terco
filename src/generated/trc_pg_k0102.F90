!
! Class (01|02) cooperative kernel, CUDA Fortran.
!
...
module trc_pg_k0102
   ...
   integer, parameter :: CDC = 1, ABC = 16, NTC = 40

contains

   attributes(global) subroutine pg0102(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(3), jcd(6), kac(1)
      real(dp) :: kad(6), kbc(3), kbd(18)
      real(dp) :: dab(3), dcd(6), dac(1)
      real(dp) :: dad(6), dbc(3), dbd(18)
      ...
      pcut = thresh*1.0e-3_dp
                  ...
                  if (tau <= nabc) then
                     do c = 1, ncdc
                        ...
                        if (combo >= cb0 .and. combo < cb0 + nbt) then
                           do x = 1, 40
                              Gs(x, combo - cb0 + 1) = gown(x + (c - 1)*40)
                           end do
                        end if
                     end do
                  end if
         ...
         ! --- HRR ---
         vbuf(1) = abx*cdx*cdx*g1(1) &
            + 2.0_dp*abx*cdx*g1(5) &
            + abx*g1(17) &
            + cdx*cdx*g1(2) &
            + 2.0_dp*cdx*g1(6) &
            + g1(18)
         vbuf(2) = aby*cdx*cdx*g1(1) &
            + 2.0_dp*aby*cdx*g1(5) &
            + aby*g1(17) &
            + cdx*cdx*g1(3) &
            + 2.0_dp*cdx*g1(7) &
            + g1(19)
         vbuf(3) = abz*cdx*cdx*g1(1) &
            + 2.0_dp*abz*cdx*g1(5) &
            + abz*g1(17) &
            + cdx*cdx*g1(4) &
            + 2.0_dp*cdx*g1(8) &
            + g1(20)
         vbuf(4) = abx*cdx*cdy*g1(1) &
            + abx*cdx*g1(9) &
            + abx*cdy*g1(5) &
            + abx*g1(21) &
            + cdx*cdy*g1(2) &
         ...
         vbuf(9) = abz*cdx*cdz*g1(1) &
            ...
            + cdz*g1(8) &
            + g1(28)
         vbuf(10) = abx*cdy*cdy*g1(1) &
            + 2.0_dp*abx*cdy*g1(9) &
            + abx*g1(29) &
            + cdy*cdy*g1(2) &
            + 2.0_dp*cdy*g1(10) &
            + g1(30)
         vbuf(11) = aby*cdy*cdy*g1(1) &
            + 2.0_dp*aby*cdy*g1(9) &
            + aby*g1(29) &
            + cdy*cdy*g1(3) &
            + 2.0_dp*cdy*g1(11) &
            + g1(31)
         vbuf(12) = abz*cdy*cdy*g1(1) &
            + 2.0_dp*abz*cdy*g1(9) &
            + abz*g1(29) &
            + cdy*cdy*g1(4) &
            + 2.0_dp*cdy*g1(12) &
            + g1(32)
         vbuf(13) = abx*cdy*cdz*g1(1) &
            + abx*cdy*g1(13) &
            + abx*cdz*g1(9) &
            + abx*g1(33) &
            + cdy*cdz*g1(2) &
         ...
         vbuf(15) = abz*cdy*cdz*g1(1) &
            ...
            + cdz*g1(12) &
            + g1(36)
         vbuf(16) = abx*cdz*cdz*g1(1) &
            + 2.0_dp*abx*cdz*g1(13) &
            + abx*g1(37) &
            + cdz*cdz*g1(2) &
            + 2.0_dp*cdz*g1(14) &
            + g1(38)
         vbuf(17) = aby*cdz*cdz*g1(1) &
            + 2.0_dp*aby*cdz*g1(13) &
            + aby*g1(37) &
            + cdz*cdz*g1(3) &
            + 2.0_dp*cdz*g1(15) &
            + g1(39)
         vbuf(18) = abz*cdz*cdz*g1(1) &
   ...
   end subroutine pg0102
#endif
end module trc_pg_k0102
