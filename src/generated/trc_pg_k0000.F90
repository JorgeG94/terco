!
! Class (00|00) cooperative kernel, CUDA Fortran.
!
...
module trc_pg_k0000
   ...
   integer, parameter :: CDC = 4, ABC = 16, NTC = 4

contains

   attributes(global) subroutine pg0000(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
         ...
         do cd0 = 1, nccd, CDC
            ...
            v(1,0) = pref*f(0)
               cur = 0
                        ...
                        tcl(2) = tcl(2) + wcol(2)*v(1, 0)
                        tcl(3) = tcl(3) + wcol(3)*v(1, 0)
                        tcl(4) = tcl(4) + wcol(4)*v(1, 0)
                     end if
                  end do   ! kq0
   ...
   end subroutine pg0000
#endif
end module trc_pg_k0000
