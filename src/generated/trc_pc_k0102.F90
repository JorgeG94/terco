...
contains
   ...
   pure subroutine pci0102(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*cdx*cdx*g(1) &
            + 2.0_dp*abx*cdx*g(5) &
            + abx*g(17) &
            + cdx*cdx*g(2) &
            + 2.0_dp*cdx*g(6) &
            + g(18)
         vbuf(2) = aby*cdx*cdx*g(1) &
            + 2.0_dp*aby*cdx*g(5) &
            + aby*g(17) &
            + cdx*cdx*g(3) &
            + 2.0_dp*cdx*g(7) &
            + g(19)
         vbuf(3) = abz*cdx*cdx*g(1) &
            + 2.0_dp*abz*cdx*g(5) &
            + abz*g(17) &
            + cdx*cdx*g(4) &
            + 2.0_dp*cdx*g(8) &
            + g(20)
         vbuf(4) = abx*cdx*cdy*g(1) &
            + abx*cdx*g(9) &
            + abx*cdy*g(5) &
            + abx*g(21) &
            + cdx*cdy*g(2) &
         ...
         vbuf(9) = abz*cdx*cdz*g(1) &
            ...
            + cdz*g(8) &
            + g(28)
         vbuf(10) = abx*cdy*cdy*g(1) &
            + 2.0_dp*abx*cdy*g(9) &
            + abx*g(29) &
            + cdy*cdy*g(2) &
            + 2.0_dp*cdy*g(10) &
            + g(30)
         vbuf(11) = aby*cdy*cdy*g(1) &
            + 2.0_dp*aby*cdy*g(9) &
            + aby*g(29) &
            + cdy*cdy*g(3) &
            + 2.0_dp*cdy*g(11) &
            + g(31)
         vbuf(12) = abz*cdy*cdy*g(1) &
            + 2.0_dp*abz*cdy*g(9) &
            + abz*g(29) &
            + cdy*cdy*g(4) &
            + 2.0_dp*cdy*g(12) &
            + g(32)
         vbuf(13) = abx*cdy*cdz*g(1) &
            + abx*cdy*g(13) &
            + abx*cdz*g(9) &
            + abx*g(33) &
            + cdy*cdz*g(2) &
         ...
         vbuf(15) = abz*cdy*cdz*g(1) &
            ...
            + cdz*g(12) &
            + g(36)
         vbuf(16) = abx*cdz*cdz*g(1) &
            + 2.0_dp*abx*cdz*g(13) &
            + abx*g(37) &
            + cdz*cdz*g(2) &
            + 2.0_dp*cdz*g(14) &
            + g(38)
         vbuf(17) = aby*cdz*cdz*g(1) &
            + 2.0_dp*aby*cdz*g(13) &
            + aby*g(37) &
            + cdz*cdz*g(3) &
            + 2.0_dp*cdz*g(15) &
            + g(39)
         vbuf(18) = abz*cdz*cdz*g(1) &
            + 2.0_dp*abz*cdz*g(13) &
            + abz*g(37) &
            + cdz*cdz*g(4) &
            + 2.0_dp*cdz*g(16) &
