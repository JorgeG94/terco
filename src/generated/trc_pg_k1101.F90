!
! Class (11|01) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg1101(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(9), jcd(3), kac(3)
      real(dp) :: kad(9), kbc(3), kbd(9)
      real(dp) :: dab(9), dcd(3), dac(3)
      real(dp) :: dad(9), dbc(3), dbd(9)
      ...
      if (gt > gend) return
         ...
         vbuf(9) = abz*cdx*g1(4) &
            ...
            + cdx*g1(10) &
            + g1(20)
         vbuf(10) = abx*cdy*g1(2) &
            + abx*g1(22) &
            + cdy*g1(5) &
            + g1(25)
         vbuf(11) = abx*cdy*g1(3) &
            + abx*g1(23) &
            + cdy*g1(6) &
            + g1(26)
         vbuf(12) = abx*cdy*g1(4) &
            + abx*g1(24) &
            + cdy*g1(7) &
            + g1(27)
         vbuf(13) = aby*cdy*g1(2) &
            + aby*g1(22) &
            + cdy*g1(6) &
            + g1(26)
         vbuf(14) = aby*cdy*g1(3) &
            + aby*g1(23) &
            + cdy*g1(8) &
            + g1(28)
         vbuf(15) = aby*cdy*g1(4) &
            + aby*g1(24) &
            + cdy*g1(9) &
            + g1(29)
         vbuf(16) = abz*cdy*g1(2) &
            + abz*g1(22) &
            + cdy*g1(7) &
            + g1(27)
         vbuf(17) = abz*cdy*g1(3) &
            + abz*g1(23) &
            + cdy*g1(9) &
            + g1(29)
         vbuf(18) = abz*cdy*g1(4) &
            + abz*g1(24) &
            + cdy*g1(10) &
            + g1(30)
         vbuf(19) = abx*cdz*g1(2) &
            + abx*g1(32) &
            + cdz*g1(5) &
            + g1(35)
         vbuf(20) = abx*cdz*g1(3) &
            + abx*g1(33) &
            + cdz*g1(6) &
            + g1(36)
         vbuf(21) = abx*cdz*g1(4) &
            + abx*g1(34) &
            + cdz*g1(7) &
            + g1(37)
         vbuf(22) = aby*cdz*g1(2) &
            + aby*g1(32) &
            + cdz*g1(6) &
            + g1(36)
         vbuf(23) = aby*cdz*g1(3) &
            + aby*g1(33) &
            + cdz*g1(8) &
            + g1(38)
         vbuf(24) = aby*cdz*g1(4) &
            + aby*g1(34) &
            + cdz*g1(9) &
            + g1(39)
         vbuf(25) = abz*cdz*g1(2) &
            + abz*g1(32) &
            + cdz*g1(7) &
            + g1(37)
         vbuf(26) = abz*cdz*g1(3) &
            + abz*g1(33) &
            + cdz*g1(9) &
            + g1(39)
         vbuf(27) = abz*cdz*g1(4) &
            + abz*g1(34) &
            + cdz*g1(10) &
            + g1(40)
   ...
   end subroutine pg1101
#endif
end module trc_pg_k1101
