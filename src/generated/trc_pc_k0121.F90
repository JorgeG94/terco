   ...
   pure subroutine pci0121(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(11) = aby*cdx*g(29) &
            ...
            + cdx*g(31) &
            + g(55)
         vbuf(12) = abz*cdx*g(29) &
            + abz*g(53) &
            + cdx*g(32) &
            + g(56)
         vbuf(13) = abx*cdx*g(33) &
            + abx*g(57) &
            + cdx*g(34) &
            + g(58)
         vbuf(14) = aby*cdx*g(33) &
            + aby*g(57) &
            + cdx*g(35) &
            + g(59)
         vbuf(15) = abz*cdx*g(33) &
            + abz*g(57) &
            + cdx*g(36) &
            + g(60)
         vbuf(16) = abx*cdx*g(37) &
            + abx*g(61) &
            + cdx*g(38) &
            + g(62)
         vbuf(17) = aby*cdx*g(37) &
            + aby*g(61) &
            + cdx*g(39) &
            + g(63)
         vbuf(18) = abz*cdx*g(37) &
            + abz*g(61) &
            + cdx*g(40) &
            + g(64)
         vbuf(19) = abx*cdy*g(17) &
            + abx*g(45) &
            + cdy*g(18) &
            + g(46)
         vbuf(20) = aby*cdy*g(17) &
            + aby*g(45) &
            + cdy*g(19) &
            + g(47)
         vbuf(21) = abz*cdy*g(17) &
            + abz*g(45) &
            + cdy*g(20) &
            + g(48)
         vbuf(22) = abx*cdy*g(21) &
            + abx*g(53) &
            + cdy*g(22) &
            + g(54)
         vbuf(23) = aby*cdy*g(21) &
            + aby*g(53) &
            + cdy*g(23) &
            + g(55)
         vbuf(24) = abz*cdy*g(21) &
            + abz*g(53) &
            + cdy*g(24) &
            + g(56)
         vbuf(25) = abx*cdy*g(25) &
            + abx*g(57) &
            + cdy*g(26) &
            + g(58)
         vbuf(26) = aby*cdy*g(25) &
            + aby*g(57) &
            + cdy*g(27) &
            + g(59)
         vbuf(27) = abz*cdy*g(25) &
            + abz*g(57) &
            + cdy*g(28) &
            + g(60)
         vbuf(28) = abx*cdy*g(29) &
            + abx*g(65) &
            + cdy*g(30) &
            + g(66)
         vbuf(29) = aby*cdy*g(29) &
            + aby*g(65) &
            + cdy*g(31) &
            + g(67)
         vbuf(30) = abz*cdy*g(29) &
            + abz*g(65) &
            + cdy*g(32) &
            + g(68)
         vbuf(31) = abx*cdy*g(33) &
            + abx*g(69) &
            + cdy*g(34) &
            + g(70)
         vbuf(32) = aby*cdy*g(33) &
            + aby*g(69) &
            + cdy*g(35) &
            + g(71)
         vbuf(33) = abz*cdy*g(33) &
            + abz*g(69) &
            + cdy*g(36) &
            + g(72)
         vbuf(34) = abx*cdy*g(37) &
            + abx*g(73) &
            + cdy*g(38) &
            + g(74)
         vbuf(35) = aby*cdy*g(37) &
            + aby*g(73) &
            + cdy*g(39) &
            + g(75)
         vbuf(36) = abz*cdy*g(37) &
            + abz*g(73) &
            + cdy*g(40) &
            + g(76)
         vbuf(37) = abx*cdz*g(17) &
            + abx*g(49) &
            + cdz*g(18) &
            + g(50)
         vbuf(38) = aby*cdz*g(17) &
            + aby*g(49) &
            + cdz*g(19) &
            + g(51)
         vbuf(39) = abz*cdz*g(17) &
            + abz*g(49) &
            + cdz*g(20) &
            + g(52)
         vbuf(40) = abx*cdz*g(21) &
            + abx*g(57) &
            + cdz*g(22) &
            + g(58)
         vbuf(41) = aby*cdz*g(21) &
            + aby*g(57) &
            + cdz*g(23) &
            + g(59)
         vbuf(42) = abz*cdz*g(21) &
            + abz*g(57) &
            + cdz*g(24) &
            + g(60)
         vbuf(43) = abx*cdz*g(25) &
            + abx*g(61) &
            + cdz*g(26) &
            + g(62)
         vbuf(44) = aby*cdz*g(25) &
            + aby*g(61) &
            + cdz*g(27) &
            + g(63)
         vbuf(45) = abz*cdz*g(25) &
            + abz*g(61) &
            + cdz*g(28) &
            + g(64)
         vbuf(46) = abx*cdz*g(29) &
            + abx*g(69) &
            + cdz*g(30) &
            + g(70)
         vbuf(47) = aby*cdz*g(29) &
            + aby*g(69) &
            + cdz*g(31) &
            + g(71)
         vbuf(48) = abz*cdz*g(29) &
            + abz*g(69) &
            + cdz*g(32) &
            + g(72)
         vbuf(49) = abx*cdz*g(33) &
            + abx*g(73) &
            + cdz*g(34) &
            + g(74)
         vbuf(50) = aby*cdz*g(33) &
            + aby*g(73) &
            + cdz*g(35) &
            + g(75)
         vbuf(51) = abz*cdz*g(33) &
            + abz*g(73) &
            + cdz*g(36) &
            + g(76)
         vbuf(52) = abx*cdz*g(37) &
            + abx*g(77) &
            + cdz*g(38) &
            + g(78)
         vbuf(53) = aby*cdz*g(37) &
            + aby*g(77) &
            + cdz*g(39) &
            + g(79)
         vbuf(54) = abz*cdz*g(37) &
            + abz*g(77) &
            + cdz*g(40) &
            + g(80)
