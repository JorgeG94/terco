   ...
   pure subroutine pci0112(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*cdx*cdx*g(5) &
            ...
            + 2.0_dp*cdx*g(18) &
            + g(42)
         vbuf(2) = aby*cdx*cdx*g(5) &
            + 2.0_dp*aby*cdx*g(17) &
            + aby*g(41) &
            + cdx*cdx*g(7) &
            + 2.0_dp*cdx*g(19) &
            + g(43)
         vbuf(3) = abz*cdx*cdx*g(5) &
            + 2.0_dp*abz*cdx*g(17) &
            + abz*g(41) &
            + cdx*cdx*g(8) &
            + 2.0_dp*cdx*g(20) &
            + g(44)
         vbuf(4) = abx*cdx*cdx*g(9) &
            + 2.0_dp*abx*cdx*g(21) &
            + abx*g(45) &
            + cdx*cdx*g(10) &
            + 2.0_dp*cdx*g(22) &
            + g(46)
         vbuf(5) = aby*cdx*cdx*g(9) &
            + 2.0_dp*aby*cdx*g(21) &
            + aby*g(45) &
            + cdx*cdx*g(11) &
            + 2.0_dp*cdx*g(23) &
            + g(47)
         vbuf(6) = abz*cdx*cdx*g(9) &
            + 2.0_dp*abz*cdx*g(21) &
            + abz*g(45) &
            + cdx*cdx*g(12) &
            + 2.0_dp*cdx*g(24) &
            + g(48)
         vbuf(7) = abx*cdx*cdx*g(13) &
            + 2.0_dp*abx*cdx*g(25) &
            + abx*g(49) &
            + cdx*cdx*g(14) &
            + 2.0_dp*cdx*g(26) &
            + g(50)
         vbuf(8) = aby*cdx*cdx*g(13) &
            + 2.0_dp*aby*cdx*g(25) &
            + aby*g(49) &
            + cdx*cdx*g(15) &
            + 2.0_dp*cdx*g(27) &
            + g(51)
         vbuf(9) = abz*cdx*cdx*g(13) &
            + 2.0_dp*abz*cdx*g(25) &
            + abz*g(49) &
            + cdx*cdx*g(16) &
            + 2.0_dp*cdx*g(28) &
            + g(52)
         vbuf(10) = abx*cdx*cdy*g(5) &
            + abx*cdx*g(21) &
            + abx*cdy*g(17) &
            + abx*g(45) &
            + cdx*cdy*g(6) &
         ...
         vbuf(27) = abz*cdx*cdz*g(13) &
            ...
            + cdz*g(28) &
            + g(64)
         vbuf(28) = abx*cdy*cdy*g(5) &
            + 2.0_dp*abx*cdy*g(21) &
            + abx*g(53) &
            + cdy*cdy*g(6) &
            + 2.0_dp*cdy*g(22) &
            + g(54)
         vbuf(29) = aby*cdy*cdy*g(5) &
            + 2.0_dp*aby*cdy*g(21) &
            + aby*g(53) &
            + cdy*cdy*g(7) &
            + 2.0_dp*cdy*g(23) &
            + g(55)
         vbuf(30) = abz*cdy*cdy*g(5) &
            + 2.0_dp*abz*cdy*g(21) &
            + abz*g(53) &
            + cdy*cdy*g(8) &
            + 2.0_dp*cdy*g(24) &
            + g(56)
         vbuf(31) = abx*cdy*cdy*g(9) &
            + 2.0_dp*abx*cdy*g(29) &
            + abx*g(65) &
            + cdy*cdy*g(10) &
            + 2.0_dp*cdy*g(30) &
            + g(66)
         vbuf(32) = aby*cdy*cdy*g(9) &
            + 2.0_dp*aby*cdy*g(29) &
            + aby*g(65) &
            + cdy*cdy*g(11) &
            + 2.0_dp*cdy*g(31) &
            + g(67)
         vbuf(33) = abz*cdy*cdy*g(9) &
            + 2.0_dp*abz*cdy*g(29) &
            + abz*g(65) &
            + cdy*cdy*g(12) &
            + 2.0_dp*cdy*g(32) &
            + g(68)
         vbuf(34) = abx*cdy*cdy*g(13) &
            + 2.0_dp*abx*cdy*g(33) &
            + abx*g(69) &
            + cdy*cdy*g(14) &
            + 2.0_dp*cdy*g(34) &
            + g(70)
         vbuf(35) = aby*cdy*cdy*g(13) &
            + 2.0_dp*aby*cdy*g(33) &
            + aby*g(69) &
            + cdy*cdy*g(15) &
            + 2.0_dp*cdy*g(35) &
            + g(71)
         vbuf(36) = abz*cdy*cdy*g(13) &
            + 2.0_dp*abz*cdy*g(33) &
            + abz*g(69) &
            + cdy*cdy*g(16) &
            + 2.0_dp*cdy*g(36) &
            + g(72)
         vbuf(37) = abx*cdy*cdz*g(5) &
            + abx*cdy*g(25) &
            + abx*cdz*g(21) &
            + abx*g(57) &
            + cdy*cdz*g(6) &
         ...
         vbuf(45) = abz*cdy*cdz*g(13) &
            ...
            + cdz*g(36) &
            + g(76)
         vbuf(46) = abx*cdz*cdz*g(5) &
            + 2.0_dp*abx*cdz*g(25) &
            + abx*g(61) &
            + cdz*cdz*g(6) &
            + 2.0_dp*cdz*g(26) &
            + g(62)
         vbuf(47) = aby*cdz*cdz*g(5) &
            + 2.0_dp*aby*cdz*g(25) &
            + aby*g(61) &
            + cdz*cdz*g(7) &
            + 2.0_dp*cdz*g(27) &
            + g(63)
         vbuf(48) = abz*cdz*cdz*g(5) &
            + 2.0_dp*abz*cdz*g(25) &
            + abz*g(61) &
            + cdz*cdz*g(8) &
            + 2.0_dp*cdz*g(28) &
            + g(64)
         vbuf(49) = abx*cdz*cdz*g(9) &
            + 2.0_dp*abx*cdz*g(33) &
            + abx*g(73) &
            + cdz*cdz*g(10) &
            + 2.0_dp*cdz*g(34) &
            + g(74)
         vbuf(50) = aby*cdz*cdz*g(9) &
            + 2.0_dp*aby*cdz*g(33) &
            + aby*g(73) &
            + cdz*cdz*g(11) &
            + 2.0_dp*cdz*g(35) &
            + g(75)
         vbuf(51) = abz*cdz*cdz*g(9) &
            + 2.0_dp*abz*cdz*g(33) &
            + abz*g(73) &
            + cdz*cdz*g(12) &
            + 2.0_dp*cdz*g(36) &
            + g(76)
         vbuf(52) = abx*cdz*cdz*g(13) &
            + 2.0_dp*abx*cdz*g(37) &
            + abx*g(77) &
            + cdz*cdz*g(14) &
            + 2.0_dp*cdz*g(38) &
            + g(78)
         vbuf(53) = aby*cdz*cdz*g(13) &
            + 2.0_dp*aby*cdz*g(37) &
            + aby*g(77) &
            + cdz*cdz*g(15) &
            + 2.0_dp*cdz*g(39) &
            + g(79)
         vbuf(54) = abz*cdz*cdz*g(13) &
            + 2.0_dp*abz*cdz*g(37) &
            + abz*g(77) &
            + cdz*cdz*g(16) &
            + 2.0_dp*cdz*g(40) &
