!
! Class (12|00) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg1200(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(18), jcd(1), kac(3)
      real(dp) :: kad(3), kbc(6), kbd(6)
      real(dp) :: dab(18), dcd(1), dac(3)
      real(dp) :: dad(3), dbc(6), dbd(6)
      ...
      pcut = thresh*1.0e-3_dp
         ...
         vbuf(9) = abx*abz*g1(4) &
            ...
            + abz*g1(7) &
            + g1(16)
         vbuf(10) = aby*aby*g1(2) &
            + 2.0_dp*aby*g1(6) &
            + g1(14)
         vbuf(11) = aby*aby*g1(3) &
            + 2.0_dp*aby*g1(8) &
            + g1(17)
         vbuf(12) = aby*aby*g1(4) &
            + 2.0_dp*aby*g1(9) &
            + g1(18)
         vbuf(13) = aby*abz*g1(2) &
            + aby*g1(7) &
            + abz*g1(6) &
            + g1(15)
         vbuf(14) = aby*abz*g1(3) &
            + aby*g1(9) &
            + abz*g1(8) &
            + g1(18)
         vbuf(15) = aby*abz*g1(4) &
            + aby*g1(10) &
            + abz*g1(9) &
            + g1(19)
         vbuf(16) = abz*abz*g1(2) &
            + 2.0_dp*abz*g1(7) &
            + g1(16)
         vbuf(17) = abz*abz*g1(3) &
            + 2.0_dp*abz*g1(9) &
            + g1(19)
         vbuf(18) = abz*abz*g1(4) &
            + 2.0_dp*abz*g1(10) &
            + g1(20)
   ...
   end subroutine pg1200
#endif
end module trc_pg_k1200
