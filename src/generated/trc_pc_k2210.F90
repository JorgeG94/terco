...
#endif
   end subroutine pcsi2210

   subroutine pcr2210(lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
                      npair, sp_i, sp_j, sp_q, thresh, pcut, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, &
                      pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, &
                      ndens, dmat, jmat, rank, nranks)
      integer,  intent(in)    :: lo, hi, nseg, npair, nbas, npp, nao
      ...
      do concurrent(i=1:((nr + 31)/32)*32*3)
         ...
         if (it <= nr) then
            call pcri2210(g0 + (it - 1)*nranks, role, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
                          npair, sp_i, sp_j, sp_q, thresh, pcut, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, &
                          pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, ndens, dmat, jmat)
         end if
      end do
   end subroutine pcr2210

   pure subroutine pcri2210(gt, role, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
                      npair, sp_i, sp_j, sp_q, thresh, pcut, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, &
                      pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, &
                      ndens, dmat, jmat)
      !$acc routine seq
      ...
      integer  :: bi, bj, bbase
      real(dp) :: bx, bx2, b0, b1, b2, btt, bet
      real(dp) :: v(56, 0:1), g1(31), vbuf(36)
      real(dp) :: wq, w, wab, cabmax, ccdmax, qchunk
      logical  :: same_ab, same_cd, same_pair
      real(dp) :: jab(36), jcd(3), kac(18)
      real(dp) :: kad(6), kbc(18), kbd(6)
      ...
      ! locate the segment
         ...
         case (1)
            ...
            v(8,0) = paz*v(4,0) + wpz*v(4,1) &
               + 1.0_dp*oo2z*(v(1,0) - rz*v(1,1))
            v(22,0) = qcx*v(4,0) + wqx*v(4,1)
            v(9,0) = pax*v(5,0) + wpx*v(5,1) &
               + 2.0_dp*oo2z*(v(2,0) - rz*v(2,1))
            v(10,0) = pay*v(5,0) + wpy*v(5,1)
            v(11,0) = paz*v(5,0) + wpz*v(5,1)
            ...
            v(16,0) = paz*v(8,0) + wpz*v(8,1) &
               + 2.0_dp*oo2z*(v(4,0) - rz*v(4,1))
            v(23,0) = qcx*v(5,0) + wqx*v(5,1) &
               + 2.0_dp*oo2ze*v(2,1)
            v(24,0) = qcx*v(6,0) + wqx*v(6,1) &
               + 1.0_dp*oo2ze*v(3,1)
            v(25,0) = pax*v(22,0) + wpx*v(22,1) &
               + 1.0_dp*oo2ze*v(4,1)
            v(27,0) = pay*v(22,0) + wpy*v(22,1)
            v(28,0) = qcx*v(8,0) + wqx*v(8,1)
            v(17,0) = pax*v(9,0) + wpx*v(9,1) &
               + 3.0_dp*oo2z*(v(5,0) - rz*v(5,1))
            v(18,0) = pay*v(9,0) + wpy*v(9,1)
            v(19,0) = pax*v(12,0) + wpx*v(12,1) &
               + 1.0_dp*oo2z*(v(7,0) - rz*v(7,1))
            v(20,0) = pay*v(13,0) + wpy*v(13,1) &
               + 3.0_dp*oo2z*(v(7,0) - rz*v(7,1))
            v(21,0) = pay*v(15,0) + wpy*v(15,1) &
               + 1.0_dp*oo2z*(v(8,0) - rz*v(8,1))
            v(31,0) = paz*v(23,0) + wpz*v(23,1)
            v(32,0) = qcx*v(12,0) + wqx*v(12,1) &
               + 1.0_dp*oo2ze*v(7,1)
            v(36,0) = qcx*v(14,0) + wqx*v(14,1)
            v(37,0) = qcx*v(15,0) + wqx*v(15,1)
            v(38,0) = qcx*v(16,0) + wqx*v(16,1)
            v(1,1) = pref*f(0)
            v(2,1) = pax*v(1,1) + wpx*v(1,0)
            v(3,1) = pay*v(1,1) + wpy*v(1,0)
            v(4,1) = paz*v(1,1) + wpz*v(1,0)
            ...
            v(23,1) = qcx*v(5,1) + wqx*v(5,0) &
               + 2.0_dp*oo2ze*v(2,0)
            v(24,1) = qcx*v(6,1) + wqx*v(6,0) &
               + 1.0_dp*oo2ze*v(3,0)
            v(25,1) = pax*v(22,1) + wpx*v(22,0) &
               + 1.0_dp*oo2ze*v(4,0)
            v(26,1) = qcx*v(7,1) + wqx*v(7,0)
            v(27,1) = pay*v(22,1) + wpy*v(22,0)
            v(28,1) = qcx*v(8,1) + wqx*v(8,0)
            v(17,1) = pax*v(9,1) + wpx*v(9,0) &
               + 3.0_dp*oo2z*(v(5,1) - rz*v(5,0))
            v(18,1) = pay*v(9,1) + wpy*v(9,0)
            v(19,1) = pax*v(12,1) + wpx*v(12,0) &
               + 1.0_dp*oo2z*(v(7,1) - rz*v(7,0))
            v(20,1) = pay*v(13,1) + wpy*v(13,0) &
               + 3.0_dp*oo2z*(v(7,1) - rz*v(7,0))
            v(21,1) = paz*v(14,1) + wpz*v(14,0) &
               + 1.0_dp*oo2z*(v(7,1) - rz*v(7,0))
            v(29,1) = qcx*v(9,1) + wqx*v(9,0) &
               + 3.0_dp*oo2ze*v(5,0)
            v(30,1) = pay*v(23,1) + wpy*v(23,0)
            v(31,1) = paz*v(23,1) + wpz*v(23,0)
            v(32,1) = qcx*v(12,1) + wqx*v(12,0) &
               + 1.0_dp*oo2ze*v(7,0)
            v(33,1) = pay*v(25,1) + wpy*v(25,0)
            v(34,1) = pax*v(28,1) + wpx*v(28,0) &
               + 1.0_dp*oo2ze*v(8,0)
            v(35,1) = qcx*v(13,1) + wqx*v(13,0)
            v(36,1) = qcx*v(14,1) + wqx*v(14,0)
            v(37,1) = pay*v(28,1) + wpy*v(28,0)
            v(38,1) = qcx*v(16,1) + wqx*v(16,0)
            v(39,1) = qcx*v(17,1) + wqx*v(17,0) &
               + 4.0_dp*oo2ze*v(9,0)
            v(40,1) = qcx*v(18,1) + wqx*v(18,0) &
               + 3.0_dp*oo2ze*v(10,0)
            v(41,1) = pax*v(31,1) + wpx*v(31,0) &
               + 2.0_dp*oo2z*(v(25,1) - rz*v(25,0)) &
               + 1.0_dp*oo2ze*v(11,0)
            v(42,1) = qcx*v(19,1) + wqx*v(19,0) &
               + 2.0_dp*oo2ze*v(12,0)
            v(43,1) = pay*v(31,1) + wpy*v(31,0)
            v(44,1) = paz*v(31,1) + wpz*v(31,0) &
               + 1.0_dp*oo2z*(v(23,1) - rz*v(23,0))
            v(45,1) = pay*v(32,1) + wpy*v(32,0) &
               + 2.0_dp*oo2z*(v(24,1) - rz*v(24,0))
            v(46,1) = paz*v(32,1) + wpz*v(32,0)
            v(47,1) = pax*v(37,1) + wpx*v(37,0) &
               + 1.0_dp*oo2ze*v(15,0)
            v(48,1) = pax*v(38,1) + wpx*v(38,0) &
               + 1.0_dp*oo2ze*v(16,0)
            v(49,1) = qcx*v(20,1) + wqx*v(20,0)
            v(50,1) = pay*v(36,1) + wpy*v(36,0) &
               + 2.0_dp*oo2z*(v(27,1) - rz*v(27,0))
            v(51,1) = qcx*v(21,1) + wqx*v(21,0)
            v(52,1) = pay*v(38,1) + wpy*v(38,0)
            v(53,1) = paz*v(38,1) + wpz*v(38,0) &
               ...
               cur = 1
                  ...
                  g1(8) = g1(8) + v(30, cur)
                  g1(9) = g1(9) + v(31, cur)
                  g1(10) = g1(10) + v(32, cur)
                  g1(11) = g1(11) + v(33, cur)
                  g1(12) = g1(12) + v(34, cur)
                  g1(13) = g1(13) + v(35, cur)
                  g1(14) = g1(14) + v(36, cur)
                  g1(15) = g1(15) + v(37, cur)
                  g1(16) = g1(16) + v(38, cur)
                  g1(17) = g1(17) + v(39, cur)
                  g1(18) = g1(18) + v(40, cur)
                  g1(19) = g1(19) + v(41, cur)
                  g1(20) = g1(20) + v(42, cur)
                  g1(21) = g1(21) + v(43, cur)
                  g1(22) = g1(22) + v(44, cur)
                  g1(23) = g1(23) + v(45, cur)
                  g1(24) = g1(24) + v(46, cur)
                  g1(25) = g1(25) + v(47, cur)
                  g1(26) = g1(26) + v(48, cur)
                  g1(27) = g1(27) + v(49, cur)
                  g1(28) = g1(28) + v(50, cur)
                  g1(29) = g1(29) + v(51, cur)
                  g1(30) = g1(30) + v(52, cur)
                  g1(31) = g1(31) + v(53, cur)
               end do
            end do
         vbuf(1) = abx*abx*g1(1) &
            + 2.0_dp*abx*g1(7) &
         ...
         case (2)
            ...
            v(11,1) = pax*v(5,1) + wpx*v(5,0) &
               + 2.0_dp*oo2z*(v(2,1) - rz*v(2,0))
            v(14,1) = pax*v(8,1) + wpx*v(8,0)
            v(16,1) = pay*v(8,1) + wpy*v(8,0) &
               + 2.0_dp*oo2z*(v(3,1) - rz*v(3,0))
            v(18,1) = pay*v(10,1) + wpy*v(10,0)
            v(19,1) = paz*v(10,1) + wpz*v(10,0) &
               + 2.0_dp*oo2z*(v(4,1) - rz*v(4,0))
            ...
            v(14,0) = pax*v(8,0) + wpx*v(8,1)
            v(15,0) = pax*v(9,0) + wpx*v(9,1)
            v(16,0) = pay*v(8,0) + wpy*v(8,1) &
               + 2.0_dp*oo2z*(v(3,0) - rz*v(3,1))
            v(17,0) = paz*v(8,0) + wpz*v(8,1)
            v(18,0) = pay*v(10,0) + wpy*v(10,1)
            v(19,0) = paz*v(10,0) + wpz*v(10,1) &
               + 2.0_dp*oo2z*(v(4,0) - rz*v(4,1))
            ...
            v(20,0) = pax*v(11,0) + wpx*v(11,1) &
               + 3.0_dp*oo2z*(v(5,0) - rz*v(5,1))
            v(21,0) = pay*v(11,0) + wpy*v(11,1)
            v(22,0) = pax*v(14,0) + wpx*v(14,1) &
               + 1.0_dp*oo2z*(v(8,0) - rz*v(8,1))
            v(23,0) = pay*v(16,0) + wpy*v(16,1) &
               + 3.0_dp*oo2z*(v(8,0) - rz*v(8,1))
            v(24,0) = pay*v(18,0) + wpy*v(18,1) &
               + 1.0_dp*oo2z*(v(10,0) - rz*v(10,1))
            v(34,0) = pax*v(28,0) + wpx*v(28,1) &
               + 1.0_dp*oo2z*(v(25,0) - rz*v(25,1))
            v(36,0) = pay*v(28,0) + wpy*v(28,1) &
               + 1.0_dp*oo2ze*v(7,1)
            v(38,0) = qcy*v(16,0) + wqy*v(16,1) &
               + 3.0_dp*oo2ze*v(8,1)
            v(41,0) = qcy*v(19,0) + wqy*v(19,1)
            v(1,1) = pref*f(0)
            v(2,1) = pax*v(1,1) + wpx*v(1,0)
            v(3,1) = pay*v(1,1) + wpy*v(1,0)
            v(4,1) = paz*v(1,1) + wpz*v(1,0)
            ...
            v(16,1) = pay*v(8,1) + wpy*v(8,0) &
               + 2.0_dp*oo2z*(v(3,1) - rz*v(3,0))
            v(17,1) = paz*v(8,1) + wpz*v(8,0)
            v(19,1) = paz*v(10,1) + wpz*v(10,0) &
               + 2.0_dp*oo2z*(v(4,1) - rz*v(4,0))
            v(26,1) = qcy*v(5,1) + wqy*v(5,0)
            v(27,1) = qcy*v(6,1) + wqy*v(6,0) &
               + 1.0_dp*oo2ze*v(2,0)
            v(28,1) = pax*v(25,1) + wpx*v(25,0)
            ...
            v(20,1) = pax*v(11,1) + wpx*v(11,0) &
               + 3.0_dp*oo2z*(v(5,1) - rz*v(5,0))
            v(21,1) = pay*v(11,1) + wpy*v(11,0)
            v(22,1) = pax*v(14,1) + wpx*v(14,0) &
               + 1.0_dp*oo2z*(v(8,1) - rz*v(8,0))
            v(23,1) = pay*v(16,1) + wpy*v(16,0) &
               + 3.0_dp*oo2z*(v(8,1) - rz*v(8,0))
            v(24,1) = paz*v(17,1) + wpz*v(17,0) &
               + 1.0_dp*oo2z*(v(8,1) - rz*v(8,0))
            v(32,1) = qcy*v(11,1) + wqy*v(11,0)
            v(33,1) = pay*v(26,1) + wpy*v(26,0) &
               + 1.0_dp*oo2ze*v(5,0)
            v(34,1) = paz*v(26,1) + wpz*v(26,0)
            v(35,1) = qcy*v(14,1) + wqy*v(14,0) &
               + 2.0_dp*oo2ze*v(6,0)
            v(36,1) = paz*v(27,1) + wpz*v(27,0)
            v(37,1) = pax*v(31,1) + wpx*v(31,0)
            v(38,1) = qcy*v(16,1) + wqy*v(16,0) &
               + 3.0_dp*oo2ze*v(8,0)
            v(39,1) = qcy*v(17,1) + wqy*v(17,0) &
               + 2.0_dp*oo2ze*v(9,0)
            v(40,1) = pay*v(31,1) + wpy*v(31,0) &
               + 1.0_dp*oo2ze*v(10,0)
            v(41,1) = qcy*v(19,1) + wqy*v(19,0)
            v(42,1) = qcy*v(20,1) + wqy*v(20,0)
            v(43,1) = qcy*v(21,1) + wqy*v(21,0) &
               + 1.0_dp*oo2ze*v(11,0)
            v(44,1) = pax*v(34,1) + wpx*v(34,0) &
               + 2.0_dp*oo2z*(v(28,1) - rz*v(28,0))
            v(45,1) = qcy*v(22,1) + wqy*v(22,0) &
               + 2.0_dp*oo2ze*v(12,0)
            v(46,1) = pay*v(34,1) + wpy*v(34,0) &
               + 1.0_dp*oo2ze*v(13,0)
            v(47,1) = paz*v(34,1) + wpz*v(34,0) &
               + 1.0_dp*oo2z*(v(26,1) - rz*v(26,0))
            v(48,1) = pax*v(38,1) + wpx*v(38,0)
            v(49,1) = pay*v(36,1) + wpy*v(36,0) &
               + 1.0_dp*oo2z*(v(28,1) - rz*v(28,0)) &
               + 1.0_dp*oo2ze*v(15,0)
            v(50,1) = paz*v(36,1) + wpz*v(36,0) &
               + 1.0_dp*oo2z*(v(27,1) - rz*v(27,0))
            v(51,1) = pax*v(41,1) + wpx*v(41,0)
            v(52,1) = qcy*v(23,1) + wqy*v(23,0) &
               + 4.0_dp*oo2ze*v(16,0)
            v(53,1) = paz*v(38,1) + wpz*v(38,0)
            v(54,1) = qcy*v(24,1) + wqy*v(24,0) &
               + 2.0_dp*oo2ze*v(18,0)
            v(55,1) = pay*v(41,1) + wpy*v(41,0) &
               + 1.0_dp*oo2ze*v(19,0)
            v(56,1) = paz*v(41,1) + wpz*v(41,0) &
               + 3.0_dp*oo2z*(v(31,1) - rz*v(31,0))
               cur = 1
                  g1(1) = g1(1) + v(26, cur)
                  g1(2) = g1(2) + v(27, cur)
                  g1(3) = g1(3) + v(28, cur)
         ...
         case (3)
            ...
            v(9,1) = paz*v(4,1) + wpz*v(4,0) &
               + 1.0_dp*oo2z*(v(1,1) - rz*v(1,0))
            v(22,1) = qcz*v(2,1) + wqz*v(2,0)
            v(10,1) = pax*v(5,1) + wpx*v(5,0) &
               + 2.0_dp*oo2z*(v(2,1) - rz*v(2,0))
            v(13,1) = pax*v(7,1) + wpx*v(7,0)
            ...
            v(12,0) = paz*v(5,0) + wpz*v(5,1)
            v(13,0) = pax*v(7,0) + wpx*v(7,1)
            v(14,0) = pay*v(7,0) + wpy*v(7,1) &
               + 2.0_dp*oo2z*(v(3,0) - rz*v(3,1))
            v(15,0) = paz*v(7,0) + wpz*v(7,1)
            v(16,0) = pay*v(9,0) + wpy*v(9,1)
            v(17,0) = paz*v(9,0) + wpz*v(9,1) &
               + 2.0_dp*oo2z*(v(4,0) - rz*v(4,1))
            v(25,0) = paz*v(22,0) + wpz*v(22,1) &
               + 1.0_dp*oo2ze*v(2,1)
            v(27,0) = qcz*v(8,0) + wqz*v(8,1) &
               + 1.0_dp*oo2ze*v(3,1)
            v(28,0) = qcz*v(9,0) + wqz*v(9,1) &
               + 2.0_dp*oo2ze*v(4,1)
            v(18,0) = pax*v(10,0) + wpx*v(10,1) &
               + 3.0_dp*oo2z*(v(5,0) - rz*v(5,1))
            v(19,0) = pax*v(13,0) + wpx*v(13,1) &
               + 1.0_dp*oo2z*(v(7,0) - rz*v(7,1))
            v(20,0) = pay*v(14,0) + wpy*v(14,1) &
               + 3.0_dp*oo2z*(v(7,0) - rz*v(7,1))
            v(21,0) = pay*v(16,0) + wpy*v(16,1) &
               + 1.0_dp*oo2z*(v(9,0) - rz*v(9,1))
            v(29,0) = qcz*v(10,0) + wqz*v(10,1)
            v(33,0) = pay*v(25,0) + wpy*v(25,1)
            v(34,0) = paz*v(25,0) + wpz*v(25,1) &
               + 1.0_dp*oo2z*(v(22,0) - rz*v(22,1)) &
               + 1.0_dp*oo2ze*v(6,1)
            v(35,0) = qcz*v(14,0) + wqz*v(14,1)
            v(38,0) = qcz*v(17,0) + wqz*v(17,1) &
               + 3.0_dp*oo2ze*v(9,1)
            v(1,1) = pref*f(0)
            v(2,1) = pax*v(1,1) + wpx*v(1,0)
            v(3,1) = pay*v(1,1) + wpy*v(1,0)
            ...
            v(12,1) = paz*v(5,1) + wpz*v(5,0)
            v(13,1) = pax*v(7,1) + wpx*v(7,0)
            v(14,1) = pay*v(7,1) + wpy*v(7,0) &
               + 2.0_dp*oo2z*(v(3,1) - rz*v(3,0))
            v(15,1) = paz*v(7,1) + wpz*v(7,0)
            v(17,1) = paz*v(9,1) + wpz*v(9,0) &
               + 2.0_dp*oo2z*(v(4,1) - rz*v(4,0))
            v(23,1) = qcz*v(5,1) + wqz*v(5,0)
            v(24,1) = pay*v(22,1) + wpy*v(22,0)
            v(25,1) = paz*v(22,1) + wpz*v(22,0) &
               + 1.0_dp*oo2ze*v(2,0)
            v(26,1) = qcz*v(7,1) + wqz*v(7,0)
            v(27,1) = qcz*v(8,1) + wqz*v(8,0) &
               + 1.0_dp*oo2ze*v(3,0)
            v(28,1) = qcz*v(9,1) + wqz*v(9,0) &
               + 2.0_dp*oo2ze*v(4,0)
            v(18,1) = pax*v(10,1) + wpx*v(10,0) &
               + 3.0_dp*oo2z*(v(5,1) - rz*v(5,0))
            v(19,1) = pax*v(13,1) + wpx*v(13,0) &
               + 1.0_dp*oo2z*(v(7,1) - rz*v(7,0))
            v(20,1) = pay*v(14,1) + wpy*v(14,0) &
               + 3.0_dp*oo2z*(v(7,1) - rz*v(7,0))
            v(21,1) = paz*v(15,1) + wpz*v(15,0) &
               + 1.0_dp*oo2z*(v(7,1) - rz*v(7,0))
            v(29,1) = qcz*v(10,1) + wqz*v(10,0)
            v(30,1) = qcz*v(11,1) + wqz*v(11,0)
            v(31,1) = qcz*v(12,1) + wqz*v(12,0) &
               + 1.0_dp*oo2ze*v(5,0)
            v(32,1) = qcz*v(13,1) + wqz*v(13,0)
            v(33,1) = pax*v(27,1) + wpx*v(27,0)
            v(34,1) = pax*v(28,1) + wpx*v(28,0)
            v(35,1) = qcz*v(14,1) + wqz*v(14,0)
            v(36,1) = qcz*v(15,1) + wqz*v(15,0) &
               + 1.0_dp*oo2ze*v(7,0)
            v(37,1) = pay*v(28,1) + wpy*v(28,0)
            v(38,1) = qcz*v(17,1) + wqz*v(17,0) &
               + 3.0_dp*oo2ze*v(9,0)
            v(39,1) = qcz*v(18,1) + wqz*v(18,0)
            v(40,1) = pay*v(29,1) + wpy*v(29,0)
            v(41,1) = paz*v(29,1) + wpz*v(29,0) &
               + 1.0_dp*oo2ze*v(10,0)
            v(42,1) = qcz*v(19,1) + wqz*v(19,0)
            v(43,1) = pax*v(33,1) + wpx*v(33,0) &
               + 1.0_dp*oo2z*(v(27,1) - rz*v(27,0))
            v(44,1) = pax*v(34,1) + wpx*v(34,0) &
               + 1.0_dp*oo2z*(v(28,1) - rz*v(28,0))
            v(45,1) = pax*v(35,1) + wpx*v(35,0)
            v(46,1) = pay*v(33,1) + wpy*v(33,0) &
               + 1.0_dp*oo2z*(v(25,1) - rz*v(25,0))
            v(47,1) = pay*v(34,1) + wpy*v(34,0)
            v(48,1) = pax*v(38,1) + wpx*v(38,0)
            v(49,1) = qcz*v(20,1) + wqz*v(20,0)
            v(50,1) = paz*v(35,1) + wpz*v(35,0) &
               + 1.0_dp*oo2ze*v(14,0)
            v(51,1) = qcz*v(21,1) + wqz*v(21,0) &
               + 2.0_dp*oo2ze*v(15,0)
            v(52,1) = pay*v(38,1) + wpy*v(38,0)
            v(53,1) = paz*v(38,1) + wpz*v(38,0) &
               + 3.0_dp*oo2z*(v(28,1) - rz*v(28,0)) &
