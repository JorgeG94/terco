...
contains
   ...
   pure subroutine pci0201(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*g(1) &
            + abx*abx*g(11) &
            + 2.0_dp*abx*cdx*g(2) &
            + 2.0_dp*abx*g(12) &
            + cdx*g(5) &
            + g(15)
         vbuf(2) = abx*aby*cdx*g(1) &
            + abx*aby*g(11) &
            + abx*cdx*g(3) &
            + abx*g(13) &
            + aby*cdx*g(2) &
         ...
         vbuf(3) = abx*abz*cdx*g(1) &
            ...
            + cdx*g(7) &
            + g(17)
         vbuf(4) = aby*aby*cdx*g(1) &
            + aby*aby*g(11) &
            + 2.0_dp*aby*cdx*g(3) &
            + 2.0_dp*aby*g(13) &
            + cdx*g(8) &
            + g(18)
         vbuf(5) = aby*abz*cdx*g(1) &
            + aby*abz*g(11) &
            + aby*cdx*g(4) &
            + aby*g(14) &
            + abz*cdx*g(3) &
            ...
            + cdx*g(9) &
            + g(19)
         vbuf(6) = abz*abz*cdx*g(1) &
            + abz*abz*g(11) &
            + 2.0_dp*abz*cdx*g(4) &
            + 2.0_dp*abz*g(14) &
            + cdx*g(10) &
            + g(20)
         vbuf(7) = abx*abx*cdy*g(1) &
            + abx*abx*g(21) &
            + 2.0_dp*abx*cdy*g(2) &
            + 2.0_dp*abx*g(22) &
            + cdy*g(5) &
            + g(25)
         vbuf(8) = abx*aby*cdy*g(1) &
            + abx*aby*g(21) &
            + abx*cdy*g(3) &
            + abx*g(23) &
            + aby*cdy*g(2) &
         ...
         vbuf(9) = abx*abz*cdy*g(1) &
            ...
            + cdy*g(7) &
            + g(27)
         vbuf(10) = aby*aby*cdy*g(1) &
            + aby*aby*g(21) &
            + 2.0_dp*aby*cdy*g(3) &
            + 2.0_dp*aby*g(23) &
            + cdy*g(8) &
            + g(28)
         vbuf(11) = aby*abz*cdy*g(1) &
            + aby*abz*g(21) &
            + aby*cdy*g(4) &
            + aby*g(24) &
            + abz*cdy*g(3) &
            ...
            + cdy*g(9) &
            + g(29)
         vbuf(12) = abz*abz*cdy*g(1) &
            + abz*abz*g(21) &
            + 2.0_dp*abz*cdy*g(4) &
            + 2.0_dp*abz*g(24) &
            + cdy*g(10) &
            + g(30)
         vbuf(13) = abx*abx*cdz*g(1) &
            + abx*abx*g(31) &
            + 2.0_dp*abx*cdz*g(2) &
            + 2.0_dp*abx*g(32) &
            + cdz*g(5) &
            + g(35)
         vbuf(14) = abx*aby*cdz*g(1) &
            + abx*aby*g(31) &
            + abx*cdz*g(3) &
            + abx*g(33) &
            + aby*cdz*g(2) &
         ...
         vbuf(15) = abx*abz*cdz*g(1) &
            ...
            + cdz*g(7) &
            + g(37)
         vbuf(16) = aby*aby*cdz*g(1) &
            + aby*aby*g(31) &
            + 2.0_dp*aby*cdz*g(3) &
            + 2.0_dp*aby*g(33) &
            + cdz*g(8) &
            + g(38)
         vbuf(17) = aby*abz*cdz*g(1) &
            + aby*abz*g(31) &
            + aby*cdz*g(4) &
            + aby*g(34) &
            + abz*cdz*g(3) &
