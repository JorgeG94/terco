...
contains
   ...
   pure subroutine pci1202(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*cdx*g(2) &
            + 2.0_dp*abx*abx*cdx*g(22) &
            + abx*abx*g(82) &
            + 2.0_dp*abx*cdx*cdx*g(5) &
            + 4.0_dp*abx*cdx*g(25) &
            + 2.0_dp*abx*g(85) &
            + cdx*cdx*g(11) &
            + 2.0_dp*cdx*g(31) &
            + g(91)
         vbuf(2) = abx*abx*cdx*cdx*g(3) &
            + 2.0_dp*abx*abx*cdx*g(23) &
            + abx*abx*g(83) &
            + 2.0_dp*abx*cdx*cdx*g(6) &
            + 4.0_dp*abx*cdx*g(26) &
            + 2.0_dp*abx*g(86) &
            + cdx*cdx*g(12) &
            + 2.0_dp*cdx*g(32) &
            + g(92)
         vbuf(3) = abx*abx*cdx*cdx*g(4) &
            + 2.0_dp*abx*abx*cdx*g(24) &
            + abx*abx*g(84) &
            + 2.0_dp*abx*cdx*cdx*g(7) &
            + 4.0_dp*abx*cdx*g(27) &
            + 2.0_dp*abx*g(87) &
            + cdx*cdx*g(13) &
            + 2.0_dp*cdx*g(33) &
            + g(93)
         vbuf(4) = abx*aby*cdx*cdx*g(2) &
            + 2.0_dp*abx*aby*cdx*g(22) &
            + abx*aby*g(82) &
            + abx*cdx*cdx*g(6) &
            + 2.0_dp*abx*cdx*g(26) &
            + abx*g(86) &
            ...
            + 2.0_dp*cdx*g(32) &
            + g(92)
         vbuf(5) = abx*aby*cdx*cdx*g(3) &
            + 2.0_dp*abx*aby*cdx*g(23) &
            + abx*aby*g(83) &
            + abx*cdx*cdx*g(8) &
            + 2.0_dp*abx*cdx*g(28) &
            + abx*g(88) &
            ...
            + 2.0_dp*cdx*g(34) &
            + g(94)
         vbuf(6) = abx*aby*cdx*cdx*g(4) &
            + 2.0_dp*abx*aby*cdx*g(24) &
            + abx*aby*g(84) &
            + abx*cdx*cdx*g(9) &
            + 2.0_dp*abx*cdx*g(29) &
            + abx*g(89) &
            ...
            + 2.0_dp*cdx*g(35) &
            + g(95)
         vbuf(7) = abx*abz*cdx*cdx*g(2) &
            + 2.0_dp*abx*abz*cdx*g(22) &
            + abx*abz*g(82) &
            + abx*cdx*cdx*g(7) &
            + 2.0_dp*abx*cdx*g(27) &
            + abx*g(87) &
            ...
            + 2.0_dp*cdx*g(33) &
            + g(93)
         vbuf(8) = abx*abz*cdx*cdx*g(3) &
            + 2.0_dp*abx*abz*cdx*g(23) &
            + abx*abz*g(83) &
            + abx*cdx*cdx*g(9) &
            + 2.0_dp*abx*cdx*g(29) &
            + abx*g(89) &
            ...
            + 2.0_dp*cdx*g(35) &
            + g(95)
         vbuf(9) = abx*abz*cdx*cdx*g(4) &
            + 2.0_dp*abx*abz*cdx*g(24) &
            + abx*abz*g(84) &
            + abx*cdx*cdx*g(10) &
            + 2.0_dp*abx*cdx*g(30) &
            + abx*g(90) &
            ...
            + 2.0_dp*cdx*g(36) &
            + g(96)
         vbuf(10) = aby*aby*cdx*cdx*g(2) &
            + 2.0_dp*aby*aby*cdx*g(22) &
            + aby*aby*g(82) &
            + 2.0_dp*aby*cdx*cdx*g(6) &
            + 4.0_dp*aby*cdx*g(26) &
            + 2.0_dp*aby*g(86) &
            + cdx*cdx*g(14) &
            + 2.0_dp*cdx*g(34) &
            + g(94)
         vbuf(11) = aby*aby*cdx*cdx*g(3) &
            + 2.0_dp*aby*aby*cdx*g(23) &
            + aby*aby*g(83) &
            + 2.0_dp*aby*cdx*cdx*g(8) &
            + 4.0_dp*aby*cdx*g(28) &
            + 2.0_dp*aby*g(88) &
            + cdx*cdx*g(17) &
            + 2.0_dp*cdx*g(37) &
            + g(97)
         vbuf(12) = aby*aby*cdx*cdx*g(4) &
            + 2.0_dp*aby*aby*cdx*g(24) &
            + aby*aby*g(84) &
            + 2.0_dp*aby*cdx*cdx*g(9) &
            + 4.0_dp*aby*cdx*g(29) &
            + 2.0_dp*aby*g(89) &
            + cdx*cdx*g(18) &
            + 2.0_dp*cdx*g(38) &
            + g(98)
         vbuf(13) = aby*abz*cdx*cdx*g(2) &
            + 2.0_dp*aby*abz*cdx*g(22) &
            + aby*abz*g(82) &
            + aby*cdx*cdx*g(7) &
            + 2.0_dp*aby*cdx*g(27) &
            + aby*g(87) &
            ...
            + 2.0_dp*cdx*g(35) &
            + g(95)
         vbuf(14) = aby*abz*cdx*cdx*g(3) &
            + 2.0_dp*aby*abz*cdx*g(23) &
            + aby*abz*g(83) &
            + aby*cdx*cdx*g(9) &
            + 2.0_dp*aby*cdx*g(29) &
            + aby*g(89) &
            ...
            + 2.0_dp*cdx*g(38) &
            + g(98)
         vbuf(15) = aby*abz*cdx*cdx*g(4) &
            + 2.0_dp*aby*abz*cdx*g(24) &
            + aby*abz*g(84) &
            + aby*cdx*cdx*g(10) &
            + 2.0_dp*aby*cdx*g(30) &
            + aby*g(90) &
            ...
            + 2.0_dp*cdx*g(39) &
            + g(99)
         vbuf(16) = abz*abz*cdx*cdx*g(2) &
            + 2.0_dp*abz*abz*cdx*g(22) &
            + abz*abz*g(82) &
            + 2.0_dp*abz*cdx*cdx*g(7) &
            + 4.0_dp*abz*cdx*g(27) &
            + 2.0_dp*abz*g(87) &
            + cdx*cdx*g(16) &
            + 2.0_dp*cdx*g(36) &
            + g(96)
         vbuf(17) = abz*abz*cdx*cdx*g(3) &
            + 2.0_dp*abz*abz*cdx*g(23) &
            + abz*abz*g(83) &
            + 2.0_dp*abz*cdx*cdx*g(9) &
            + 4.0_dp*abz*cdx*g(29) &
            + 2.0_dp*abz*g(89) &
            + cdx*cdx*g(19) &
            + 2.0_dp*cdx*g(39) &
            + g(99)
         vbuf(18) = abz*abz*cdx*cdx*g(4) &
            + 2.0_dp*abz*abz*cdx*g(24) &
            + abz*abz*g(84) &
            + 2.0_dp*abz*cdx*cdx*g(10) &
            + 4.0_dp*abz*cdx*g(30) &
            + 2.0_dp*abz*g(90) &
            + cdx*cdx*g(20) &
            + 2.0_dp*cdx*g(40) &
            + g(100)
         vbuf(19) = abx*abx*cdx*cdy*g(2) &
            + abx*abx*cdx*g(42) &
            + abx*abx*cdy*g(22) &
            + abx*abx*g(102) &
            + 2.0_dp*abx*cdx*cdy*g(5) &
            + 2.0_dp*abx*cdx*g(45) &
            + 2.0_dp*abx*cdy*g(25) &
            + 2.0_dp*abx*g(105) &
            + cdx*cdy*g(11) &
            ...
            + cdy*g(31) &
            + g(111)
         vbuf(20) = abx*abx*cdx*cdy*g(3) &
            + abx*abx*cdx*g(43) &
            + abx*abx*cdy*g(23) &
            + abx*abx*g(103) &
            + 2.0_dp*abx*cdx*cdy*g(6) &
            + 2.0_dp*abx*cdx*g(46) &
            + 2.0_dp*abx*cdy*g(26) &
            + 2.0_dp*abx*g(106) &
            + cdx*cdy*g(12) &
            ...
            + cdy*g(32) &
            + g(112)
         vbuf(21) = abx*abx*cdx*cdy*g(4) &
            + abx*abx*cdx*g(44) &
            + abx*abx*cdy*g(24) &
            + abx*abx*g(104) &
            + 2.0_dp*abx*cdx*cdy*g(7) &
            + 2.0_dp*abx*cdx*g(47) &
            + 2.0_dp*abx*cdy*g(27) &
            + 2.0_dp*abx*g(107) &
            + cdx*cdy*g(13) &
         ...
         vbuf(27) = abx*abz*cdx*cdy*g(4) &
            ...
            + cdy*g(36) &
            + g(116)
         vbuf(28) = aby*aby*cdx*cdy*g(2) &
            + aby*aby*cdx*g(42) &
            + aby*aby*cdy*g(22) &
            + aby*aby*g(102) &
            + 2.0_dp*aby*cdx*cdy*g(6) &
            + 2.0_dp*aby*cdx*g(46) &
            + 2.0_dp*aby*cdy*g(26) &
            + 2.0_dp*aby*g(106) &
            + cdx*cdy*g(14) &
            ...
            + cdy*g(34) &
            + g(114)
         vbuf(29) = aby*aby*cdx*cdy*g(3) &
            + aby*aby*cdx*g(43) &
            + aby*aby*cdy*g(23) &
            + aby*aby*g(103) &
            + 2.0_dp*aby*cdx*cdy*g(8) &
            + 2.0_dp*aby*cdx*g(48) &
            + 2.0_dp*aby*cdy*g(28) &
            + 2.0_dp*aby*g(108) &
            + cdx*cdy*g(17) &
            ...
            + cdy*g(37) &
            + g(117)
         vbuf(30) = aby*aby*cdx*cdy*g(4) &
            + aby*aby*cdx*g(44) &
            + aby*aby*cdy*g(24) &
            + aby*aby*g(104) &
            + 2.0_dp*aby*cdx*cdy*g(9) &
            + 2.0_dp*aby*cdx*g(49) &
            + 2.0_dp*aby*cdy*g(29) &
            + 2.0_dp*aby*g(109) &
            + cdx*cdy*g(18) &
         ...
         vbuf(33) = aby*abz*cdx*cdy*g(4) &
            ...
            + cdy*g(39) &
            + g(119)
         vbuf(34) = abz*abz*cdx*cdy*g(2) &
            + abz*abz*cdx*g(42) &
            + abz*abz*cdy*g(22) &
            + abz*abz*g(102) &
            + 2.0_dp*abz*cdx*cdy*g(7) &
            + 2.0_dp*abz*cdx*g(47) &
            + 2.0_dp*abz*cdy*g(27) &
            + 2.0_dp*abz*g(107) &
            + cdx*cdy*g(16) &
            ...
            + cdy*g(36) &
            + g(116)
         vbuf(35) = abz*abz*cdx*cdy*g(3) &
            + abz*abz*cdx*g(43) &
            + abz*abz*cdy*g(23) &
            + abz*abz*g(103) &
            + 2.0_dp*abz*cdx*cdy*g(9) &
            + 2.0_dp*abz*cdx*g(49) &
            + 2.0_dp*abz*cdy*g(29) &
            + 2.0_dp*abz*g(109) &
            + cdx*cdy*g(19) &
            ...
            + cdy*g(39) &
            + g(119)
         vbuf(36) = abz*abz*cdx*cdy*g(4) &
            + abz*abz*cdx*g(44) &
            + abz*abz*cdy*g(24) &
            + abz*abz*g(104) &
            + 2.0_dp*abz*cdx*cdy*g(10) &
            + 2.0_dp*abz*cdx*g(50) &
            + 2.0_dp*abz*cdy*g(30) &
            + 2.0_dp*abz*g(110) &
            + cdx*cdy*g(20) &
            ...
            + cdy*g(40) &
            + g(120)
         vbuf(37) = abx*abx*cdx*cdz*g(2) &
            + abx*abx*cdx*g(62) &
            + abx*abx*cdz*g(22) &
            + abx*abx*g(122) &
            + 2.0_dp*abx*cdx*cdz*g(5) &
            + 2.0_dp*abx*cdx*g(65) &
            + 2.0_dp*abx*cdz*g(25) &
            + 2.0_dp*abx*g(125) &
            + cdx*cdz*g(11) &
            ...
            + cdz*g(31) &
            + g(131)
         vbuf(38) = abx*abx*cdx*cdz*g(3) &
            + abx*abx*cdx*g(63) &
            + abx*abx*cdz*g(23) &
            + abx*abx*g(123) &
            + 2.0_dp*abx*cdx*cdz*g(6) &
            + 2.0_dp*abx*cdx*g(66) &
            + 2.0_dp*abx*cdz*g(26) &
            + 2.0_dp*abx*g(126) &
            + cdx*cdz*g(12) &
            ...
            + cdz*g(32) &
            + g(132)
         vbuf(39) = abx*abx*cdx*cdz*g(4) &
            + abx*abx*cdx*g(64) &
            + abx*abx*cdz*g(24) &
            + abx*abx*g(124) &
            + 2.0_dp*abx*cdx*cdz*g(7) &
            + 2.0_dp*abx*cdx*g(67) &
            + 2.0_dp*abx*cdz*g(27) &
            + 2.0_dp*abx*g(127) &
            + cdx*cdz*g(13) &
         ...
         vbuf(45) = abx*abz*cdx*cdz*g(4) &
            ...
            + cdz*g(36) &
            + g(136)
         vbuf(46) = aby*aby*cdx*cdz*g(2) &
            + aby*aby*cdx*g(62) &
            + aby*aby*cdz*g(22) &
            + aby*aby*g(122) &
            + 2.0_dp*aby*cdx*cdz*g(6) &
            + 2.0_dp*aby*cdx*g(66) &
            + 2.0_dp*aby*cdz*g(26) &
            + 2.0_dp*aby*g(126) &
            + cdx*cdz*g(14) &
            ...
            + cdz*g(34) &
            + g(134)
         vbuf(47) = aby*aby*cdx*cdz*g(3) &
            + aby*aby*cdx*g(63) &
            + aby*aby*cdz*g(23) &
            + aby*aby*g(123) &
            + 2.0_dp*aby*cdx*cdz*g(8) &
            + 2.0_dp*aby*cdx*g(68) &
            + 2.0_dp*aby*cdz*g(28) &
            + 2.0_dp*aby*g(128) &
            + cdx*cdz*g(17) &
            ...
            + cdz*g(37) &
            + g(137)
         vbuf(48) = aby*aby*cdx*cdz*g(4) &
            + aby*aby*cdx*g(64) &
            + aby*aby*cdz*g(24) &
            + aby*aby*g(124) &
            + 2.0_dp*aby*cdx*cdz*g(9) &
            + 2.0_dp*aby*cdx*g(69) &
            + 2.0_dp*aby*cdz*g(29) &
            + 2.0_dp*aby*g(129) &
            + cdx*cdz*g(18) &
         ...
         vbuf(51) = aby*abz*cdx*cdz*g(4) &
            ...
            + cdz*g(39) &
            + g(139)
         vbuf(52) = abz*abz*cdx*cdz*g(2) &
            + abz*abz*cdx*g(62) &
            + abz*abz*cdz*g(22) &
            + abz*abz*g(122) &
            + 2.0_dp*abz*cdx*cdz*g(7) &
            + 2.0_dp*abz*cdx*g(67) &
            + 2.0_dp*abz*cdz*g(27) &
            + 2.0_dp*abz*g(127) &
            + cdx*cdz*g(16) &
            ...
            + cdz*g(36) &
            + g(136)
         vbuf(53) = abz*abz*cdx*cdz*g(3) &
            + abz*abz*cdx*g(63) &
            + abz*abz*cdz*g(23) &
            + abz*abz*g(123) &
            + 2.0_dp*abz*cdx*cdz*g(9) &
            + 2.0_dp*abz*cdx*g(69) &
            + 2.0_dp*abz*cdz*g(29) &
            + 2.0_dp*abz*g(129) &
            + cdx*cdz*g(19) &
            ...
            + cdz*g(39) &
            + g(139)
         vbuf(54) = abz*abz*cdx*cdz*g(4) &
            + abz*abz*cdx*g(64) &
            + abz*abz*cdz*g(24) &
            + abz*abz*g(124) &
            + 2.0_dp*abz*cdx*cdz*g(10) &
            + 2.0_dp*abz*cdx*g(70) &
            + 2.0_dp*abz*cdz*g(30) &
            + 2.0_dp*abz*g(130) &
            + cdx*cdz*g(20) &
            ...
            + cdz*g(40) &
            + g(140)
         vbuf(55) = abx*abx*cdy*cdy*g(2) &
            + 2.0_dp*abx*abx*cdy*g(42) &
            + abx*abx*g(142) &
            + 2.0_dp*abx*cdy*cdy*g(5) &
            + 4.0_dp*abx*cdy*g(45) &
            + 2.0_dp*abx*g(145) &
            + cdy*cdy*g(11) &
            + 2.0_dp*cdy*g(51) &
            + g(151)
         vbuf(56) = abx*abx*cdy*cdy*g(3) &
            + 2.0_dp*abx*abx*cdy*g(43) &
            + abx*abx*g(143) &
            + 2.0_dp*abx*cdy*cdy*g(6) &
            + 4.0_dp*abx*cdy*g(46) &
            + 2.0_dp*abx*g(146) &
            + cdy*cdy*g(12) &
            + 2.0_dp*cdy*g(52) &
            + g(152)
         vbuf(57) = abx*abx*cdy*cdy*g(4) &
            + 2.0_dp*abx*abx*cdy*g(44) &
            + abx*abx*g(144) &
            + 2.0_dp*abx*cdy*cdy*g(7) &
            + 4.0_dp*abx*cdy*g(47) &
            + 2.0_dp*abx*g(147) &
            + cdy*cdy*g(13) &
            + 2.0_dp*cdy*g(53) &
            + g(153)
         vbuf(58) = abx*aby*cdy*cdy*g(2) &
            + 2.0_dp*abx*aby*cdy*g(42) &
            + abx*aby*g(142) &
            + abx*cdy*cdy*g(6) &
            + 2.0_dp*abx*cdy*g(46) &
            + abx*g(146) &
            ...
            + 2.0_dp*cdy*g(52) &
            + g(152)
         vbuf(59) = abx*aby*cdy*cdy*g(3) &
            + 2.0_dp*abx*aby*cdy*g(43) &
            + abx*aby*g(143) &
            + abx*cdy*cdy*g(8) &
            + 2.0_dp*abx*cdy*g(48) &
            + abx*g(148) &
            ...
            + 2.0_dp*cdy*g(54) &
            + g(154)
         vbuf(60) = abx*aby*cdy*cdy*g(4) &
            + 2.0_dp*abx*aby*cdy*g(44) &
            + abx*aby*g(144) &
            + abx*cdy*cdy*g(9) &
            + 2.0_dp*abx*cdy*g(49) &
            + abx*g(149) &
            ...
            + 2.0_dp*cdy*g(55) &
            + g(155)
         vbuf(61) = abx*abz*cdy*cdy*g(2) &
            + 2.0_dp*abx*abz*cdy*g(42) &
            + abx*abz*g(142) &
            + abx*cdy*cdy*g(7) &
            + 2.0_dp*abx*cdy*g(47) &
            + abx*g(147) &
            ...
            + 2.0_dp*cdy*g(53) &
            + g(153)
         vbuf(62) = abx*abz*cdy*cdy*g(3) &
            + 2.0_dp*abx*abz*cdy*g(43) &
            + abx*abz*g(143) &
            + abx*cdy*cdy*g(9) &
            + 2.0_dp*abx*cdy*g(49) &
            + abx*g(149) &
            ...
            + 2.0_dp*cdy*g(55) &
            + g(155)
         vbuf(63) = abx*abz*cdy*cdy*g(4) &
            + 2.0_dp*abx*abz*cdy*g(44) &
            + abx*abz*g(144) &
            + abx*cdy*cdy*g(10) &
            + 2.0_dp*abx*cdy*g(50) &
            + abx*g(150) &
            ...
            + 2.0_dp*cdy*g(56) &
            + g(156)
         vbuf(64) = aby*aby*cdy*cdy*g(2) &
            + 2.0_dp*aby*aby*cdy*g(42) &
            + aby*aby*g(142) &
            + 2.0_dp*aby*cdy*cdy*g(6) &
            + 4.0_dp*aby*cdy*g(46) &
            + 2.0_dp*aby*g(146) &
            + cdy*cdy*g(14) &
            + 2.0_dp*cdy*g(54) &
            + g(154)
         vbuf(65) = aby*aby*cdy*cdy*g(3) &
            + 2.0_dp*aby*aby*cdy*g(43) &
            + aby*aby*g(143) &
            + 2.0_dp*aby*cdy*cdy*g(8) &
            + 4.0_dp*aby*cdy*g(48) &
            + 2.0_dp*aby*g(148) &
            + cdy*cdy*g(17) &
            + 2.0_dp*cdy*g(57) &
            + g(157)
         vbuf(66) = aby*aby*cdy*cdy*g(4) &
            + 2.0_dp*aby*aby*cdy*g(44) &
            + aby*aby*g(144) &
            + 2.0_dp*aby*cdy*cdy*g(9) &
            + 4.0_dp*aby*cdy*g(49) &
            + 2.0_dp*aby*g(149) &
            + cdy*cdy*g(18) &
            + 2.0_dp*cdy*g(58) &
            + g(158)
         vbuf(67) = aby*abz*cdy*cdy*g(2) &
            + 2.0_dp*aby*abz*cdy*g(42) &
            + aby*abz*g(142) &
            + aby*cdy*cdy*g(7) &
            + 2.0_dp*aby*cdy*g(47) &
            + aby*g(147) &
            ...
            + 2.0_dp*cdy*g(55) &
            + g(155)
         vbuf(68) = aby*abz*cdy*cdy*g(3) &
            + 2.0_dp*aby*abz*cdy*g(43) &
            + aby*abz*g(143) &
            + aby*cdy*cdy*g(9) &
            + 2.0_dp*aby*cdy*g(49) &
            + aby*g(149) &
            ...
            + 2.0_dp*cdy*g(58) &
            + g(158)
         vbuf(69) = aby*abz*cdy*cdy*g(4) &
            + 2.0_dp*aby*abz*cdy*g(44) &
            + aby*abz*g(144) &
            + aby*cdy*cdy*g(10) &
            + 2.0_dp*aby*cdy*g(50) &
            + aby*g(150) &
            ...
            + 2.0_dp*cdy*g(59) &
            + g(159)
         vbuf(70) = abz*abz*cdy*cdy*g(2) &
            + 2.0_dp*abz*abz*cdy*g(42) &
            + abz*abz*g(142) &
            + 2.0_dp*abz*cdy*cdy*g(7) &
            + 4.0_dp*abz*cdy*g(47) &
            + 2.0_dp*abz*g(147) &
            + cdy*cdy*g(16) &
            + 2.0_dp*cdy*g(56) &
            + g(156)
         vbuf(71) = abz*abz*cdy*cdy*g(3) &
            + 2.0_dp*abz*abz*cdy*g(43) &
            + abz*abz*g(143) &
            + 2.0_dp*abz*cdy*cdy*g(9) &
            + 4.0_dp*abz*cdy*g(49) &
            + 2.0_dp*abz*g(149) &
            + cdy*cdy*g(19) &
            + 2.0_dp*cdy*g(59) &
            + g(159)
         vbuf(72) = abz*abz*cdy*cdy*g(4) &
            + 2.0_dp*abz*abz*cdy*g(44) &
            + abz*abz*g(144) &
            + 2.0_dp*abz*cdy*cdy*g(10) &
            + 4.0_dp*abz*cdy*g(50) &
            + 2.0_dp*abz*g(150) &
            + cdy*cdy*g(20) &
            + 2.0_dp*cdy*g(60) &
            + g(160)
         vbuf(73) = abx*abx*cdy*cdz*g(2) &
            + abx*abx*cdy*g(62) &
            + abx*abx*cdz*g(42) &
            + abx*abx*g(162) &
            + 2.0_dp*abx*cdy*cdz*g(5) &
            + 2.0_dp*abx*cdy*g(65) &
            + 2.0_dp*abx*cdz*g(45) &
            + 2.0_dp*abx*g(165) &
            + cdy*cdz*g(11) &
            ...
            + cdz*g(51) &
            + g(171)
         vbuf(74) = abx*abx*cdy*cdz*g(3) &
            + abx*abx*cdy*g(63) &
            + abx*abx*cdz*g(43) &
            + abx*abx*g(163) &
            + 2.0_dp*abx*cdy*cdz*g(6) &
            + 2.0_dp*abx*cdy*g(66) &
            + 2.0_dp*abx*cdz*g(46) &
            + 2.0_dp*abx*g(166) &
            + cdy*cdz*g(12) &
            ...
            + cdz*g(52) &
            + g(172)
         vbuf(75) = abx*abx*cdy*cdz*g(4) &
            + abx*abx*cdy*g(64) &
            + abx*abx*cdz*g(44) &
            + abx*abx*g(164) &
            + 2.0_dp*abx*cdy*cdz*g(7) &
            + 2.0_dp*abx*cdy*g(67) &
            + 2.0_dp*abx*cdz*g(47) &
            + 2.0_dp*abx*g(167) &
            + cdy*cdz*g(13) &
         ...
         vbuf(81) = abx*abz*cdy*cdz*g(4) &
            ...
            + cdz*g(56) &
            + g(176)
         vbuf(82) = aby*aby*cdy*cdz*g(2) &
            + aby*aby*cdy*g(62) &
            + aby*aby*cdz*g(42) &
            + aby*aby*g(162) &
            + 2.0_dp*aby*cdy*cdz*g(6) &
            + 2.0_dp*aby*cdy*g(66) &
            + 2.0_dp*aby*cdz*g(46) &
            + 2.0_dp*aby*g(166) &
            + cdy*cdz*g(14) &
            ...
            + cdz*g(54) &
            + g(174)
         vbuf(83) = aby*aby*cdy*cdz*g(3) &
            + aby*aby*cdy*g(63) &
            + aby*aby*cdz*g(43) &
            + aby*aby*g(163) &
            + 2.0_dp*aby*cdy*cdz*g(8) &
            + 2.0_dp*aby*cdy*g(68) &
            + 2.0_dp*aby*cdz*g(48) &
            + 2.0_dp*aby*g(168) &
            + cdy*cdz*g(17) &
            ...
            + cdz*g(57) &
            + g(177)
         vbuf(84) = aby*aby*cdy*cdz*g(4) &
            + aby*aby*cdy*g(64) &
            + aby*aby*cdz*g(44) &
            + aby*aby*g(164) &
            + 2.0_dp*aby*cdy*cdz*g(9) &
            + 2.0_dp*aby*cdy*g(69) &
            + 2.0_dp*aby*cdz*g(49) &
            + 2.0_dp*aby*g(169) &
            + cdy*cdz*g(18) &
         ...
         vbuf(87) = aby*abz*cdy*cdz*g(4) &
            ...
            + cdz*g(59) &
            + g(179)
         vbuf(88) = abz*abz*cdy*cdz*g(2) &
            + abz*abz*cdy*g(62) &
            + abz*abz*cdz*g(42) &
            + abz*abz*g(162) &
            + 2.0_dp*abz*cdy*cdz*g(7) &
            + 2.0_dp*abz*cdy*g(67) &
            + 2.0_dp*abz*cdz*g(47) &
            + 2.0_dp*abz*g(167) &
            + cdy*cdz*g(16) &
            ...
            + cdz*g(56) &
            + g(176)
         vbuf(89) = abz*abz*cdy*cdz*g(3) &
            + abz*abz*cdy*g(63) &
            + abz*abz*cdz*g(43) &
            + abz*abz*g(163) &
            + 2.0_dp*abz*cdy*cdz*g(9) &
            + 2.0_dp*abz*cdy*g(69) &
            + 2.0_dp*abz*cdz*g(49) &
            + 2.0_dp*abz*g(169) &
            + cdy*cdz*g(19) &
            ...
            + cdz*g(59) &
            + g(179)
         vbuf(90) = abz*abz*cdy*cdz*g(4) &
            + abz*abz*cdy*g(64) &
            + abz*abz*cdz*g(44) &
            + abz*abz*g(164) &
            + 2.0_dp*abz*cdy*cdz*g(10) &
            + 2.0_dp*abz*cdy*g(70) &
            + 2.0_dp*abz*cdz*g(50) &
            + 2.0_dp*abz*g(170) &
            + cdy*cdz*g(20) &
            ...
            + cdz*g(60) &
            + g(180)
         vbuf(91) = abx*abx*cdz*cdz*g(2) &
            + 2.0_dp*abx*abx*cdz*g(62) &
            + abx*abx*g(182) &
            + 2.0_dp*abx*cdz*cdz*g(5) &
            + 4.0_dp*abx*cdz*g(65) &
            + 2.0_dp*abx*g(185) &
            + cdz*cdz*g(11) &
            + 2.0_dp*cdz*g(71) &
            + g(191)
         vbuf(92) = abx*abx*cdz*cdz*g(3) &
            + 2.0_dp*abx*abx*cdz*g(63) &
            + abx*abx*g(183) &
            + 2.0_dp*abx*cdz*cdz*g(6) &
            + 4.0_dp*abx*cdz*g(66) &
            + 2.0_dp*abx*g(186) &
            + cdz*cdz*g(12) &
            + 2.0_dp*cdz*g(72) &
            + g(192)
         vbuf(93) = abx*abx*cdz*cdz*g(4) &
            + 2.0_dp*abx*abx*cdz*g(64) &
            + abx*abx*g(184) &
            + 2.0_dp*abx*cdz*cdz*g(7) &
            + 4.0_dp*abx*cdz*g(67) &
            + 2.0_dp*abx*g(187) &
            + cdz*cdz*g(13) &
            + 2.0_dp*cdz*g(73) &
            + g(193)
         vbuf(94) = abx*aby*cdz*cdz*g(2) &
            + 2.0_dp*abx*aby*cdz*g(62) &
            + abx*aby*g(182) &
            + abx*cdz*cdz*g(6) &
            + 2.0_dp*abx*cdz*g(66) &
            + abx*g(186) &
            ...
            + 2.0_dp*cdz*g(72) &
            + g(192)
         vbuf(95) = abx*aby*cdz*cdz*g(3) &
            + 2.0_dp*abx*aby*cdz*g(63) &
            + abx*aby*g(183) &
            + abx*cdz*cdz*g(8) &
            + 2.0_dp*abx*cdz*g(68) &
            + abx*g(188) &
            ...
            + 2.0_dp*cdz*g(74) &
            + g(194)
         vbuf(96) = abx*aby*cdz*cdz*g(4) &
            + 2.0_dp*abx*aby*cdz*g(64) &
            + abx*aby*g(184) &
            + abx*cdz*cdz*g(9) &
            + 2.0_dp*abx*cdz*g(69) &
            + abx*g(189) &
            ...
            + 2.0_dp*cdz*g(75) &
            + g(195)
         vbuf(97) = abx*abz*cdz*cdz*g(2) &
            + 2.0_dp*abx*abz*cdz*g(62) &
            + abx*abz*g(182) &
            + abx*cdz*cdz*g(7) &
            + 2.0_dp*abx*cdz*g(67) &
            + abx*g(187) &
            ...
            + 2.0_dp*cdz*g(73) &
            + g(193)
         vbuf(98) = abx*abz*cdz*cdz*g(3) &
            + 2.0_dp*abx*abz*cdz*g(63) &
            + abx*abz*g(183) &
            + abx*cdz*cdz*g(9) &
            + 2.0_dp*abx*cdz*g(69) &
            + abx*g(189) &
            ...
            + 2.0_dp*cdz*g(75) &
            + g(195)
         vbuf(99) = abx*abz*cdz*cdz*g(4) &
            + 2.0_dp*abx*abz*cdz*g(64) &
            + abx*abz*g(184) &
            + abx*cdz*cdz*g(10) &
            + 2.0_dp*abx*cdz*g(70) &
            + abx*g(190) &
            ...
            + 2.0_dp*cdz*g(76) &
            + g(196)
         vbuf(100) = aby*aby*cdz*cdz*g(2) &
            + 2.0_dp*aby*aby*cdz*g(62) &
            + aby*aby*g(182) &
            + 2.0_dp*aby*cdz*cdz*g(6) &
            + 4.0_dp*aby*cdz*g(66) &
            + 2.0_dp*aby*g(186) &
            + cdz*cdz*g(14) &
            + 2.0_dp*cdz*g(74) &
            + g(194)
         vbuf(101) = aby*aby*cdz*cdz*g(3) &
            + 2.0_dp*aby*aby*cdz*g(63) &
            + aby*aby*g(183) &
            + 2.0_dp*aby*cdz*cdz*g(8) &
            + 4.0_dp*aby*cdz*g(68) &
            + 2.0_dp*aby*g(188) &
            + cdz*cdz*g(17) &
            + 2.0_dp*cdz*g(77) &
            + g(197)
         vbuf(102) = aby*aby*cdz*cdz*g(4) &
            + 2.0_dp*aby*aby*cdz*g(64) &
            + aby*aby*g(184) &
            + 2.0_dp*aby*cdz*cdz*g(9) &
            + 4.0_dp*aby*cdz*g(69) &
            + 2.0_dp*aby*g(189) &
            + cdz*cdz*g(18) &
            + 2.0_dp*cdz*g(78) &
            + g(198)
         vbuf(103) = aby*abz*cdz*cdz*g(2) &
            + 2.0_dp*aby*abz*cdz*g(62) &
            + aby*abz*g(182) &
            + aby*cdz*cdz*g(7) &
            + 2.0_dp*aby*cdz*g(67) &
            + aby*g(187) &
            ...
            + 2.0_dp*cdz*g(75) &
            + g(195)
         vbuf(104) = aby*abz*cdz*cdz*g(3) &
            + 2.0_dp*aby*abz*cdz*g(63) &
            + aby*abz*g(183) &
            + aby*cdz*cdz*g(9) &
            + 2.0_dp*aby*cdz*g(69) &
            + aby*g(189) &
            ...
            + 2.0_dp*cdz*g(78) &
            + g(198)
         vbuf(105) = aby*abz*cdz*cdz*g(4) &
            + 2.0_dp*aby*abz*cdz*g(64) &
            + aby*abz*g(184) &
            + aby*cdz*cdz*g(10) &
            + 2.0_dp*aby*cdz*g(70) &
            + aby*g(190) &
            ...
            + 2.0_dp*cdz*g(79) &
            + g(199)
         vbuf(106) = abz*abz*cdz*cdz*g(2) &
            + 2.0_dp*abz*abz*cdz*g(62) &
            + abz*abz*g(182) &
            + 2.0_dp*abz*cdz*cdz*g(7) &
            + 4.0_dp*abz*cdz*g(67) &
            + 2.0_dp*abz*g(187) &
            + cdz*cdz*g(16) &
            + 2.0_dp*cdz*g(76) &
            + g(196)
         vbuf(107) = abz*abz*cdz*cdz*g(3) &
            + 2.0_dp*abz*abz*cdz*g(63) &
            + abz*abz*g(183) &
            + 2.0_dp*abz*cdz*cdz*g(9) &
            + 4.0_dp*abz*cdz*g(69) &
            + 2.0_dp*abz*g(189) &
            + cdz*cdz*g(19) &
            + 2.0_dp*cdz*g(79) &
            + g(199)
         vbuf(108) = abz*abz*cdz*cdz*g(4) &
            + 2.0_dp*abz*abz*cdz*g(64) &
            + abz*abz*g(184) &
            + 2.0_dp*abz*cdz*cdz*g(10) &
            + 4.0_dp*abz*cdz*g(70) &
            + 2.0_dp*abz*g(190) &
            + cdz*cdz*g(20) &
            + 2.0_dp*cdz*g(80) &
