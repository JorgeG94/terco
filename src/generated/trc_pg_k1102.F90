!
! Class (11|02) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg1102(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      pcut = thresh*1.0e-3_dp
         ...
         ! --- HRR ---
         vbuf(1) = abx*cdx*cdx*g1(2) &
            + 2.0_dp*abx*cdx*g1(12) &
            + abx*g1(42) &
            + cdx*cdx*g1(5) &
            + 2.0_dp*cdx*g1(15) &
            + g1(45)
         vbuf(2) = abx*cdx*cdx*g1(3) &
            + 2.0_dp*abx*cdx*g1(13) &
            + abx*g1(43) &
            + cdx*cdx*g1(6) &
            + 2.0_dp*cdx*g1(16) &
            + g1(46)
         vbuf(3) = abx*cdx*cdx*g1(4) &
            + 2.0_dp*abx*cdx*g1(14) &
            + abx*g1(44) &
            + cdx*cdx*g1(7) &
            + 2.0_dp*cdx*g1(17) &
            + g1(47)
         vbuf(4) = aby*cdx*cdx*g1(2) &
            + 2.0_dp*aby*cdx*g1(12) &
            + aby*g1(42) &
            + cdx*cdx*g1(6) &
            + 2.0_dp*cdx*g1(16) &
            + g1(46)
         vbuf(5) = aby*cdx*cdx*g1(3) &
            + 2.0_dp*aby*cdx*g1(13) &
            + aby*g1(43) &
            + cdx*cdx*g1(8) &
            + 2.0_dp*cdx*g1(18) &
            + g1(48)
         vbuf(6) = aby*cdx*cdx*g1(4) &
            + 2.0_dp*aby*cdx*g1(14) &
            + aby*g1(44) &
            + cdx*cdx*g1(9) &
            + 2.0_dp*cdx*g1(19) &
            + g1(49)
         vbuf(7) = abz*cdx*cdx*g1(2) &
            + 2.0_dp*abz*cdx*g1(12) &
            + abz*g1(42) &
            + cdx*cdx*g1(7) &
            + 2.0_dp*cdx*g1(17) &
            + g1(47)
         vbuf(8) = abz*cdx*cdx*g1(3) &
            + 2.0_dp*abz*cdx*g1(13) &
            + abz*g1(43) &
            + cdx*cdx*g1(9) &
            + 2.0_dp*cdx*g1(19) &
            + g1(49)
         vbuf(9) = abz*cdx*cdx*g1(4) &
            + 2.0_dp*abz*cdx*g1(14) &
            + abz*g1(44) &
            + cdx*cdx*g1(10) &
            + 2.0_dp*cdx*g1(20) &
            + g1(50)
         vbuf(10) = abx*cdx*cdy*g1(2) &
            + abx*cdx*g1(22) &
            + abx*cdy*g1(12) &
            + abx*g1(52) &
            + cdx*cdy*g1(5) &
         ...
         vbuf(27) = abz*cdx*cdz*g1(4) &
            ...
            + cdz*g1(20) &
            + g1(70)
         vbuf(28) = abx*cdy*cdy*g1(2) &
            + 2.0_dp*abx*cdy*g1(22) &
            + abx*g1(72) &
            + cdy*cdy*g1(5) &
            + 2.0_dp*cdy*g1(25) &
            + g1(75)
         vbuf(29) = abx*cdy*cdy*g1(3) &
            + 2.0_dp*abx*cdy*g1(23) &
            + abx*g1(73) &
            + cdy*cdy*g1(6) &
            + 2.0_dp*cdy*g1(26) &
            + g1(76)
         vbuf(30) = abx*cdy*cdy*g1(4) &
            + 2.0_dp*abx*cdy*g1(24) &
            + abx*g1(74) &
            + cdy*cdy*g1(7) &
            + 2.0_dp*cdy*g1(27) &
            + g1(77)
         vbuf(31) = aby*cdy*cdy*g1(2) &
            + 2.0_dp*aby*cdy*g1(22) &
            + aby*g1(72) &
            + cdy*cdy*g1(6) &
            + 2.0_dp*cdy*g1(26) &
            + g1(76)
         vbuf(32) = aby*cdy*cdy*g1(3) &
            + 2.0_dp*aby*cdy*g1(23) &
            + aby*g1(73) &
            + cdy*cdy*g1(8) &
            + 2.0_dp*cdy*g1(28) &
            + g1(78)
         vbuf(33) = aby*cdy*cdy*g1(4) &
            + 2.0_dp*aby*cdy*g1(24) &
            + aby*g1(74) &
            + cdy*cdy*g1(9) &
            + 2.0_dp*cdy*g1(29) &
            + g1(79)
         vbuf(34) = abz*cdy*cdy*g1(2) &
            + 2.0_dp*abz*cdy*g1(22) &
            + abz*g1(72) &
            + cdy*cdy*g1(7) &
            + 2.0_dp*cdy*g1(27) &
            + g1(77)
         vbuf(35) = abz*cdy*cdy*g1(3) &
            + 2.0_dp*abz*cdy*g1(23) &
            + abz*g1(73) &
            + cdy*cdy*g1(9) &
            + 2.0_dp*cdy*g1(29) &
            + g1(79)
         vbuf(36) = abz*cdy*cdy*g1(4) &
            + 2.0_dp*abz*cdy*g1(24) &
            + abz*g1(74) &
            + cdy*cdy*g1(10) &
            + 2.0_dp*cdy*g1(30) &
            + g1(80)
         vbuf(37) = abx*cdy*cdz*g1(2) &
            + abx*cdy*g1(32) &
            + abx*cdz*g1(22) &
            + abx*g1(82) &
            + cdy*cdz*g1(5) &
         ...
         vbuf(45) = abz*cdy*cdz*g1(4) &
            ...
            + cdz*g1(30) &
            + g1(90)
         vbuf(46) = abx*cdz*cdz*g1(2) &
            + 2.0_dp*abx*cdz*g1(32) &
            + abx*g1(92) &
            + cdz*cdz*g1(5) &
            + 2.0_dp*cdz*g1(35) &
            + g1(95)
         vbuf(47) = abx*cdz*cdz*g1(3) &
            + 2.0_dp*abx*cdz*g1(33) &
            + abx*g1(93) &
            + cdz*cdz*g1(6) &
            + 2.0_dp*cdz*g1(36) &
            + g1(96)
         vbuf(48) = abx*cdz*cdz*g1(4) &
            + 2.0_dp*abx*cdz*g1(34) &
            + abx*g1(94) &
            + cdz*cdz*g1(7) &
            + 2.0_dp*cdz*g1(37) &
            + g1(97)
         vbuf(49) = aby*cdz*cdz*g1(2) &
            + 2.0_dp*aby*cdz*g1(32) &
            + aby*g1(92) &
            + cdz*cdz*g1(6) &
            + 2.0_dp*cdz*g1(36) &
            + g1(96)
         vbuf(50) = aby*cdz*cdz*g1(3) &
            + 2.0_dp*aby*cdz*g1(33) &
            + aby*g1(93) &
            + cdz*cdz*g1(8) &
            + 2.0_dp*cdz*g1(38) &
            + g1(98)
         vbuf(51) = aby*cdz*cdz*g1(4) &
            + 2.0_dp*aby*cdz*g1(34) &
            + aby*g1(94) &
            + cdz*cdz*g1(9) &
            + 2.0_dp*cdz*g1(39) &
            + g1(99)
         vbuf(52) = abz*cdz*cdz*g1(2) &
            + 2.0_dp*abz*cdz*g1(32) &
            + abz*g1(92) &
            + cdz*cdz*g1(7) &
            + 2.0_dp*cdz*g1(37) &
            + g1(97)
         vbuf(53) = abz*cdz*cdz*g1(3) &
            + 2.0_dp*abz*cdz*g1(33) &
            + abz*g1(93) &
            + cdz*cdz*g1(9) &
            + 2.0_dp*cdz*g1(39) &
            + g1(99)
         vbuf(54) = abz*cdz*cdz*g1(4) &
   ...
   end subroutine pg1102
#endif
end module trc_pg_k1102
