...
contains
   ...
   pure subroutine pci0211(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*g(11) &
            + abx*abx*g(41) &
            + 2.0_dp*abx*cdx*g(12) &
            + 2.0_dp*abx*g(42) &
            + cdx*g(15) &
            + g(45)
         vbuf(2) = abx*aby*cdx*g(11) &
            + abx*aby*g(41) &
            + abx*cdx*g(13) &
            + abx*g(43) &
            + aby*cdx*g(12) &
         ...
         vbuf(3) = abx*abz*cdx*g(11) &
            ...
            + cdx*g(17) &
            + g(47)
         vbuf(4) = aby*aby*cdx*g(11) &
            + aby*aby*g(41) &
            + 2.0_dp*aby*cdx*g(13) &
            + 2.0_dp*aby*g(43) &
            + cdx*g(18) &
            + g(48)
         vbuf(5) = aby*abz*cdx*g(11) &
            + aby*abz*g(41) &
            + aby*cdx*g(14) &
            + aby*g(44) &
            + abz*cdx*g(13) &
            ...
            + cdx*g(19) &
            + g(49)
         vbuf(6) = abz*abz*cdx*g(11) &
            + abz*abz*g(41) &
            + 2.0_dp*abz*cdx*g(14) &
            + 2.0_dp*abz*g(44) &
            + cdx*g(20) &
            + g(50)
         vbuf(7) = abx*abx*cdx*g(21) &
            + abx*abx*g(51) &
            + 2.0_dp*abx*cdx*g(22) &
            + 2.0_dp*abx*g(52) &
            + cdx*g(25) &
            + g(55)
         vbuf(8) = abx*aby*cdx*g(21) &
            + abx*aby*g(51) &
            + abx*cdx*g(23) &
            + abx*g(53) &
            + aby*cdx*g(22) &
         ...
         vbuf(9) = abx*abz*cdx*g(21) &
            ...
            + cdx*g(27) &
            + g(57)
         vbuf(10) = aby*aby*cdx*g(21) &
            + aby*aby*g(51) &
            + 2.0_dp*aby*cdx*g(23) &
            + 2.0_dp*aby*g(53) &
            + cdx*g(28) &
            + g(58)
         vbuf(11) = aby*abz*cdx*g(21) &
            + aby*abz*g(51) &
            + aby*cdx*g(24) &
            + aby*g(54) &
            + abz*cdx*g(23) &
            ...
            + cdx*g(29) &
            + g(59)
         vbuf(12) = abz*abz*cdx*g(21) &
            + abz*abz*g(51) &
            + 2.0_dp*abz*cdx*g(24) &
            + 2.0_dp*abz*g(54) &
            + cdx*g(30) &
            + g(60)
         vbuf(13) = abx*abx*cdx*g(31) &
            + abx*abx*g(61) &
            + 2.0_dp*abx*cdx*g(32) &
            + 2.0_dp*abx*g(62) &
            + cdx*g(35) &
            + g(65)
         vbuf(14) = abx*aby*cdx*g(31) &
            + abx*aby*g(61) &
            + abx*cdx*g(33) &
            + abx*g(63) &
            + aby*cdx*g(32) &
         ...
         vbuf(15) = abx*abz*cdx*g(31) &
            ...
            + cdx*g(37) &
            + g(67)
         vbuf(16) = aby*aby*cdx*g(31) &
            + aby*aby*g(61) &
            + 2.0_dp*aby*cdx*g(33) &
            + 2.0_dp*aby*g(63) &
            + cdx*g(38) &
            + g(68)
         vbuf(17) = aby*abz*cdx*g(31) &
            + aby*abz*g(61) &
            + aby*cdx*g(34) &
            + aby*g(64) &
            + abz*cdx*g(33) &
            ...
            + cdx*g(39) &
            + g(69)
         vbuf(18) = abz*abz*cdx*g(31) &
            + abz*abz*g(61) &
            + 2.0_dp*abz*cdx*g(34) &
            + 2.0_dp*abz*g(64) &
            + cdx*g(40) &
            + g(70)
         vbuf(19) = abx*abx*cdy*g(11) &
            + abx*abx*g(51) &
            + 2.0_dp*abx*cdy*g(12) &
            + 2.0_dp*abx*g(52) &
            + cdy*g(15) &
            + g(55)
         vbuf(20) = abx*aby*cdy*g(11) &
            + abx*aby*g(51) &
            + abx*cdy*g(13) &
            + abx*g(53) &
            + aby*cdy*g(12) &
         ...
         vbuf(21) = abx*abz*cdy*g(11) &
            ...
            + cdy*g(17) &
            + g(57)
         vbuf(22) = aby*aby*cdy*g(11) &
            + aby*aby*g(51) &
            + 2.0_dp*aby*cdy*g(13) &
            + 2.0_dp*aby*g(53) &
            + cdy*g(18) &
            + g(58)
         vbuf(23) = aby*abz*cdy*g(11) &
            + aby*abz*g(51) &
            + aby*cdy*g(14) &
            + aby*g(54) &
            + abz*cdy*g(13) &
            ...
            + cdy*g(19) &
            + g(59)
         vbuf(24) = abz*abz*cdy*g(11) &
            + abz*abz*g(51) &
            + 2.0_dp*abz*cdy*g(14) &
            + 2.0_dp*abz*g(54) &
            + cdy*g(20) &
            + g(60)
         vbuf(25) = abx*abx*cdy*g(21) &
            + abx*abx*g(71) &
            + 2.0_dp*abx*cdy*g(22) &
            + 2.0_dp*abx*g(72) &
            + cdy*g(25) &
            + g(75)
         vbuf(26) = abx*aby*cdy*g(21) &
            + abx*aby*g(71) &
            + abx*cdy*g(23) &
            + abx*g(73) &
            + aby*cdy*g(22) &
         ...
         vbuf(27) = abx*abz*cdy*g(21) &
            ...
            + cdy*g(27) &
            + g(77)
         vbuf(28) = aby*aby*cdy*g(21) &
            + aby*aby*g(71) &
            + 2.0_dp*aby*cdy*g(23) &
            + 2.0_dp*aby*g(73) &
            + cdy*g(28) &
            + g(78)
         vbuf(29) = aby*abz*cdy*g(21) &
            + aby*abz*g(71) &
            + aby*cdy*g(24) &
            + aby*g(74) &
            + abz*cdy*g(23) &
            ...
            + cdy*g(29) &
            + g(79)
         vbuf(30) = abz*abz*cdy*g(21) &
            + abz*abz*g(71) &
            + 2.0_dp*abz*cdy*g(24) &
            + 2.0_dp*abz*g(74) &
            + cdy*g(30) &
            + g(80)
         vbuf(31) = abx*abx*cdy*g(31) &
            + abx*abx*g(81) &
            + 2.0_dp*abx*cdy*g(32) &
            + 2.0_dp*abx*g(82) &
            + cdy*g(35) &
            + g(85)
         vbuf(32) = abx*aby*cdy*g(31) &
            + abx*aby*g(81) &
            + abx*cdy*g(33) &
            + abx*g(83) &
            + aby*cdy*g(32) &
         ...
         vbuf(33) = abx*abz*cdy*g(31) &
            ...
            + cdy*g(37) &
            + g(87)
         vbuf(34) = aby*aby*cdy*g(31) &
            + aby*aby*g(81) &
            + 2.0_dp*aby*cdy*g(33) &
            + 2.0_dp*aby*g(83) &
            + cdy*g(38) &
            + g(88)
         vbuf(35) = aby*abz*cdy*g(31) &
            + aby*abz*g(81) &
            + aby*cdy*g(34) &
            + aby*g(84) &
            + abz*cdy*g(33) &
            ...
            + cdy*g(39) &
            + g(89)
         vbuf(36) = abz*abz*cdy*g(31) &
            + abz*abz*g(81) &
            + 2.0_dp*abz*cdy*g(34) &
            + 2.0_dp*abz*g(84) &
            + cdy*g(40) &
            + g(90)
         vbuf(37) = abx*abx*cdz*g(11) &
            + abx*abx*g(61) &
            + 2.0_dp*abx*cdz*g(12) &
            + 2.0_dp*abx*g(62) &
            + cdz*g(15) &
            + g(65)
         vbuf(38) = abx*aby*cdz*g(11) &
            + abx*aby*g(61) &
            + abx*cdz*g(13) &
            + abx*g(63) &
            + aby*cdz*g(12) &
         ...
         vbuf(39) = abx*abz*cdz*g(11) &
            ...
            + cdz*g(17) &
            + g(67)
         vbuf(40) = aby*aby*cdz*g(11) &
            + aby*aby*g(61) &
            + 2.0_dp*aby*cdz*g(13) &
            + 2.0_dp*aby*g(63) &
            + cdz*g(18) &
            + g(68)
         vbuf(41) = aby*abz*cdz*g(11) &
            + aby*abz*g(61) &
            + aby*cdz*g(14) &
            + aby*g(64) &
            + abz*cdz*g(13) &
            ...
            + cdz*g(19) &
            + g(69)
         vbuf(42) = abz*abz*cdz*g(11) &
            + abz*abz*g(61) &
            + 2.0_dp*abz*cdz*g(14) &
            + 2.0_dp*abz*g(64) &
            + cdz*g(20) &
            + g(70)
         vbuf(43) = abx*abx*cdz*g(21) &
            + abx*abx*g(81) &
            + 2.0_dp*abx*cdz*g(22) &
            + 2.0_dp*abx*g(82) &
            + cdz*g(25) &
            + g(85)
         vbuf(44) = abx*aby*cdz*g(21) &
            + abx*aby*g(81) &
            + abx*cdz*g(23) &
            + abx*g(83) &
            + aby*cdz*g(22) &
         ...
         vbuf(45) = abx*abz*cdz*g(21) &
            ...
            + cdz*g(27) &
            + g(87)
         vbuf(46) = aby*aby*cdz*g(21) &
            + aby*aby*g(81) &
            + 2.0_dp*aby*cdz*g(23) &
            + 2.0_dp*aby*g(83) &
            + cdz*g(28) &
            + g(88)
         vbuf(47) = aby*abz*cdz*g(21) &
            + aby*abz*g(81) &
            + aby*cdz*g(24) &
            + aby*g(84) &
            + abz*cdz*g(23) &
            ...
            + cdz*g(29) &
            + g(89)
         vbuf(48) = abz*abz*cdz*g(21) &
            + abz*abz*g(81) &
            + 2.0_dp*abz*cdz*g(24) &
            + 2.0_dp*abz*g(84) &
            + cdz*g(30) &
            + g(90)
         vbuf(49) = abx*abx*cdz*g(31) &
            + abx*abx*g(91) &
            + 2.0_dp*abx*cdz*g(32) &
            + 2.0_dp*abx*g(92) &
            + cdz*g(35) &
            + g(95)
         vbuf(50) = abx*aby*cdz*g(31) &
            + abx*aby*g(91) &
            + abx*cdz*g(33) &
            + abx*g(93) &
            + aby*cdz*g(32) &
         ...
         vbuf(51) = abx*abz*cdz*g(31) &
            ...
            + cdz*g(37) &
            + g(97)
         vbuf(52) = aby*aby*cdz*g(31) &
            + aby*aby*g(91) &
            + 2.0_dp*aby*cdz*g(33) &
            + 2.0_dp*aby*g(93) &
            + cdz*g(38) &
            + g(98)
         vbuf(53) = aby*abz*cdz*g(31) &
            + aby*abz*g(91) &
            + aby*cdz*g(34) &
            + aby*g(94) &
            + abz*cdz*g(33) &
