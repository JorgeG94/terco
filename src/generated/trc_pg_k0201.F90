!
! Class (02|01) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0201(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(6), jcd(3), kac(1)
      real(dp) :: kad(3), kbc(6), kbd(18)
      real(dp) :: dab(6), dcd(3), dac(1)
      real(dp) :: dad(3), dbc(6), dbd(18)
      ...
      pcut = thresh*1.0e-3_dp
         ...
         vbuf(3) = abx*abz*cdx*g1(1) &
            ...
            + cdx*g1(7) &
            + g1(17)
         vbuf(4) = aby*aby*cdx*g1(1) &
            + aby*aby*g1(11) &
            + 2.0_dp*aby*cdx*g1(3) &
            + 2.0_dp*aby*g1(13) &
            + cdx*g1(8) &
            + g1(18)
         vbuf(5) = aby*abz*cdx*g1(1) &
            + aby*abz*g1(11) &
            + aby*cdx*g1(4) &
            + aby*g1(14) &
            + abz*cdx*g1(3) &
            ...
            + cdx*g1(9) &
            + g1(19)
         vbuf(6) = abz*abz*cdx*g1(1) &
            + abz*abz*g1(11) &
            + 2.0_dp*abz*cdx*g1(4) &
            + 2.0_dp*abz*g1(14) &
            + cdx*g1(10) &
            + g1(20)
         vbuf(7) = abx*abx*cdy*g1(1) &
            + abx*abx*g1(21) &
            + 2.0_dp*abx*cdy*g1(2) &
            + 2.0_dp*abx*g1(22) &
            + cdy*g1(5) &
            + g1(25)
         vbuf(8) = abx*aby*cdy*g1(1) &
            + abx*aby*g1(21) &
            + abx*cdy*g1(3) &
            + abx*g1(23) &
            + aby*cdy*g1(2) &
         ...
         vbuf(9) = abx*abz*cdy*g1(1) &
            ...
            + cdy*g1(7) &
            + g1(27)
         vbuf(10) = aby*aby*cdy*g1(1) &
            + aby*aby*g1(21) &
            + 2.0_dp*aby*cdy*g1(3) &
            + 2.0_dp*aby*g1(23) &
            + cdy*g1(8) &
            + g1(28)
         vbuf(11) = aby*abz*cdy*g1(1) &
            + aby*abz*g1(21) &
            + aby*cdy*g1(4) &
            + aby*g1(24) &
            + abz*cdy*g1(3) &
            ...
            + cdy*g1(9) &
            + g1(29)
         vbuf(12) = abz*abz*cdy*g1(1) &
            + abz*abz*g1(21) &
            + 2.0_dp*abz*cdy*g1(4) &
            + 2.0_dp*abz*g1(24) &
            + cdy*g1(10) &
            + g1(30)
         vbuf(13) = abx*abx*cdz*g1(1) &
            + abx*abx*g1(31) &
            + 2.0_dp*abx*cdz*g1(2) &
            + 2.0_dp*abx*g1(32) &
            + cdz*g1(5) &
            + g1(35)
         vbuf(14) = abx*aby*cdz*g1(1) &
            + abx*aby*g1(31) &
            + abx*cdz*g1(3) &
            + abx*g1(33) &
            + aby*cdz*g1(2) &
         ...
         vbuf(15) = abx*abz*cdz*g1(1) &
            ...
            + cdz*g1(7) &
            + g1(37)
         vbuf(16) = aby*aby*cdz*g1(1) &
            + aby*aby*g1(31) &
            + 2.0_dp*aby*cdz*g1(3) &
            + 2.0_dp*aby*g1(33) &
            + cdz*g1(8) &
            + g1(38)
         vbuf(17) = aby*abz*cdz*g1(1) &
            + aby*abz*g1(31) &
            + aby*cdz*g1(4) &
            + aby*g1(34) &
            + abz*cdz*g1(3) &
   ...
   end subroutine pg0201
#endif
end module trc_pg_k0201
