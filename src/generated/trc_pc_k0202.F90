...
contains
   ...
   pure subroutine pci0202(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      real(dp) :: v(100, 0:1), g(100), vbuf(36)
      real(dp) :: wq
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*cdx*g(1) &
            + 2.0_dp*abx*abx*cdx*g(11) &
            + abx*abx*g(41) &
            + 2.0_dp*abx*cdx*cdx*g(2) &
            + 4.0_dp*abx*cdx*g(12) &
            + 2.0_dp*abx*g(42) &
            + cdx*cdx*g(5) &
            + 2.0_dp*cdx*g(15) &
            + g(45)
         vbuf(2) = abx*aby*cdx*cdx*g(1) &
            + 2.0_dp*abx*aby*cdx*g(11) &
            + abx*aby*g(41) &
            + abx*cdx*cdx*g(3) &
            + 2.0_dp*abx*cdx*g(13) &
            + abx*g(43) &
            ...
            + 2.0_dp*cdx*g(16) &
            + g(46)
         vbuf(3) = abx*abz*cdx*cdx*g(1) &
            + 2.0_dp*abx*abz*cdx*g(11) &
            + abx*abz*g(41) &
            + abx*cdx*cdx*g(4) &
            + 2.0_dp*abx*cdx*g(14) &
            + abx*g(44) &
            ...
            + 2.0_dp*cdx*g(17) &
            + g(47)
         vbuf(4) = aby*aby*cdx*cdx*g(1) &
            + 2.0_dp*aby*aby*cdx*g(11) &
            + aby*aby*g(41) &
            + 2.0_dp*aby*cdx*cdx*g(3) &
            + 4.0_dp*aby*cdx*g(13) &
            + 2.0_dp*aby*g(43) &
            + cdx*cdx*g(8) &
            + 2.0_dp*cdx*g(18) &
            + g(48)
         vbuf(5) = aby*abz*cdx*cdx*g(1) &
            + 2.0_dp*aby*abz*cdx*g(11) &
            + aby*abz*g(41) &
            + aby*cdx*cdx*g(4) &
            + 2.0_dp*aby*cdx*g(14) &
            + aby*g(44) &
            ...
            + 2.0_dp*cdx*g(19) &
            + g(49)
         vbuf(6) = abz*abz*cdx*cdx*g(1) &
            + 2.0_dp*abz*abz*cdx*g(11) &
            + abz*abz*g(41) &
            + 2.0_dp*abz*cdx*cdx*g(4) &
            + 4.0_dp*abz*cdx*g(14) &
            + 2.0_dp*abz*g(44) &
            + cdx*cdx*g(10) &
            + 2.0_dp*cdx*g(20) &
            + g(50)
         vbuf(7) = abx*abx*cdx*cdy*g(1) &
            + abx*abx*cdx*g(21) &
            + abx*abx*cdy*g(11) &
            + abx*abx*g(51) &
            + 2.0_dp*abx*cdx*cdy*g(2) &
            + 2.0_dp*abx*cdx*g(22) &
            + 2.0_dp*abx*cdy*g(12) &
            + 2.0_dp*abx*g(52) &
            + cdx*cdy*g(5) &
         ...
         vbuf(9) = abx*abz*cdx*cdy*g(1) &
            ...
            + cdy*g(17) &
            + g(57)
         vbuf(10) = aby*aby*cdx*cdy*g(1) &
            + aby*aby*cdx*g(21) &
            + aby*aby*cdy*g(11) &
            + aby*aby*g(51) &
            + 2.0_dp*aby*cdx*cdy*g(3) &
            + 2.0_dp*aby*cdx*g(23) &
            + 2.0_dp*aby*cdy*g(13) &
            + 2.0_dp*aby*g(53) &
            + cdx*cdy*g(8) &
         ...
         vbuf(11) = aby*abz*cdx*cdy*g(1) &
            ...
            + cdy*g(19) &
            + g(59)
         vbuf(12) = abz*abz*cdx*cdy*g(1) &
            + abz*abz*cdx*g(21) &
            + abz*abz*cdy*g(11) &
            + abz*abz*g(51) &
            + 2.0_dp*abz*cdx*cdy*g(4) &
            + 2.0_dp*abz*cdx*g(24) &
            + 2.0_dp*abz*cdy*g(14) &
            + 2.0_dp*abz*g(54) &
            + cdx*cdy*g(10) &
            ...
            + cdy*g(20) &
            + g(60)
         vbuf(13) = abx*abx*cdx*cdz*g(1) &
            + abx*abx*cdx*g(31) &
            + abx*abx*cdz*g(11) &
            + abx*abx*g(61) &
            + 2.0_dp*abx*cdx*cdz*g(2) &
            + 2.0_dp*abx*cdx*g(32) &
            + 2.0_dp*abx*cdz*g(12) &
            + 2.0_dp*abx*g(62) &
            + cdx*cdz*g(5) &
         ...
         vbuf(15) = abx*abz*cdx*cdz*g(1) &
            ...
            + cdz*g(17) &
            + g(67)
         vbuf(16) = aby*aby*cdx*cdz*g(1) &
            + aby*aby*cdx*g(31) &
            + aby*aby*cdz*g(11) &
            + aby*aby*g(61) &
            + 2.0_dp*aby*cdx*cdz*g(3) &
            + 2.0_dp*aby*cdx*g(33) &
            + 2.0_dp*aby*cdz*g(13) &
            + 2.0_dp*aby*g(63) &
            + cdx*cdz*g(8) &
         ...
         vbuf(17) = aby*abz*cdx*cdz*g(1) &
            ...
            + cdz*g(19) &
            + g(69)
         vbuf(18) = abz*abz*cdx*cdz*g(1) &
            + abz*abz*cdx*g(31) &
            + abz*abz*cdz*g(11) &
            + abz*abz*g(61) &
            + 2.0_dp*abz*cdx*cdz*g(4) &
            + 2.0_dp*abz*cdx*g(34) &
            + 2.0_dp*abz*cdz*g(14) &
            + 2.0_dp*abz*g(64) &
            + cdx*cdz*g(10) &
            ...
            + cdz*g(20) &
            + g(70)
         vbuf(19) = abx*abx*cdy*cdy*g(1) &
            + 2.0_dp*abx*abx*cdy*g(21) &
            + abx*abx*g(71) &
            + 2.0_dp*abx*cdy*cdy*g(2) &
            + 4.0_dp*abx*cdy*g(22) &
            + 2.0_dp*abx*g(72) &
            + cdy*cdy*g(5) &
            + 2.0_dp*cdy*g(25) &
            + g(75)
         vbuf(20) = abx*aby*cdy*cdy*g(1) &
            + 2.0_dp*abx*aby*cdy*g(21) &
            + abx*aby*g(71) &
            + abx*cdy*cdy*g(3) &
            + 2.0_dp*abx*cdy*g(23) &
            + abx*g(73) &
            ...
            + 2.0_dp*cdy*g(26) &
            + g(76)
         vbuf(21) = abx*abz*cdy*cdy*g(1) &
            + 2.0_dp*abx*abz*cdy*g(21) &
            + abx*abz*g(71) &
            + abx*cdy*cdy*g(4) &
            + 2.0_dp*abx*cdy*g(24) &
            + abx*g(74) &
            ...
            + 2.0_dp*cdy*g(27) &
            + g(77)
         vbuf(22) = aby*aby*cdy*cdy*g(1) &
            + 2.0_dp*aby*aby*cdy*g(21) &
            + aby*aby*g(71) &
            + 2.0_dp*aby*cdy*cdy*g(3) &
            + 4.0_dp*aby*cdy*g(23) &
            + 2.0_dp*aby*g(73) &
            + cdy*cdy*g(8) &
            + 2.0_dp*cdy*g(28) &
            + g(78)
         vbuf(23) = aby*abz*cdy*cdy*g(1) &
            + 2.0_dp*aby*abz*cdy*g(21) &
            + aby*abz*g(71) &
            + aby*cdy*cdy*g(4) &
            + 2.0_dp*aby*cdy*g(24) &
            + aby*g(74) &
            ...
            + 2.0_dp*cdy*g(29) &
            + g(79)
         vbuf(24) = abz*abz*cdy*cdy*g(1) &
            + 2.0_dp*abz*abz*cdy*g(21) &
            + abz*abz*g(71) &
            + 2.0_dp*abz*cdy*cdy*g(4) &
            + 4.0_dp*abz*cdy*g(24) &
            + 2.0_dp*abz*g(74) &
            + cdy*cdy*g(10) &
            + 2.0_dp*cdy*g(30) &
            + g(80)
         vbuf(25) = abx*abx*cdy*cdz*g(1) &
            + abx*abx*cdy*g(31) &
            + abx*abx*cdz*g(21) &
            + abx*abx*g(81) &
            + 2.0_dp*abx*cdy*cdz*g(2) &
            + 2.0_dp*abx*cdy*g(32) &
            + 2.0_dp*abx*cdz*g(22) &
            + 2.0_dp*abx*g(82) &
            + cdy*cdz*g(5) &
         ...
         vbuf(27) = abx*abz*cdy*cdz*g(1) &
            ...
            + cdz*g(27) &
            + g(87)
         vbuf(28) = aby*aby*cdy*cdz*g(1) &
            + aby*aby*cdy*g(31) &
            + aby*aby*cdz*g(21) &
            + aby*aby*g(81) &
            + 2.0_dp*aby*cdy*cdz*g(3) &
            + 2.0_dp*aby*cdy*g(33) &
            + 2.0_dp*aby*cdz*g(23) &
            + 2.0_dp*aby*g(83) &
            + cdy*cdz*g(8) &
         ...
         vbuf(29) = aby*abz*cdy*cdz*g(1) &
            ...
            + cdz*g(29) &
            + g(89)
         vbuf(30) = abz*abz*cdy*cdz*g(1) &
            + abz*abz*cdy*g(31) &
            + abz*abz*cdz*g(21) &
            + abz*abz*g(81) &
            + 2.0_dp*abz*cdy*cdz*g(4) &
            + 2.0_dp*abz*cdy*g(34) &
            + 2.0_dp*abz*cdz*g(24) &
            + 2.0_dp*abz*g(84) &
            + cdy*cdz*g(10) &
            ...
            + cdz*g(30) &
            + g(90)
         vbuf(31) = abx*abx*cdz*cdz*g(1) &
            + 2.0_dp*abx*abx*cdz*g(31) &
            + abx*abx*g(91) &
            + 2.0_dp*abx*cdz*cdz*g(2) &
            + 4.0_dp*abx*cdz*g(32) &
            + 2.0_dp*abx*g(92) &
            + cdz*cdz*g(5) &
            + 2.0_dp*cdz*g(35) &
            + g(95)
         vbuf(32) = abx*aby*cdz*cdz*g(1) &
            + 2.0_dp*abx*aby*cdz*g(31) &
            + abx*aby*g(91) &
            + abx*cdz*cdz*g(3) &
            + 2.0_dp*abx*cdz*g(33) &
            + abx*g(93) &
            ...
            + 2.0_dp*cdz*g(36) &
            + g(96)
         vbuf(33) = abx*abz*cdz*cdz*g(1) &
            + 2.0_dp*abx*abz*cdz*g(31) &
            + abx*abz*g(91) &
            + abx*cdz*cdz*g(4) &
            + 2.0_dp*abx*cdz*g(34) &
            + abx*g(94) &
            ...
            + 2.0_dp*cdz*g(37) &
            + g(97)
         vbuf(34) = aby*aby*cdz*cdz*g(1) &
            + 2.0_dp*aby*aby*cdz*g(31) &
            + aby*aby*g(91) &
            + 2.0_dp*aby*cdz*cdz*g(3) &
            + 4.0_dp*aby*cdz*g(33) &
            + 2.0_dp*aby*g(93) &
            + cdz*cdz*g(8) &
            + 2.0_dp*cdz*g(38) &
            + g(98)
         vbuf(35) = aby*abz*cdz*cdz*g(1) &
            + 2.0_dp*aby*abz*cdz*g(31) &
            + aby*abz*g(91) &
            + aby*cdz*cdz*g(4) &
            + 2.0_dp*aby*cdz*g(34) &
            + aby*g(94) &
            ...
            + 2.0_dp*cdz*g(39) &
            + g(99)
         vbuf(36) = abz*abz*cdz*cdz*g(1) &
            + 2.0_dp*abz*abz*cdz*g(31) &
            + abz*abz*g(91) &
            + 2.0_dp*abz*cdz*cdz*g(4) &
            + 4.0_dp*abz*cdz*g(34) &
            + 2.0_dp*abz*g(94) &
            + cdz*cdz*g(10) &
            + 2.0_dp*cdz*g(40) &
