!
! Class (02|10) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0210(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(6), jcd(3), kac(3)
      real(dp) :: kad(1), kbc(18), kbd(6)
      real(dp) :: dab(6), dcd(3), dac(3)
      real(dp) :: dad(1), dbc(18), dbd(6)
      ...
      pcut = thresh*1.0e-3_dp
         ...
         ! --- HRR ---
         vbuf(1) = abx*abx*g1(11) &
            + 2.0_dp*abx*g1(12) &
            + g1(15)
         vbuf(2) = abx*aby*g1(11) &
            + abx*g1(13) &
            + aby*g1(12) &
            + g1(16)
         vbuf(3) = abx*abz*g1(11) &
            + abx*g1(14) &
            + abz*g1(12) &
            + g1(17)
         vbuf(4) = aby*aby*g1(11) &
            + 2.0_dp*aby*g1(13) &
            + g1(18)
         vbuf(5) = aby*abz*g1(11) &
            + aby*g1(14) &
            + abz*g1(13) &
            + g1(19)
         vbuf(6) = abz*abz*g1(11) &
            + 2.0_dp*abz*g1(14) &
            + g1(20)
         vbuf(7) = abx*abx*g1(21) &
            + 2.0_dp*abx*g1(22) &
            + g1(25)
         vbuf(8) = abx*aby*g1(21) &
            + abx*g1(23) &
            + aby*g1(22) &
            + g1(26)
         vbuf(9) = abx*abz*g1(21) &
            + abx*g1(24) &
            + abz*g1(22) &
            + g1(27)
         vbuf(10) = aby*aby*g1(21) &
            + 2.0_dp*aby*g1(23) &
            + g1(28)
         vbuf(11) = aby*abz*g1(21) &
            + aby*g1(24) &
            + abz*g1(23) &
            + g1(29)
         vbuf(12) = abz*abz*g1(21) &
            + 2.0_dp*abz*g1(24) &
            + g1(30)
         vbuf(13) = abx*abx*g1(31) &
            + 2.0_dp*abx*g1(32) &
            + g1(35)
         vbuf(14) = abx*aby*g1(31) &
            + abx*g1(33) &
            + aby*g1(32) &
            + g1(36)
         vbuf(15) = abx*abz*g1(31) &
            + abx*g1(34) &
            + abz*g1(32) &
            + g1(37)
         vbuf(16) = aby*aby*g1(31) &
            + 2.0_dp*aby*g1(33) &
            + g1(38)
         vbuf(17) = aby*abz*g1(31) &
            + aby*g1(34) &
            + abz*g1(33) &
            + g1(39)
         vbuf(18) = abz*abz*g1(31) &
            + 2.0_dp*abz*g1(34) &
            + g1(40)
   ...
   end subroutine pg0210
#endif
end module trc_pg_k0210
