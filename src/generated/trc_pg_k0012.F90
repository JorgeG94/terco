!
! Class (00|12) cooperative kernel, CUDA Fortran.
!
...
module trc_pg_k0012
   ...
   integer, parameter :: CDC = 3, ABC = 16, NTC = 60

contains

   attributes(global) subroutine pg0012(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: v(20, 0:1), g1(20), vbuf(18)
      ...
      real(dp) :: jab(1), jcd(18), kac(3)
      real(dp) :: kad(6), kbc(3), kbd(6)
      real(dp) :: dab(1), dcd(18), dac(3)
      real(dp) :: dad(6), dbc(3), dbd(6)
      ...
      pcut = thresh*1.0e-3_dp
         ...
         do cd0 = 1, nccd, CDC
            ...
            v(20,1) = qcz*v(10,1) + wqz*v(10,0) &
               ...
               cur = 1
                        ...
                        tcl(21) = tcl(21) + wcol(2)*v(1, 1)
                        tcl(22) = tcl(22) + wcol(2)*v(2, 1)
                        tcl(23) = tcl(23) + wcol(2)*v(3, 1)
                        tcl(24) = tcl(24) + wcol(2)*v(4, 1)
                        tcl(25) = tcl(25) + wcol(2)*v(5, 1)
                        tcl(26) = tcl(26) + wcol(2)*v(6, 1)
                        tcl(27) = tcl(27) + wcol(2)*v(7, 1)
                        tcl(28) = tcl(28) + wcol(2)*v(8, 1)
                        tcl(29) = tcl(29) + wcol(2)*v(9, 1)
                        tcl(30) = tcl(30) + wcol(2)*v(10, 1)
                        tcl(31) = tcl(31) + wcol(2)*v(11, 1)
                        tcl(32) = tcl(32) + wcol(2)*v(12, 1)
                        tcl(33) = tcl(33) + wcol(2)*v(13, 1)
                        tcl(34) = tcl(34) + wcol(2)*v(14, 1)
                        tcl(35) = tcl(35) + wcol(2)*v(15, 1)
                        tcl(36) = tcl(36) + wcol(2)*v(16, 1)
                        tcl(37) = tcl(37) + wcol(2)*v(17, 1)
                        tcl(38) = tcl(38) + wcol(2)*v(18, 1)
                        tcl(39) = tcl(39) + wcol(2)*v(19, 1)
                        tcl(40) = tcl(40) + wcol(2)*v(20, 1)
                        tcl(41) = tcl(41) + wcol(3)*v(1, 1)
                        tcl(42) = tcl(42) + wcol(3)*v(2, 1)
                        tcl(43) = tcl(43) + wcol(3)*v(3, 1)
                        tcl(44) = tcl(44) + wcol(3)*v(4, 1)
                        tcl(45) = tcl(45) + wcol(3)*v(5, 1)
                        tcl(46) = tcl(46) + wcol(3)*v(6, 1)
                        tcl(47) = tcl(47) + wcol(3)*v(7, 1)
                        tcl(48) = tcl(48) + wcol(3)*v(8, 1)
                        tcl(49) = tcl(49) + wcol(3)*v(9, 1)
                        tcl(50) = tcl(50) + wcol(3)*v(10, 1)
                        tcl(51) = tcl(51) + wcol(3)*v(11, 1)
                        tcl(52) = tcl(52) + wcol(3)*v(12, 1)
                        tcl(53) = tcl(53) + wcol(3)*v(13, 1)
                        tcl(54) = tcl(54) + wcol(3)*v(14, 1)
                        tcl(55) = tcl(55) + wcol(3)*v(15, 1)
                        tcl(56) = tcl(56) + wcol(3)*v(16, 1)
                        tcl(57) = tcl(57) + wcol(3)*v(17, 1)
                        tcl(58) = tcl(58) + wcol(3)*v(18, 1)
                        tcl(59) = tcl(59) + wcol(3)*v(19, 1)
                        tcl(60) = tcl(60) + wcol(3)*v(20, 1)
                     end if
                  end do   ! kq0
                  ...
                  if (tau <= nabc) then
                     do c = 1, ncdc
                        ...
                        if (combo >= cb0 .and. combo < cb0 + nbt) then
                           do x = 1, 20
                              Gs(x, combo - cb0 + 1) = gown(x + (c - 1)*20)
                           end do
                        end if
                     end do
                  end if
         ...
         vbuf(9) = cdx*cdz*g1(4) &
            ...
            + cdz*g1(7) &
            + g1(16)
         vbuf(10) = cdy*cdy*g1(2) &
            + 2.0_dp*cdy*g1(6) &
            + g1(14)
         vbuf(11) = cdy*cdy*g1(3) &
            + 2.0_dp*cdy*g1(8) &
            + g1(17)
         vbuf(12) = cdy*cdy*g1(4) &
            + 2.0_dp*cdy*g1(9) &
            + g1(18)
         vbuf(13) = cdy*cdz*g1(2) &
            + cdy*g1(7) &
            + cdz*g1(6) &
            + g1(15)
         vbuf(14) = cdy*cdz*g1(3) &
            + cdy*g1(9) &
            + cdz*g1(8) &
            + g1(18)
         vbuf(15) = cdy*cdz*g1(4) &
            + cdy*g1(10) &
            + cdz*g1(9) &
            + g1(19)
         vbuf(16) = cdz*cdz*g1(2) &
            + 2.0_dp*cdz*g1(7) &
            + g1(16)
         vbuf(17) = cdz*cdz*g1(3) &
            + 2.0_dp*cdz*g1(9) &
            + g1(19)
         vbuf(18) = cdz*cdz*g1(4) &
            + 2.0_dp*cdz*g1(10) &
            + g1(20)
   ...
   end subroutine pg0012
#endif
end module trc_pg_k0012
