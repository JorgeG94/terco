...
contains
   ...
   pure subroutine pci1201(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*g(2) &
            + abx*abx*g(22) &
            + 2.0_dp*abx*cdx*g(5) &
            + 2.0_dp*abx*g(25) &
            + cdx*g(11) &
            + g(31)
         vbuf(2) = abx*abx*cdx*g(3) &
            + abx*abx*g(23) &
            + 2.0_dp*abx*cdx*g(6) &
            + 2.0_dp*abx*g(26) &
            + cdx*g(12) &
            + g(32)
         vbuf(3) = abx*abx*cdx*g(4) &
            + abx*abx*g(24) &
            + 2.0_dp*abx*cdx*g(7) &
            + 2.0_dp*abx*g(27) &
            + cdx*g(13) &
            + g(33)
         vbuf(4) = abx*aby*cdx*g(2) &
            + abx*aby*g(22) &
            + abx*cdx*g(6) &
            + abx*g(26) &
            + aby*cdx*g(5) &
         ...
         vbuf(9) = abx*abz*cdx*g(4) &
            ...
            + cdx*g(16) &
            + g(36)
         vbuf(10) = aby*aby*cdx*g(2) &
            + aby*aby*g(22) &
            + 2.0_dp*aby*cdx*g(6) &
            + 2.0_dp*aby*g(26) &
            + cdx*g(14) &
            + g(34)
         vbuf(11) = aby*aby*cdx*g(3) &
            + aby*aby*g(23) &
            + 2.0_dp*aby*cdx*g(8) &
            + 2.0_dp*aby*g(28) &
            + cdx*g(17) &
            + g(37)
         vbuf(12) = aby*aby*cdx*g(4) &
            + aby*aby*g(24) &
            + 2.0_dp*aby*cdx*g(9) &
            + 2.0_dp*aby*g(29) &
            + cdx*g(18) &
            + g(38)
         vbuf(13) = aby*abz*cdx*g(2) &
            + aby*abz*g(22) &
            + aby*cdx*g(7) &
            + aby*g(27) &
            + abz*cdx*g(6) &
         ...
         vbuf(15) = aby*abz*cdx*g(4) &
            ...
            + cdx*g(19) &
            + g(39)
         vbuf(16) = abz*abz*cdx*g(2) &
            + abz*abz*g(22) &
            + 2.0_dp*abz*cdx*g(7) &
            + 2.0_dp*abz*g(27) &
            + cdx*g(16) &
            + g(36)
         vbuf(17) = abz*abz*cdx*g(3) &
            + abz*abz*g(23) &
            + 2.0_dp*abz*cdx*g(9) &
            + 2.0_dp*abz*g(29) &
            + cdx*g(19) &
            + g(39)
         vbuf(18) = abz*abz*cdx*g(4) &
            + abz*abz*g(24) &
            + 2.0_dp*abz*cdx*g(10) &
            + 2.0_dp*abz*g(30) &
            + cdx*g(20) &
            + g(40)
         vbuf(19) = abx*abx*cdy*g(2) &
            + abx*abx*g(42) &
            + 2.0_dp*abx*cdy*g(5) &
            + 2.0_dp*abx*g(45) &
            + cdy*g(11) &
            + g(51)
         vbuf(20) = abx*abx*cdy*g(3) &
            + abx*abx*g(43) &
            + 2.0_dp*abx*cdy*g(6) &
            + 2.0_dp*abx*g(46) &
            + cdy*g(12) &
            + g(52)
         vbuf(21) = abx*abx*cdy*g(4) &
            + abx*abx*g(44) &
            + 2.0_dp*abx*cdy*g(7) &
            + 2.0_dp*abx*g(47) &
            + cdy*g(13) &
            + g(53)
         vbuf(22) = abx*aby*cdy*g(2) &
            + abx*aby*g(42) &
            + abx*cdy*g(6) &
            + abx*g(46) &
            + aby*cdy*g(5) &
         ...
         vbuf(27) = abx*abz*cdy*g(4) &
            ...
            + cdy*g(16) &
            + g(56)
         vbuf(28) = aby*aby*cdy*g(2) &
            + aby*aby*g(42) &
            + 2.0_dp*aby*cdy*g(6) &
            + 2.0_dp*aby*g(46) &
            + cdy*g(14) &
            + g(54)
         vbuf(29) = aby*aby*cdy*g(3) &
            + aby*aby*g(43) &
            + 2.0_dp*aby*cdy*g(8) &
            + 2.0_dp*aby*g(48) &
            + cdy*g(17) &
            + g(57)
         vbuf(30) = aby*aby*cdy*g(4) &
            + aby*aby*g(44) &
            + 2.0_dp*aby*cdy*g(9) &
            + 2.0_dp*aby*g(49) &
            + cdy*g(18) &
            + g(58)
         vbuf(31) = aby*abz*cdy*g(2) &
            + aby*abz*g(42) &
            + aby*cdy*g(7) &
            + aby*g(47) &
            + abz*cdy*g(6) &
         ...
         vbuf(33) = aby*abz*cdy*g(4) &
            ...
            + cdy*g(19) &
            + g(59)
         vbuf(34) = abz*abz*cdy*g(2) &
            + abz*abz*g(42) &
            + 2.0_dp*abz*cdy*g(7) &
            + 2.0_dp*abz*g(47) &
            + cdy*g(16) &
            + g(56)
         vbuf(35) = abz*abz*cdy*g(3) &
            + abz*abz*g(43) &
            + 2.0_dp*abz*cdy*g(9) &
            + 2.0_dp*abz*g(49) &
            + cdy*g(19) &
            + g(59)
         vbuf(36) = abz*abz*cdy*g(4) &
            + abz*abz*g(44) &
            + 2.0_dp*abz*cdy*g(10) &
            + 2.0_dp*abz*g(50) &
            + cdy*g(20) &
            + g(60)
         vbuf(37) = abx*abx*cdz*g(2) &
            + abx*abx*g(62) &
            + 2.0_dp*abx*cdz*g(5) &
            + 2.0_dp*abx*g(65) &
            + cdz*g(11) &
            + g(71)
         vbuf(38) = abx*abx*cdz*g(3) &
            + abx*abx*g(63) &
            + 2.0_dp*abx*cdz*g(6) &
            + 2.0_dp*abx*g(66) &
            + cdz*g(12) &
            + g(72)
         vbuf(39) = abx*abx*cdz*g(4) &
            + abx*abx*g(64) &
            + 2.0_dp*abx*cdz*g(7) &
            + 2.0_dp*abx*g(67) &
            + cdz*g(13) &
            + g(73)
         vbuf(40) = abx*aby*cdz*g(2) &
            + abx*aby*g(62) &
            + abx*cdz*g(6) &
            + abx*g(66) &
            + aby*cdz*g(5) &
         ...
         vbuf(45) = abx*abz*cdz*g(4) &
            ...
            + cdz*g(16) &
            + g(76)
         vbuf(46) = aby*aby*cdz*g(2) &
            + aby*aby*g(62) &
            + 2.0_dp*aby*cdz*g(6) &
            + 2.0_dp*aby*g(66) &
            + cdz*g(14) &
            + g(74)
         vbuf(47) = aby*aby*cdz*g(3) &
            + aby*aby*g(63) &
            + 2.0_dp*aby*cdz*g(8) &
            + 2.0_dp*aby*g(68) &
            + cdz*g(17) &
            + g(77)
         vbuf(48) = aby*aby*cdz*g(4) &
            + aby*aby*g(64) &
            + 2.0_dp*aby*cdz*g(9) &
            + 2.0_dp*aby*g(69) &
            + cdz*g(18) &
            + g(78)
         vbuf(49) = aby*abz*cdz*g(2) &
            + aby*abz*g(62) &
            + aby*cdz*g(7) &
            + aby*g(67) &
            + abz*cdz*g(6) &
         ...
         vbuf(51) = aby*abz*cdz*g(4) &
            ...
            + cdz*g(19) &
            + g(79)
         vbuf(52) = abz*abz*cdz*g(2) &
            + abz*abz*g(62) &
            + 2.0_dp*abz*cdz*g(7) &
            + 2.0_dp*abz*g(67) &
            + cdz*g(16) &
            + g(76)
         vbuf(53) = abz*abz*cdz*g(3) &
            + abz*abz*g(63) &
            + 2.0_dp*abz*cdz*g(9) &
            + 2.0_dp*abz*g(69) &
            + cdz*g(19) &
            + g(79)
         vbuf(54) = abz*abz*cdz*g(4) &
            + abz*abz*g(64) &
            + 2.0_dp*abz*cdz*g(10) &
            + 2.0_dp*abz*g(70) &
            + cdz*g(20) &
