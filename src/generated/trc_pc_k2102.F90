...
contains
   ...
   pure subroutine pci2102(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*cdx*cdx*g(5) &
            + 2.0_dp*abx*cdx*g(25) &
            + abx*g(85) &
            + cdx*cdx*g(11) &
            + 2.0_dp*cdx*g(31) &
            + g(91)
         vbuf(2) = abx*cdx*cdx*g(6) &
            + 2.0_dp*abx*cdx*g(26) &
            + abx*g(86) &
            + cdx*cdx*g(12) &
            + 2.0_dp*cdx*g(32) &
            + g(92)
         vbuf(3) = abx*cdx*cdx*g(7) &
            + 2.0_dp*abx*cdx*g(27) &
            + abx*g(87) &
            + cdx*cdx*g(13) &
            + 2.0_dp*cdx*g(33) &
            + g(93)
         vbuf(4) = abx*cdx*cdx*g(8) &
            + 2.0_dp*abx*cdx*g(28) &
            + abx*g(88) &
            + cdx*cdx*g(14) &
            + 2.0_dp*cdx*g(34) &
            + g(94)
         vbuf(5) = abx*cdx*cdx*g(9) &
            + 2.0_dp*abx*cdx*g(29) &
            + abx*g(89) &
            + cdx*cdx*g(15) &
            + 2.0_dp*cdx*g(35) &
            + g(95)
         vbuf(6) = abx*cdx*cdx*g(10) &
            + 2.0_dp*abx*cdx*g(30) &
            + abx*g(90) &
            + cdx*cdx*g(16) &
            + 2.0_dp*cdx*g(36) &
            + g(96)
         vbuf(7) = aby*cdx*cdx*g(5) &
            + 2.0_dp*aby*cdx*g(25) &
            + aby*g(85) &
            + cdx*cdx*g(12) &
            + 2.0_dp*cdx*g(32) &
            + g(92)
         vbuf(8) = aby*cdx*cdx*g(6) &
            + 2.0_dp*aby*cdx*g(26) &
            + aby*g(86) &
            + cdx*cdx*g(14) &
            + 2.0_dp*cdx*g(34) &
            + g(94)
         vbuf(9) = aby*cdx*cdx*g(7) &
            + 2.0_dp*aby*cdx*g(27) &
            + aby*g(87) &
            + cdx*cdx*g(15) &
            + 2.0_dp*cdx*g(35) &
            + g(95)
         vbuf(10) = aby*cdx*cdx*g(8) &
            + 2.0_dp*aby*cdx*g(28) &
            + aby*g(88) &
            + cdx*cdx*g(17) &
            + 2.0_dp*cdx*g(37) &
            + g(97)
         vbuf(11) = aby*cdx*cdx*g(9) &
            + 2.0_dp*aby*cdx*g(29) &
            + aby*g(89) &
            + cdx*cdx*g(18) &
            + 2.0_dp*cdx*g(38) &
            + g(98)
         vbuf(12) = aby*cdx*cdx*g(10) &
            + 2.0_dp*aby*cdx*g(30) &
            + aby*g(90) &
            + cdx*cdx*g(19) &
            + 2.0_dp*cdx*g(39) &
            + g(99)
         vbuf(13) = abz*cdx*cdx*g(5) &
            + 2.0_dp*abz*cdx*g(25) &
            + abz*g(85) &
            + cdx*cdx*g(13) &
            + 2.0_dp*cdx*g(33) &
            + g(93)
         vbuf(14) = abz*cdx*cdx*g(6) &
            + 2.0_dp*abz*cdx*g(26) &
            + abz*g(86) &
            + cdx*cdx*g(15) &
            + 2.0_dp*cdx*g(35) &
            + g(95)
         vbuf(15) = abz*cdx*cdx*g(7) &
            + 2.0_dp*abz*cdx*g(27) &
            + abz*g(87) &
            + cdx*cdx*g(16) &
            + 2.0_dp*cdx*g(36) &
            + g(96)
         vbuf(16) = abz*cdx*cdx*g(8) &
            + 2.0_dp*abz*cdx*g(28) &
            + abz*g(88) &
            + cdx*cdx*g(18) &
            + 2.0_dp*cdx*g(38) &
            + g(98)
         vbuf(17) = abz*cdx*cdx*g(9) &
            + 2.0_dp*abz*cdx*g(29) &
            + abz*g(89) &
            + cdx*cdx*g(19) &
            + 2.0_dp*cdx*g(39) &
            + g(99)
         vbuf(18) = abz*cdx*cdx*g(10) &
            + 2.0_dp*abz*cdx*g(30) &
            + abz*g(90) &
            + cdx*cdx*g(20) &
            + 2.0_dp*cdx*g(40) &
            + g(100)
         vbuf(19) = abx*cdx*cdy*g(5) &
            + abx*cdx*g(45) &
            + abx*cdy*g(25) &
            + abx*g(105) &
            + cdx*cdy*g(11) &
         ...
         vbuf(54) = abz*cdx*cdz*g(10) &
            ...
            + cdz*g(40) &
            + g(140)
         vbuf(55) = abx*cdy*cdy*g(5) &
            + 2.0_dp*abx*cdy*g(45) &
            + abx*g(145) &
            + cdy*cdy*g(11) &
            + 2.0_dp*cdy*g(51) &
            + g(151)
         vbuf(56) = abx*cdy*cdy*g(6) &
            + 2.0_dp*abx*cdy*g(46) &
            + abx*g(146) &
            + cdy*cdy*g(12) &
            + 2.0_dp*cdy*g(52) &
            + g(152)
         vbuf(57) = abx*cdy*cdy*g(7) &
            + 2.0_dp*abx*cdy*g(47) &
            + abx*g(147) &
            + cdy*cdy*g(13) &
            + 2.0_dp*cdy*g(53) &
            + g(153)
         vbuf(58) = abx*cdy*cdy*g(8) &
            + 2.0_dp*abx*cdy*g(48) &
            + abx*g(148) &
            + cdy*cdy*g(14) &
            + 2.0_dp*cdy*g(54) &
            + g(154)
         vbuf(59) = abx*cdy*cdy*g(9) &
            + 2.0_dp*abx*cdy*g(49) &
            + abx*g(149) &
            + cdy*cdy*g(15) &
            + 2.0_dp*cdy*g(55) &
            + g(155)
         vbuf(60) = abx*cdy*cdy*g(10) &
            + 2.0_dp*abx*cdy*g(50) &
            + abx*g(150) &
            + cdy*cdy*g(16) &
            + 2.0_dp*cdy*g(56) &
            + g(156)
         vbuf(61) = aby*cdy*cdy*g(5) &
            + 2.0_dp*aby*cdy*g(45) &
            + aby*g(145) &
            + cdy*cdy*g(12) &
            + 2.0_dp*cdy*g(52) &
            + g(152)
         vbuf(62) = aby*cdy*cdy*g(6) &
            + 2.0_dp*aby*cdy*g(46) &
            + aby*g(146) &
            + cdy*cdy*g(14) &
            + 2.0_dp*cdy*g(54) &
            + g(154)
         vbuf(63) = aby*cdy*cdy*g(7) &
            + 2.0_dp*aby*cdy*g(47) &
            + aby*g(147) &
            + cdy*cdy*g(15) &
            + 2.0_dp*cdy*g(55) &
            + g(155)
         vbuf(64) = aby*cdy*cdy*g(8) &
            + 2.0_dp*aby*cdy*g(48) &
            + aby*g(148) &
            + cdy*cdy*g(17) &
            + 2.0_dp*cdy*g(57) &
            + g(157)
         vbuf(65) = aby*cdy*cdy*g(9) &
            + 2.0_dp*aby*cdy*g(49) &
            + aby*g(149) &
            + cdy*cdy*g(18) &
            + 2.0_dp*cdy*g(58) &
            + g(158)
         vbuf(66) = aby*cdy*cdy*g(10) &
            + 2.0_dp*aby*cdy*g(50) &
            + aby*g(150) &
            + cdy*cdy*g(19) &
            + 2.0_dp*cdy*g(59) &
            + g(159)
         vbuf(67) = abz*cdy*cdy*g(5) &
            + 2.0_dp*abz*cdy*g(45) &
            + abz*g(145) &
            + cdy*cdy*g(13) &
            + 2.0_dp*cdy*g(53) &
            + g(153)
         vbuf(68) = abz*cdy*cdy*g(6) &
            + 2.0_dp*abz*cdy*g(46) &
            + abz*g(146) &
            + cdy*cdy*g(15) &
            + 2.0_dp*cdy*g(55) &
            + g(155)
         vbuf(69) = abz*cdy*cdy*g(7) &
            + 2.0_dp*abz*cdy*g(47) &
            + abz*g(147) &
            + cdy*cdy*g(16) &
            + 2.0_dp*cdy*g(56) &
            + g(156)
         vbuf(70) = abz*cdy*cdy*g(8) &
            + 2.0_dp*abz*cdy*g(48) &
            + abz*g(148) &
            + cdy*cdy*g(18) &
            + 2.0_dp*cdy*g(58) &
            + g(158)
         vbuf(71) = abz*cdy*cdy*g(9) &
            + 2.0_dp*abz*cdy*g(49) &
            + abz*g(149) &
            + cdy*cdy*g(19) &
            + 2.0_dp*cdy*g(59) &
            + g(159)
         vbuf(72) = abz*cdy*cdy*g(10) &
            + 2.0_dp*abz*cdy*g(50) &
            + abz*g(150) &
            + cdy*cdy*g(20) &
            + 2.0_dp*cdy*g(60) &
            + g(160)
         vbuf(73) = abx*cdy*cdz*g(5) &
            + abx*cdy*g(65) &
            + abx*cdz*g(45) &
            + abx*g(165) &
            + cdy*cdz*g(11) &
         ...
         vbuf(90) = abz*cdy*cdz*g(10) &
            ...
            + cdz*g(60) &
            + g(180)
         vbuf(91) = abx*cdz*cdz*g(5) &
            + 2.0_dp*abx*cdz*g(65) &
            + abx*g(185) &
            + cdz*cdz*g(11) &
            + 2.0_dp*cdz*g(71) &
            + g(191)
         vbuf(92) = abx*cdz*cdz*g(6) &
            + 2.0_dp*abx*cdz*g(66) &
            + abx*g(186) &
            + cdz*cdz*g(12) &
            + 2.0_dp*cdz*g(72) &
            + g(192)
         vbuf(93) = abx*cdz*cdz*g(7) &
            + 2.0_dp*abx*cdz*g(67) &
            + abx*g(187) &
            + cdz*cdz*g(13) &
            + 2.0_dp*cdz*g(73) &
            + g(193)
         vbuf(94) = abx*cdz*cdz*g(8) &
            + 2.0_dp*abx*cdz*g(68) &
            + abx*g(188) &
            + cdz*cdz*g(14) &
            + 2.0_dp*cdz*g(74) &
            + g(194)
         vbuf(95) = abx*cdz*cdz*g(9) &
            + 2.0_dp*abx*cdz*g(69) &
            + abx*g(189) &
            + cdz*cdz*g(15) &
            + 2.0_dp*cdz*g(75) &
            + g(195)
         vbuf(96) = abx*cdz*cdz*g(10) &
            + 2.0_dp*abx*cdz*g(70) &
            + abx*g(190) &
            + cdz*cdz*g(16) &
            + 2.0_dp*cdz*g(76) &
            + g(196)
         vbuf(97) = aby*cdz*cdz*g(5) &
            + 2.0_dp*aby*cdz*g(65) &
            + aby*g(185) &
            + cdz*cdz*g(12) &
            + 2.0_dp*cdz*g(72) &
            + g(192)
         vbuf(98) = aby*cdz*cdz*g(6) &
            + 2.0_dp*aby*cdz*g(66) &
            + aby*g(186) &
            + cdz*cdz*g(14) &
            + 2.0_dp*cdz*g(74) &
            + g(194)
         vbuf(99) = aby*cdz*cdz*g(7) &
            + 2.0_dp*aby*cdz*g(67) &
            + aby*g(187) &
            + cdz*cdz*g(15) &
            + 2.0_dp*cdz*g(75) &
            + g(195)
         vbuf(100) = aby*cdz*cdz*g(8) &
            + 2.0_dp*aby*cdz*g(68) &
            + aby*g(188) &
            + cdz*cdz*g(17) &
            + 2.0_dp*cdz*g(77) &
            + g(197)
         vbuf(101) = aby*cdz*cdz*g(9) &
            + 2.0_dp*aby*cdz*g(69) &
            + aby*g(189) &
            + cdz*cdz*g(18) &
            + 2.0_dp*cdz*g(78) &
            + g(198)
         vbuf(102) = aby*cdz*cdz*g(10) &
            + 2.0_dp*aby*cdz*g(70) &
            + aby*g(190) &
            + cdz*cdz*g(19) &
            + 2.0_dp*cdz*g(79) &
            + g(199)
         vbuf(103) = abz*cdz*cdz*g(5) &
            + 2.0_dp*abz*cdz*g(65) &
            + abz*g(185) &
            + cdz*cdz*g(13) &
            + 2.0_dp*cdz*g(73) &
            + g(193)
         vbuf(104) = abz*cdz*cdz*g(6) &
            + 2.0_dp*abz*cdz*g(66) &
            + abz*g(186) &
            + cdz*cdz*g(15) &
            + 2.0_dp*cdz*g(75) &
            + g(195)
         vbuf(105) = abz*cdz*cdz*g(7) &
            + 2.0_dp*abz*cdz*g(67) &
            + abz*g(187) &
            + cdz*cdz*g(16) &
            + 2.0_dp*cdz*g(76) &
            + g(196)
         vbuf(106) = abz*cdz*cdz*g(8) &
            + 2.0_dp*abz*cdz*g(68) &
            + abz*g(188) &
            + cdz*cdz*g(18) &
            + 2.0_dp*cdz*g(78) &
            + g(198)
         vbuf(107) = abz*cdz*cdz*g(9) &
            + 2.0_dp*abz*cdz*g(69) &
            + abz*g(189) &
            + cdz*cdz*g(19) &
            + 2.0_dp*cdz*g(79) &
            + g(199)
         vbuf(108) = abz*cdz*cdz*g(10) &
            + 2.0_dp*abz*cdz*g(70) &
            + abz*g(190) &
            + cdz*cdz*g(20) &
            + 2.0_dp*cdz*g(80) &
