!
! Class (12|01) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg1201(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(18), jcd(3), kac(3)
      real(dp) :: kad(9), kbc(6), kbd(18)
      real(dp) :: dab(18), dcd(3), dac(3)
      real(dp) :: dad(9), dbc(6), dbd(18)
      ...
      pcut = thresh*1.0e-3_dp
         ...
         ! --- HRR ---
         vbuf(1) = abx*abx*cdx*g1(2) &
            + abx*abx*g1(22) &
            + 2.0_dp*abx*cdx*g1(5) &
            + 2.0_dp*abx*g1(25) &
            + cdx*g1(11) &
            + g1(31)
         vbuf(2) = abx*abx*cdx*g1(3) &
            + abx*abx*g1(23) &
            + 2.0_dp*abx*cdx*g1(6) &
            + 2.0_dp*abx*g1(26) &
            + cdx*g1(12) &
            + g1(32)
         vbuf(3) = abx*abx*cdx*g1(4) &
            + abx*abx*g1(24) &
            + 2.0_dp*abx*cdx*g1(7) &
            + 2.0_dp*abx*g1(27) &
            + cdx*g1(13) &
            + g1(33)
         vbuf(4) = abx*aby*cdx*g1(2) &
            + abx*aby*g1(22) &
            + abx*cdx*g1(6) &
            + abx*g1(26) &
            + aby*cdx*g1(5) &
         ...
         vbuf(9) = abx*abz*cdx*g1(4) &
            ...
            + cdx*g1(16) &
            + g1(36)
         vbuf(10) = aby*aby*cdx*g1(2) &
            + aby*aby*g1(22) &
            + 2.0_dp*aby*cdx*g1(6) &
            + 2.0_dp*aby*g1(26) &
            + cdx*g1(14) &
            + g1(34)
         vbuf(11) = aby*aby*cdx*g1(3) &
            + aby*aby*g1(23) &
            + 2.0_dp*aby*cdx*g1(8) &
            + 2.0_dp*aby*g1(28) &
            + cdx*g1(17) &
            + g1(37)
         vbuf(12) = aby*aby*cdx*g1(4) &
            + aby*aby*g1(24) &
            + 2.0_dp*aby*cdx*g1(9) &
            + 2.0_dp*aby*g1(29) &
            + cdx*g1(18) &
            + g1(38)
         vbuf(13) = aby*abz*cdx*g1(2) &
            + aby*abz*g1(22) &
            + aby*cdx*g1(7) &
            + aby*g1(27) &
            + abz*cdx*g1(6) &
         ...
         vbuf(15) = aby*abz*cdx*g1(4) &
            ...
            + cdx*g1(19) &
            + g1(39)
         vbuf(16) = abz*abz*cdx*g1(2) &
            + abz*abz*g1(22) &
            + 2.0_dp*abz*cdx*g1(7) &
            + 2.0_dp*abz*g1(27) &
            + cdx*g1(16) &
            + g1(36)
         vbuf(17) = abz*abz*cdx*g1(3) &
            + abz*abz*g1(23) &
            + 2.0_dp*abz*cdx*g1(9) &
            + 2.0_dp*abz*g1(29) &
            + cdx*g1(19) &
            + g1(39)
         vbuf(18) = abz*abz*cdx*g1(4) &
            + abz*abz*g1(24) &
            + 2.0_dp*abz*cdx*g1(10) &
            + 2.0_dp*abz*g1(30) &
            + cdx*g1(20) &
            + g1(40)
         vbuf(19) = abx*abx*cdy*g1(2) &
            + abx*abx*g1(42) &
            + 2.0_dp*abx*cdy*g1(5) &
            + 2.0_dp*abx*g1(45) &
            + cdy*g1(11) &
            + g1(51)
         vbuf(20) = abx*abx*cdy*g1(3) &
            + abx*abx*g1(43) &
            + 2.0_dp*abx*cdy*g1(6) &
            + 2.0_dp*abx*g1(46) &
            + cdy*g1(12) &
            + g1(52)
         vbuf(21) = abx*abx*cdy*g1(4) &
            + abx*abx*g1(44) &
            + 2.0_dp*abx*cdy*g1(7) &
            + 2.0_dp*abx*g1(47) &
            + cdy*g1(13) &
            + g1(53)
         vbuf(22) = abx*aby*cdy*g1(2) &
            + abx*aby*g1(42) &
            + abx*cdy*g1(6) &
            + abx*g1(46) &
            + aby*cdy*g1(5) &
         ...
         vbuf(27) = abx*abz*cdy*g1(4) &
            ...
            + cdy*g1(16) &
            + g1(56)
         vbuf(28) = aby*aby*cdy*g1(2) &
            + aby*aby*g1(42) &
            + 2.0_dp*aby*cdy*g1(6) &
            + 2.0_dp*aby*g1(46) &
            + cdy*g1(14) &
            + g1(54)
         vbuf(29) = aby*aby*cdy*g1(3) &
            + aby*aby*g1(43) &
            + 2.0_dp*aby*cdy*g1(8) &
            + 2.0_dp*aby*g1(48) &
            + cdy*g1(17) &
            + g1(57)
         vbuf(30) = aby*aby*cdy*g1(4) &
            + aby*aby*g1(44) &
            + 2.0_dp*aby*cdy*g1(9) &
            + 2.0_dp*aby*g1(49) &
            + cdy*g1(18) &
            + g1(58)
         vbuf(31) = aby*abz*cdy*g1(2) &
            + aby*abz*g1(42) &
            + aby*cdy*g1(7) &
            + aby*g1(47) &
            + abz*cdy*g1(6) &
         ...
         vbuf(33) = aby*abz*cdy*g1(4) &
            ...
            + cdy*g1(19) &
            + g1(59)
         vbuf(34) = abz*abz*cdy*g1(2) &
            + abz*abz*g1(42) &
            + 2.0_dp*abz*cdy*g1(7) &
            + 2.0_dp*abz*g1(47) &
            + cdy*g1(16) &
            + g1(56)
         vbuf(35) = abz*abz*cdy*g1(3) &
            + abz*abz*g1(43) &
            + 2.0_dp*abz*cdy*g1(9) &
            + 2.0_dp*abz*g1(49) &
            + cdy*g1(19) &
            + g1(59)
         vbuf(36) = abz*abz*cdy*g1(4) &
            + abz*abz*g1(44) &
            + 2.0_dp*abz*cdy*g1(10) &
            + 2.0_dp*abz*g1(50) &
            + cdy*g1(20) &
            + g1(60)
         vbuf(37) = abx*abx*cdz*g1(2) &
            + abx*abx*g1(62) &
            + 2.0_dp*abx*cdz*g1(5) &
            + 2.0_dp*abx*g1(65) &
            + cdz*g1(11) &
            + g1(71)
         vbuf(38) = abx*abx*cdz*g1(3) &
            + abx*abx*g1(63) &
            + 2.0_dp*abx*cdz*g1(6) &
            + 2.0_dp*abx*g1(66) &
            + cdz*g1(12) &
            + g1(72)
         vbuf(39) = abx*abx*cdz*g1(4) &
            + abx*abx*g1(64) &
            + 2.0_dp*abx*cdz*g1(7) &
            + 2.0_dp*abx*g1(67) &
            + cdz*g1(13) &
            + g1(73)
         vbuf(40) = abx*aby*cdz*g1(2) &
            + abx*aby*g1(62) &
            + abx*cdz*g1(6) &
            + abx*g1(66) &
            + aby*cdz*g1(5) &
         ...
         vbuf(45) = abx*abz*cdz*g1(4) &
            ...
            + cdz*g1(16) &
            + g1(76)
         vbuf(46) = aby*aby*cdz*g1(2) &
            + aby*aby*g1(62) &
            + 2.0_dp*aby*cdz*g1(6) &
            + 2.0_dp*aby*g1(66) &
            + cdz*g1(14) &
            + g1(74)
         vbuf(47) = aby*aby*cdz*g1(3) &
            + aby*aby*g1(63) &
            + 2.0_dp*aby*cdz*g1(8) &
            + 2.0_dp*aby*g1(68) &
            + cdz*g1(17) &
            + g1(77)
         vbuf(48) = aby*aby*cdz*g1(4) &
            + aby*aby*g1(64) &
            + 2.0_dp*aby*cdz*g1(9) &
            + 2.0_dp*aby*g1(69) &
            + cdz*g1(18) &
            + g1(78)
         vbuf(49) = aby*abz*cdz*g1(2) &
            + aby*abz*g1(62) &
            + aby*cdz*g1(7) &
            + aby*g1(67) &
            + abz*cdz*g1(6) &
         ...
         vbuf(51) = aby*abz*cdz*g1(4) &
            ...
            + cdz*g1(19) &
            + g1(79)
         vbuf(52) = abz*abz*cdz*g1(2) &
            + abz*abz*g1(62) &
            + 2.0_dp*abz*cdz*g1(7) &
            + 2.0_dp*abz*g1(67) &
            + cdz*g1(16) &
            + g1(76)
         vbuf(53) = abz*abz*cdz*g1(3) &
            + abz*abz*g1(63) &
            + 2.0_dp*abz*cdz*g1(9) &
            + 2.0_dp*abz*g1(69) &
            + cdz*g1(19) &
            + g1(79)
         vbuf(54) = abz*abz*cdz*g1(4) &
            + abz*abz*g1(64) &
            + 2.0_dp*abz*cdz*g1(10) &
            + 2.0_dp*abz*g1(70) &
            + cdz*g1(20) &
            + g1(80)
   ...
   end subroutine pg1201
#endif
end module trc_pg_k1201
