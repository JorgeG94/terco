!
! Class (10|12) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg1012(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(3), jcd(18), kac(9)
      real(dp) :: kad(18), kbc(3), kbd(6)
      real(dp) :: dab(3), dcd(18), dac(9)
      real(dp) :: dad(18), dbc(3), dbd(6)
      ...
      if (gt > gend) return
         ...
         vbuf(3) = cdx*cdx*g1(8) &
            + 2.0_dp*cdx*g1(20) &
            + g1(44)
         vbuf(4) = cdx*cdx*g1(10) &
            + 2.0_dp*cdx*g1(22) &
            + g1(46)
         vbuf(5) = cdx*cdx*g1(11) &
            + 2.0_dp*cdx*g1(23) &
            + g1(47)
         vbuf(6) = cdx*cdx*g1(12) &
            + 2.0_dp*cdx*g1(24) &
            + g1(48)
         vbuf(7) = cdx*cdx*g1(14) &
            + 2.0_dp*cdx*g1(26) &
            + g1(50)
         vbuf(8) = cdx*cdx*g1(15) &
            + 2.0_dp*cdx*g1(27) &
            + g1(51)
         vbuf(9) = cdx*cdx*g1(16) &
            + 2.0_dp*cdx*g1(28) &
            + g1(52)
         vbuf(10) = cdx*cdy*g1(6) &
            + cdx*g1(22) &
            + cdy*g1(18) &
            + g1(46)
         vbuf(11) = cdx*cdy*g1(7) &
            + cdx*g1(23) &
            + cdy*g1(19) &
            + g1(47)
         vbuf(12) = cdx*cdy*g1(8) &
            + cdx*g1(24) &
            + cdy*g1(20) &
            + g1(48)
         vbuf(13) = cdx*cdy*g1(10) &
            + cdx*g1(30) &
            + cdy*g1(22) &
            + g1(54)
         vbuf(14) = cdx*cdy*g1(11) &
            + cdx*g1(31) &
            + cdy*g1(23) &
            + g1(55)
         vbuf(15) = cdx*cdy*g1(12) &
            + cdx*g1(32) &
            + cdy*g1(24) &
            + g1(56)
         vbuf(16) = cdx*cdy*g1(14) &
            + cdx*g1(34) &
            + cdy*g1(26) &
            + g1(58)
         vbuf(17) = cdx*cdy*g1(15) &
            + cdx*g1(35) &
            + cdy*g1(27) &
            + g1(59)
         vbuf(18) = cdx*cdy*g1(16) &
            + cdx*g1(36) &
            + cdy*g1(28) &
            + g1(60)
         vbuf(19) = cdx*cdz*g1(6) &
            + cdx*g1(26) &
            + cdz*g1(18) &
            + g1(50)
         vbuf(20) = cdx*cdz*g1(7) &
            + cdx*g1(27) &
            + cdz*g1(19) &
            + g1(51)
         vbuf(21) = cdx*cdz*g1(8) &
            + cdx*g1(28) &
            + cdz*g1(20) &
            + g1(52)
         vbuf(22) = cdx*cdz*g1(10) &
            + cdx*g1(34) &
            + cdz*g1(22) &
            + g1(58)
         vbuf(23) = cdx*cdz*g1(11) &
            + cdx*g1(35) &
            + cdz*g1(23) &
            + g1(59)
         vbuf(24) = cdx*cdz*g1(12) &
            + cdx*g1(36) &
            + cdz*g1(24) &
            + g1(60)
         vbuf(25) = cdx*cdz*g1(14) &
            + cdx*g1(38) &
            + cdz*g1(26) &
            + g1(62)
         vbuf(26) = cdx*cdz*g1(15) &
            + cdx*g1(39) &
            + cdz*g1(27) &
            + g1(63)
         vbuf(27) = cdx*cdz*g1(16) &
            + cdx*g1(40) &
            + cdz*g1(28) &
            + g1(64)
         vbuf(28) = cdy*cdy*g1(6) &
            + 2.0_dp*cdy*g1(22) &
            + g1(54)
         vbuf(29) = cdy*cdy*g1(7) &
            + 2.0_dp*cdy*g1(23) &
            + g1(55)
         vbuf(30) = cdy*cdy*g1(8) &
            + 2.0_dp*cdy*g1(24) &
            + g1(56)
         vbuf(31) = cdy*cdy*g1(10) &
            + 2.0_dp*cdy*g1(30) &
            + g1(66)
         vbuf(32) = cdy*cdy*g1(11) &
            + 2.0_dp*cdy*g1(31) &
            + g1(67)
         vbuf(33) = cdy*cdy*g1(12) &
            + 2.0_dp*cdy*g1(32) &
            + g1(68)
         vbuf(34) = cdy*cdy*g1(14) &
            + 2.0_dp*cdy*g1(34) &
            + g1(70)
         vbuf(35) = cdy*cdy*g1(15) &
            + 2.0_dp*cdy*g1(35) &
            + g1(71)
         vbuf(36) = cdy*cdy*g1(16) &
            + 2.0_dp*cdy*g1(36) &
            + g1(72)
         vbuf(37) = cdy*cdz*g1(6) &
            + cdy*g1(26) &
            + cdz*g1(22) &
            + g1(58)
         vbuf(38) = cdy*cdz*g1(7) &
            + cdy*g1(27) &
            + cdz*g1(23) &
            + g1(59)
         vbuf(39) = cdy*cdz*g1(8) &
            + cdy*g1(28) &
            + cdz*g1(24) &
            + g1(60)
         vbuf(40) = cdy*cdz*g1(10) &
            + cdy*g1(34) &
            + cdz*g1(30) &
            + g1(70)
         vbuf(41) = cdy*cdz*g1(11) &
            + cdy*g1(35) &
            + cdz*g1(31) &
            + g1(71)
         vbuf(42) = cdy*cdz*g1(12) &
            + cdy*g1(36) &
            + cdz*g1(32) &
            + g1(72)
         vbuf(43) = cdy*cdz*g1(14) &
            + cdy*g1(38) &
            + cdz*g1(34) &
            + g1(74)
         vbuf(44) = cdy*cdz*g1(15) &
            + cdy*g1(39) &
            + cdz*g1(35) &
            + g1(75)
         vbuf(45) = cdy*cdz*g1(16) &
            + cdy*g1(40) &
            + cdz*g1(36) &
            + g1(76)
         vbuf(46) = cdz*cdz*g1(6) &
            + 2.0_dp*cdz*g1(26) &
            + g1(62)
         vbuf(47) = cdz*cdz*g1(7) &
            + 2.0_dp*cdz*g1(27) &
            + g1(63)
         vbuf(48) = cdz*cdz*g1(8) &
            + 2.0_dp*cdz*g1(28) &
            + g1(64)
         vbuf(49) = cdz*cdz*g1(10) &
            + 2.0_dp*cdz*g1(34) &
            + g1(74)
         vbuf(50) = cdz*cdz*g1(11) &
            + 2.0_dp*cdz*g1(35) &
            + g1(75)
         vbuf(51) = cdz*cdz*g1(12) &
            + 2.0_dp*cdz*g1(36) &
            + g1(76)
         vbuf(52) = cdz*cdz*g1(14) &
            + 2.0_dp*cdz*g1(38) &
            + g1(78)
         vbuf(53) = cdz*cdz*g1(15) &
            + 2.0_dp*cdz*g1(39) &
            + g1(79)
         vbuf(54) = cdz*cdz*g1(16) &
            + 2.0_dp*cdz*g1(40) &
            + g1(80)
   ...
   end subroutine pg1012
#endif
end module trc_pg_k1012
