   ...
   pure subroutine pci1012(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(12) = cdx*cdy*g(8) &
            ...
            + cdy*g(20) &
            + g(48)
         vbuf(13) = cdx*cdy*g(10) &
            + cdx*g(30) &
            + cdy*g(22) &
            + g(54)
         vbuf(14) = cdx*cdy*g(11) &
            + cdx*g(31) &
            + cdy*g(23) &
            + g(55)
         vbuf(15) = cdx*cdy*g(12) &
            + cdx*g(32) &
            + cdy*g(24) &
            + g(56)
         vbuf(16) = cdx*cdy*g(14) &
            + cdx*g(34) &
            + cdy*g(26) &
            + g(58)
         vbuf(17) = cdx*cdy*g(15) &
            + cdx*g(35) &
            + cdy*g(27) &
            + g(59)
         vbuf(18) = cdx*cdy*g(16) &
            + cdx*g(36) &
            + cdy*g(28) &
            + g(60)
         vbuf(19) = cdx*cdz*g(6) &
         ...
         vbuf(21) = cdx*cdz*g(8) &
            ...
            + cdz*g(20) &
            + g(52)
         vbuf(22) = cdx*cdz*g(10) &
            + cdx*g(34) &
            + cdz*g(22) &
            + g(58)
         vbuf(23) = cdx*cdz*g(11) &
            + cdx*g(35) &
            + cdz*g(23) &
            + g(59)
         vbuf(24) = cdx*cdz*g(12) &
            + cdx*g(36) &
            + cdz*g(24) &
            + g(60)
         vbuf(25) = cdx*cdz*g(14) &
            + cdx*g(38) &
            + cdz*g(26) &
            + g(62)
         vbuf(26) = cdx*cdz*g(15) &
            + cdx*g(39) &
            + cdz*g(27) &
            + g(63)
         vbuf(27) = cdx*cdz*g(16) &
            + cdx*g(40) &
            + cdz*g(28) &
            + g(64)
         vbuf(28) = cdy*cdy*g(6) &
         ...
         vbuf(30) = cdy*cdy*g(8) &
            + 2.0_dp*cdy*g(24) &
            + g(56)
         vbuf(31) = cdy*cdy*g(10) &
            + 2.0_dp*cdy*g(30) &
            + g(66)
         vbuf(32) = cdy*cdy*g(11) &
            + 2.0_dp*cdy*g(31) &
            + g(67)
         vbuf(33) = cdy*cdy*g(12) &
            + 2.0_dp*cdy*g(32) &
            + g(68)
         vbuf(34) = cdy*cdy*g(14) &
            + 2.0_dp*cdy*g(34) &
            + g(70)
         vbuf(35) = cdy*cdy*g(15) &
            + 2.0_dp*cdy*g(35) &
            + g(71)
         vbuf(36) = cdy*cdy*g(16) &
            + 2.0_dp*cdy*g(36) &
            + g(72)
         vbuf(37) = cdy*cdz*g(6) &
            + cdy*g(26) &
         ...
         vbuf(39) = cdy*cdz*g(8) &
            ...
            + cdz*g(24) &
            + g(60)
         vbuf(40) = cdy*cdz*g(10) &
            + cdy*g(34) &
            + cdz*g(30) &
            + g(70)
         vbuf(41) = cdy*cdz*g(11) &
            + cdy*g(35) &
            + cdz*g(31) &
            + g(71)
         vbuf(42) = cdy*cdz*g(12) &
            + cdy*g(36) &
            + cdz*g(32) &
            + g(72)
         vbuf(43) = cdy*cdz*g(14) &
            + cdy*g(38) &
            + cdz*g(34) &
            + g(74)
         vbuf(44) = cdy*cdz*g(15) &
            + cdy*g(39) &
            + cdz*g(35) &
            + g(75)
         vbuf(45) = cdy*cdz*g(16) &
            + cdy*g(40) &
            + cdz*g(36) &
            + g(76)
         vbuf(46) = cdz*cdz*g(6) &
         ...
         vbuf(48) = cdz*cdz*g(8) &
            + 2.0_dp*cdz*g(28) &
            + g(64)
         vbuf(49) = cdz*cdz*g(10) &
            + 2.0_dp*cdz*g(34) &
            + g(74)
         vbuf(50) = cdz*cdz*g(11) &
            + 2.0_dp*cdz*g(35) &
            + g(75)
         vbuf(51) = cdz*cdz*g(12) &
            + 2.0_dp*cdz*g(36) &
            + g(76)
         vbuf(52) = cdz*cdz*g(14) &
            + 2.0_dp*cdz*g(38) &
            + g(78)
         vbuf(53) = cdz*cdz*g(15) &
            + 2.0_dp*cdz*g(39) &
            + g(79)
         vbuf(54) = cdz*cdz*g(16) &
            + 2.0_dp*cdz*g(40) &
            + g(80)
