   ...
   pure subroutine pci0210(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(9) = abx*abz*g(21) &
            ...
            + abz*g(22) &
            + g(27)
         vbuf(10) = aby*aby*g(21) &
            + 2.0_dp*aby*g(23) &
            + g(28)
         vbuf(11) = aby*abz*g(21) &
            + aby*g(24) &
            + abz*g(23) &
            + g(29)
         vbuf(12) = abz*abz*g(21) &
            + 2.0_dp*abz*g(24) &
            + g(30)
         vbuf(13) = abx*abx*g(31) &
            + 2.0_dp*abx*g(32) &
            + g(35)
         vbuf(14) = abx*aby*g(31) &
            + abx*g(33) &
            + aby*g(32) &
            + g(36)
         vbuf(15) = abx*abz*g(31) &
            + abx*g(34) &
            + abz*g(32) &
            + g(37)
         vbuf(16) = aby*aby*g(31) &
            + 2.0_dp*aby*g(33) &
            + g(38)
         vbuf(17) = aby*abz*g(31) &
            + aby*g(34) &
            + abz*g(33) &
            + g(39)
         vbuf(18) = abz*abz*g(31) &
            + 2.0_dp*abz*g(34) &
            + g(40)
