...
module trc_pg_k1221
   ...
   integer, parameter :: PG_NCC = 16, PG_NCAB = 16, PG_GB = 7
...
contains
   ...
   attributes(global) subroutine pg1221(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp), shared :: Vs(PG_XC, PG_T), Ws(PG_T, PG_NCC), Gs(400, PG_GB)
      integer(kind=8) :: gt
      ...
      if (gt > gend) return
         ...
         ! column combination.
         !
         cdc = max(1, min(nccd, (PG_NTC*PG_T)/400))
         ntcl = (400*cdc + PG_T - 1)/PG_T
