   ...
   pure subroutine pci1210(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(9) = abx*abz*g(24) &
            ...
            + abz*g(27) &
            + g(36)
         vbuf(10) = aby*aby*g(22) &
            + 2.0_dp*aby*g(26) &
            + g(34)
         vbuf(11) = aby*aby*g(23) &
            + 2.0_dp*aby*g(28) &
            + g(37)
         vbuf(12) = aby*aby*g(24) &
            + 2.0_dp*aby*g(29) &
            + g(38)
         vbuf(13) = aby*abz*g(22) &
            + aby*g(27) &
            + abz*g(26) &
            + g(35)
         vbuf(14) = aby*abz*g(23) &
            + aby*g(29) &
            + abz*g(28) &
            + g(38)
         vbuf(15) = aby*abz*g(24) &
            + aby*g(30) &
            + abz*g(29) &
            + g(39)
         vbuf(16) = abz*abz*g(22) &
            + 2.0_dp*abz*g(27) &
            + g(36)
         vbuf(17) = abz*abz*g(23) &
            + 2.0_dp*abz*g(29) &
            + g(39)
         vbuf(18) = abz*abz*g(24) &
            + 2.0_dp*abz*g(30) &
            + g(40)
         vbuf(19) = abx*abx*g(42) &
            + 2.0_dp*abx*g(45) &
            + g(51)
         vbuf(20) = abx*abx*g(43) &
            + 2.0_dp*abx*g(46) &
            + g(52)
         vbuf(21) = abx*abx*g(44) &
            + 2.0_dp*abx*g(47) &
            + g(53)
         vbuf(22) = abx*aby*g(42) &
            + abx*g(46) &
            + aby*g(45) &
            + g(52)
         vbuf(23) = abx*aby*g(43) &
            + abx*g(48) &
            + aby*g(46) &
            + g(54)
         vbuf(24) = abx*aby*g(44) &
            + abx*g(49) &
            + aby*g(47) &
            + g(55)
         vbuf(25) = abx*abz*g(42) &
            + abx*g(47) &
            + abz*g(45) &
            + g(53)
         vbuf(26) = abx*abz*g(43) &
            + abx*g(49) &
            + abz*g(46) &
            + g(55)
         vbuf(27) = abx*abz*g(44) &
            + abx*g(50) &
            + abz*g(47) &
            + g(56)
         vbuf(28) = aby*aby*g(42) &
            + 2.0_dp*aby*g(46) &
            + g(54)
         vbuf(29) = aby*aby*g(43) &
            + 2.0_dp*aby*g(48) &
            + g(57)
         vbuf(30) = aby*aby*g(44) &
            + 2.0_dp*aby*g(49) &
            + g(58)
         vbuf(31) = aby*abz*g(42) &
            + aby*g(47) &
            + abz*g(46) &
            + g(55)
         vbuf(32) = aby*abz*g(43) &
            + aby*g(49) &
            + abz*g(48) &
            + g(58)
         vbuf(33) = aby*abz*g(44) &
            + aby*g(50) &
            + abz*g(49) &
            + g(59)
         vbuf(34) = abz*abz*g(42) &
            + 2.0_dp*abz*g(47) &
            + g(56)
         vbuf(35) = abz*abz*g(43) &
            + 2.0_dp*abz*g(49) &
            + g(59)
         vbuf(36) = abz*abz*g(44) &
            + 2.0_dp*abz*g(50) &
            + g(60)
         vbuf(37) = abx*abx*g(62) &
            + 2.0_dp*abx*g(65) &
            + g(71)
         vbuf(38) = abx*abx*g(63) &
            + 2.0_dp*abx*g(66) &
            + g(72)
         vbuf(39) = abx*abx*g(64) &
            + 2.0_dp*abx*g(67) &
            + g(73)
         vbuf(40) = abx*aby*g(62) &
            + abx*g(66) &
            + aby*g(65) &
            + g(72)
         vbuf(41) = abx*aby*g(63) &
            + abx*g(68) &
            + aby*g(66) &
            + g(74)
         vbuf(42) = abx*aby*g(64) &
            + abx*g(69) &
            + aby*g(67) &
            + g(75)
         vbuf(43) = abx*abz*g(62) &
            + abx*g(67) &
            + abz*g(65) &
            + g(73)
         vbuf(44) = abx*abz*g(63) &
            + abx*g(69) &
            + abz*g(66) &
            + g(75)
         vbuf(45) = abx*abz*g(64) &
            + abx*g(70) &
            + abz*g(67) &
            + g(76)
         vbuf(46) = aby*aby*g(62) &
            + 2.0_dp*aby*g(66) &
            + g(74)
         vbuf(47) = aby*aby*g(63) &
            + 2.0_dp*aby*g(68) &
            + g(77)
         vbuf(48) = aby*aby*g(64) &
            + 2.0_dp*aby*g(69) &
            + g(78)
         vbuf(49) = aby*abz*g(62) &
            + aby*g(67) &
            + abz*g(66) &
            + g(75)
         vbuf(50) = aby*abz*g(63) &
            + aby*g(69) &
            + abz*g(68) &
            + g(78)
         vbuf(51) = aby*abz*g(64) &
            + aby*g(70) &
            + abz*g(69) &
            + g(79)
         vbuf(52) = abz*abz*g(62) &
            + 2.0_dp*abz*g(67) &
            + g(76)
         vbuf(53) = abz*abz*g(63) &
            + 2.0_dp*abz*g(69) &
            + g(79)
         vbuf(54) = abz*abz*g(64) &
            + 2.0_dp*abz*g(70) &
            + g(80)
