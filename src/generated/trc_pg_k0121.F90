!
! Class (01|21) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0121(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(3), jcd(18), kac(6)
      real(dp) :: kad(3), kbc(18), kbd(9)
      real(dp) :: dab(3), dcd(18), dac(6)
      real(dp) :: dad(3), dbc(18), dbd(9)
      ...
      if (gt > gend) return
         ...
         ! --- HRR ---
         vbuf(1) = abx*cdx*g1(17) &
            + abx*g1(41) &
            + cdx*g1(18) &
            + g1(42)
         vbuf(2) = aby*cdx*g1(17) &
            + aby*g1(41) &
            + cdx*g1(19) &
            + g1(43)
         vbuf(3) = abz*cdx*g1(17) &
            + abz*g1(41) &
            + cdx*g1(20) &
            + g1(44)
         vbuf(4) = abx*cdx*g1(21) &
            + abx*g1(45) &
            + cdx*g1(22) &
            + g1(46)
         vbuf(5) = aby*cdx*g1(21) &
            + aby*g1(45) &
            + cdx*g1(23) &
            + g1(47)
         vbuf(6) = abz*cdx*g1(21) &
            + abz*g1(45) &
            + cdx*g1(24) &
            + g1(48)
         vbuf(7) = abx*cdx*g1(25) &
            + abx*g1(49) &
            + cdx*g1(26) &
            + g1(50)
         vbuf(8) = aby*cdx*g1(25) &
            + aby*g1(49) &
            + cdx*g1(27) &
            + g1(51)
         vbuf(9) = abz*cdx*g1(25) &
            + abz*g1(49) &
            + cdx*g1(28) &
            + g1(52)
         vbuf(10) = abx*cdx*g1(29) &
            + abx*g1(53) &
            + cdx*g1(30) &
            + g1(54)
         vbuf(11) = aby*cdx*g1(29) &
            ...
            + cdx*g1(31) &
            + g1(55)
         vbuf(12) = abz*cdx*g1(29) &
            + abz*g1(53) &
            + cdx*g1(32) &
            + g1(56)
         vbuf(13) = abx*cdx*g1(33) &
            + abx*g1(57) &
            + cdx*g1(34) &
            + g1(58)
         vbuf(14) = aby*cdx*g1(33) &
            + aby*g1(57) &
            + cdx*g1(35) &
            + g1(59)
         vbuf(15) = abz*cdx*g1(33) &
            + abz*g1(57) &
            + cdx*g1(36) &
            + g1(60)
         vbuf(16) = abx*cdx*g1(37) &
            + abx*g1(61) &
            + cdx*g1(38) &
            + g1(62)
         vbuf(17) = aby*cdx*g1(37) &
            + aby*g1(61) &
            + cdx*g1(39) &
            + g1(63)
         vbuf(18) = abz*cdx*g1(37) &
            + abz*g1(61) &
            + cdx*g1(40) &
            + g1(64)
         vbuf(19) = abx*cdy*g1(17) &
            + abx*g1(45) &
            + cdy*g1(18) &
            + g1(46)
         vbuf(20) = aby*cdy*g1(17) &
            + aby*g1(45) &
            + cdy*g1(19) &
            + g1(47)
         vbuf(21) = abz*cdy*g1(17) &
            + abz*g1(45) &
            + cdy*g1(20) &
            + g1(48)
         vbuf(22) = abx*cdy*g1(21) &
            + abx*g1(53) &
            + cdy*g1(22) &
            + g1(54)
         vbuf(23) = aby*cdy*g1(21) &
            + aby*g1(53) &
            + cdy*g1(23) &
            + g1(55)
         vbuf(24) = abz*cdy*g1(21) &
            + abz*g1(53) &
            + cdy*g1(24) &
            + g1(56)
         vbuf(25) = abx*cdy*g1(25) &
            + abx*g1(57) &
            + cdy*g1(26) &
            + g1(58)
         vbuf(26) = aby*cdy*g1(25) &
            + aby*g1(57) &
            + cdy*g1(27) &
            + g1(59)
         vbuf(27) = abz*cdy*g1(25) &
            + abz*g1(57) &
            + cdy*g1(28) &
            + g1(60)
         vbuf(28) = abx*cdy*g1(29) &
            + abx*g1(65) &
            + cdy*g1(30) &
            + g1(66)
         vbuf(29) = aby*cdy*g1(29) &
            + aby*g1(65) &
            + cdy*g1(31) &
            + g1(67)
         vbuf(30) = abz*cdy*g1(29) &
            + abz*g1(65) &
            + cdy*g1(32) &
            + g1(68)
         vbuf(31) = abx*cdy*g1(33) &
            + abx*g1(69) &
            + cdy*g1(34) &
            + g1(70)
         vbuf(32) = aby*cdy*g1(33) &
            + aby*g1(69) &
            + cdy*g1(35) &
            + g1(71)
         vbuf(33) = abz*cdy*g1(33) &
            + abz*g1(69) &
            + cdy*g1(36) &
            + g1(72)
         vbuf(34) = abx*cdy*g1(37) &
            + abx*g1(73) &
            + cdy*g1(38) &
            + g1(74)
         vbuf(35) = aby*cdy*g1(37) &
            + aby*g1(73) &
            + cdy*g1(39) &
            + g1(75)
         vbuf(36) = abz*cdy*g1(37) &
            + abz*g1(73) &
            + cdy*g1(40) &
            + g1(76)
         vbuf(37) = abx*cdz*g1(17) &
            + abx*g1(49) &
            + cdz*g1(18) &
            + g1(50)
         vbuf(38) = aby*cdz*g1(17) &
            + aby*g1(49) &
            + cdz*g1(19) &
            + g1(51)
         vbuf(39) = abz*cdz*g1(17) &
            + abz*g1(49) &
            + cdz*g1(20) &
            + g1(52)
         vbuf(40) = abx*cdz*g1(21) &
            + abx*g1(57) &
            + cdz*g1(22) &
            + g1(58)
         vbuf(41) = aby*cdz*g1(21) &
            + aby*g1(57) &
            + cdz*g1(23) &
            + g1(59)
         vbuf(42) = abz*cdz*g1(21) &
            + abz*g1(57) &
            + cdz*g1(24) &
            + g1(60)
         vbuf(43) = abx*cdz*g1(25) &
            + abx*g1(61) &
            + cdz*g1(26) &
            + g1(62)
         vbuf(44) = aby*cdz*g1(25) &
            + aby*g1(61) &
            + cdz*g1(27) &
            + g1(63)
         vbuf(45) = abz*cdz*g1(25) &
            + abz*g1(61) &
            + cdz*g1(28) &
            + g1(64)
         vbuf(46) = abx*cdz*g1(29) &
            + abx*g1(69) &
            + cdz*g1(30) &
            + g1(70)
         vbuf(47) = aby*cdz*g1(29) &
            + aby*g1(69) &
            + cdz*g1(31) &
            + g1(71)
         vbuf(48) = abz*cdz*g1(29) &
            + abz*g1(69) &
            + cdz*g1(32) &
            + g1(72)
         vbuf(49) = abx*cdz*g1(33) &
            + abx*g1(73) &
            + cdz*g1(34) &
            + g1(74)
         vbuf(50) = aby*cdz*g1(33) &
            + aby*g1(73) &
            + cdz*g1(35) &
            + g1(75)
         vbuf(51) = abz*cdz*g1(33) &
            + abz*g1(73) &
            + cdz*g1(36) &
            + g1(76)
         vbuf(52) = abx*cdz*g1(37) &
            + abx*g1(77) &
            + cdz*g1(38) &
            + g1(78)
         vbuf(53) = aby*cdz*g1(37) &
            + aby*g1(77) &
            + cdz*g1(39) &
            + g1(79)
         vbuf(54) = abz*cdz*g1(37) &
            + abz*g1(77) &
            + cdz*g1(40) &
            + g1(80)
   ...
   end subroutine pg0121
#endif
end module trc_pg_k0121
