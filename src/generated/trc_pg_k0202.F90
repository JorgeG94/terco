!
! Class (02|02) cooperative kernel, CUDA Fortran.
!
...
module trc_pg_k0202
   ...
   integer, parameter :: PG_T = 32, PG_GB = 30
   !> ket columns per chunk, bra columns per chunk, owned entries per lane
   integer, parameter :: CDC = 1, ABC = 16, NTC = 100

contains

   attributes(global) subroutine pg0202(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: v(100, 0:1), g1(100), vbuf(36)
      ...
      real(dp) :: jab(6), jcd(6), kac(1)
      real(dp) :: kad(6), kbc(6), kbd(36)
      real(dp) :: dab(6), dcd(6), dac(1)
      real(dp) :: dad(6), dbc(6), dbd(36)
      ...
      pcut = thresh*1.0e-3_dp
                  ...
                  if (tau <= nabc) then
                     do c = 1, ncdc
                        ...
                        if (combo >= cb0 .and. combo < cb0 + nbt) then
                           do x = 1, 100
                              Gs(x, combo - cb0 + 1) = gown(x + (c - 1)*100)
                           end do
                        end if
                     end do
                  end if
         ...
         ! --- HRR ---
         vbuf(1) = abx*abx*cdx*cdx*g1(1) &
            + 2.0_dp*abx*abx*cdx*g1(11) &
            + abx*abx*g1(41) &
            + 2.0_dp*abx*cdx*cdx*g1(2) &
            + 4.0_dp*abx*cdx*g1(12) &
            + 2.0_dp*abx*g1(42) &
            + cdx*cdx*g1(5) &
            + 2.0_dp*cdx*g1(15) &
            + g1(45)
         vbuf(2) = abx*aby*cdx*cdx*g1(1) &
            + 2.0_dp*abx*aby*cdx*g1(11) &
            + abx*aby*g1(41) &
            + abx*cdx*cdx*g1(3) &
            ...
            + 2.0_dp*cdx*g1(16) &
            + g1(46)
         vbuf(3) = abx*abz*cdx*cdx*g1(1) &
            + 2.0_dp*abx*abz*cdx*g1(11) &
            + abx*abz*g1(41) &
            + abx*cdx*cdx*g1(4) &
            ...
            + 2.0_dp*cdx*g1(17) &
            + g1(47)
         vbuf(4) = aby*aby*cdx*cdx*g1(1) &
            + 2.0_dp*aby*aby*cdx*g1(11) &
            + aby*aby*g1(41) &
            + 2.0_dp*aby*cdx*cdx*g1(3) &
            + 4.0_dp*aby*cdx*g1(13) &
            + 2.0_dp*aby*g1(43) &
            + cdx*cdx*g1(8) &
            + 2.0_dp*cdx*g1(18) &
            + g1(48)
         vbuf(5) = aby*abz*cdx*cdx*g1(1) &
            + 2.0_dp*aby*abz*cdx*g1(11) &
            + aby*abz*g1(41) &
            + aby*cdx*cdx*g1(4) &
            ...
            + 2.0_dp*cdx*g1(19) &
            + g1(49)
         vbuf(6) = abz*abz*cdx*cdx*g1(1) &
            + 2.0_dp*abz*abz*cdx*g1(11) &
            + abz*abz*g1(41) &
            + 2.0_dp*abz*cdx*cdx*g1(4) &
            + 4.0_dp*abz*cdx*g1(14) &
            + 2.0_dp*abz*g1(44) &
            + cdx*cdx*g1(10) &
            + 2.0_dp*cdx*g1(20) &
            + g1(50)
         vbuf(7) = abx*abx*cdx*cdy*g1(1) &
            + abx*abx*cdx*g1(21) &
            + abx*abx*cdy*g1(11) &
            + abx*abx*g1(51) &
            + 2.0_dp*abx*cdx*cdy*g1(2) &
         ...
         vbuf(9) = abx*abz*cdx*cdy*g1(1) &
            ...
            + cdy*g1(17) &
            + g1(57)
         vbuf(10) = aby*aby*cdx*cdy*g1(1) &
            + aby*aby*cdx*g1(21) &
            + aby*aby*cdy*g1(11) &
            + aby*aby*g1(51) &
            + 2.0_dp*aby*cdx*cdy*g1(3) &
         ...
         vbuf(11) = aby*abz*cdx*cdy*g1(1) &
            ...
            + cdy*g1(19) &
            + g1(59)
         vbuf(12) = abz*abz*cdx*cdy*g1(1) &
            + abz*abz*cdx*g1(21) &
            + abz*abz*cdy*g1(11) &
            + abz*abz*g1(51) &
            + 2.0_dp*abz*cdx*cdy*g1(4) &
            ...
            + cdy*g1(20) &
            + g1(60)
         vbuf(13) = abx*abx*cdx*cdz*g1(1) &
            + abx*abx*cdx*g1(31) &
            + abx*abx*cdz*g1(11) &
            + abx*abx*g1(61) &
            + 2.0_dp*abx*cdx*cdz*g1(2) &
         ...
         vbuf(15) = abx*abz*cdx*cdz*g1(1) &
            ...
            + cdz*g1(17) &
            + g1(67)
         vbuf(16) = aby*aby*cdx*cdz*g1(1) &
            + aby*aby*cdx*g1(31) &
            + aby*aby*cdz*g1(11) &
            + aby*aby*g1(61) &
            + 2.0_dp*aby*cdx*cdz*g1(3) &
         ...
         vbuf(17) = aby*abz*cdx*cdz*g1(1) &
            ...
            + cdz*g1(19) &
            + g1(69)
         vbuf(18) = abz*abz*cdx*cdz*g1(1) &
            + abz*abz*cdx*g1(31) &
            + abz*abz*cdz*g1(11) &
            + abz*abz*g1(61) &
            + 2.0_dp*abz*cdx*cdz*g1(4) &
            ...
            + cdz*g1(20) &
            + g1(70)
         vbuf(19) = abx*abx*cdy*cdy*g1(1) &
            + 2.0_dp*abx*abx*cdy*g1(21) &
            + abx*abx*g1(71) &
            + 2.0_dp*abx*cdy*cdy*g1(2) &
            + 4.0_dp*abx*cdy*g1(22) &
            + 2.0_dp*abx*g1(72) &
            + cdy*cdy*g1(5) &
            + 2.0_dp*cdy*g1(25) &
            + g1(75)
         vbuf(20) = abx*aby*cdy*cdy*g1(1) &
            + 2.0_dp*abx*aby*cdy*g1(21) &
            + abx*aby*g1(71) &
            + abx*cdy*cdy*g1(3) &
            + 2.0_dp*abx*cdy*g1(23) &
            + abx*g1(73) &
            + aby*cdy*cdy*g1(2) &
            + 2.0_dp*aby*cdy*g1(22) &
            + aby*g1(72) &
            + cdy*cdy*g1(6) &
            + 2.0_dp*cdy*g1(26) &
            + g1(76)
         vbuf(21) = abx*abz*cdy*cdy*g1(1) &
            + 2.0_dp*abx*abz*cdy*g1(21) &
            + abx*abz*g1(71) &
            + abx*cdy*cdy*g1(4) &
            + 2.0_dp*abx*cdy*g1(24) &
            + abx*g1(74) &
            + abz*cdy*cdy*g1(2) &
            + 2.0_dp*abz*cdy*g1(22) &
            + abz*g1(72) &
            + cdy*cdy*g1(7) &
            + 2.0_dp*cdy*g1(27) &
            + g1(77)
         vbuf(22) = aby*aby*cdy*cdy*g1(1) &
            + 2.0_dp*aby*aby*cdy*g1(21) &
            + aby*aby*g1(71) &
            + 2.0_dp*aby*cdy*cdy*g1(3) &
            + 4.0_dp*aby*cdy*g1(23) &
            + 2.0_dp*aby*g1(73) &
            + cdy*cdy*g1(8) &
            + 2.0_dp*cdy*g1(28) &
            + g1(78)
         vbuf(23) = aby*abz*cdy*cdy*g1(1) &
            + 2.0_dp*aby*abz*cdy*g1(21) &
            + aby*abz*g1(71) &
            + aby*cdy*cdy*g1(4) &
            + 2.0_dp*aby*cdy*g1(24) &
            + aby*g1(74) &
            + abz*cdy*cdy*g1(3) &
            + 2.0_dp*abz*cdy*g1(23) &
            + abz*g1(73) &
            + cdy*cdy*g1(9) &
            + 2.0_dp*cdy*g1(29) &
            + g1(79)
         vbuf(24) = abz*abz*cdy*cdy*g1(1) &
            + 2.0_dp*abz*abz*cdy*g1(21) &
            + abz*abz*g1(71) &
            + 2.0_dp*abz*cdy*cdy*g1(4) &
            + 4.0_dp*abz*cdy*g1(24) &
            + 2.0_dp*abz*g1(74) &
            + cdy*cdy*g1(10) &
            + 2.0_dp*cdy*g1(30) &
            + g1(80)
         vbuf(25) = abx*abx*cdy*cdz*g1(1) &
            + abx*abx*cdy*g1(31) &
            + abx*abx*cdz*g1(21) &
            + abx*abx*g1(81) &
            + 2.0_dp*abx*cdy*cdz*g1(2) &
         ...
         vbuf(27) = abx*abz*cdy*cdz*g1(1) &
            ...
            + cdz*g1(27) &
            + g1(87)
         vbuf(28) = aby*aby*cdy*cdz*g1(1) &
            + aby*aby*cdy*g1(31) &
            + aby*aby*cdz*g1(21) &
            + aby*aby*g1(81) &
            + 2.0_dp*aby*cdy*cdz*g1(3) &
         ...
         vbuf(29) = aby*abz*cdy*cdz*g1(1) &
            ...
            + cdz*g1(29) &
            + g1(89)
         vbuf(30) = abz*abz*cdy*cdz*g1(1) &
            + abz*abz*cdy*g1(31) &
            + abz*abz*cdz*g1(21) &
            + abz*abz*g1(81) &
            + 2.0_dp*abz*cdy*cdz*g1(4) &
            ...
            + cdz*g1(30) &
            + g1(90)
         vbuf(31) = abx*abx*cdz*cdz*g1(1) &
            + 2.0_dp*abx*abx*cdz*g1(31) &
            + abx*abx*g1(91) &
            + 2.0_dp*abx*cdz*cdz*g1(2) &
            + 4.0_dp*abx*cdz*g1(32) &
            + 2.0_dp*abx*g1(92) &
            + cdz*cdz*g1(5) &
            + 2.0_dp*cdz*g1(35) &
            + g1(95)
         vbuf(32) = abx*aby*cdz*cdz*g1(1) &
            + 2.0_dp*abx*aby*cdz*g1(31) &
            + abx*aby*g1(91) &
            + abx*cdz*cdz*g1(3) &
            + 2.0_dp*abx*cdz*g1(33) &
            + abx*g1(93) &
            + aby*cdz*cdz*g1(2) &
            + 2.0_dp*aby*cdz*g1(32) &
            + aby*g1(92) &
            + cdz*cdz*g1(6) &
            + 2.0_dp*cdz*g1(36) &
            + g1(96)
         vbuf(33) = abx*abz*cdz*cdz*g1(1) &
            + 2.0_dp*abx*abz*cdz*g1(31) &
            + abx*abz*g1(91) &
            + abx*cdz*cdz*g1(4) &
            + 2.0_dp*abx*cdz*g1(34) &
            + abx*g1(94) &
            + abz*cdz*cdz*g1(2) &
            + 2.0_dp*abz*cdz*g1(32) &
            + abz*g1(92) &
            + cdz*cdz*g1(7) &
            + 2.0_dp*cdz*g1(37) &
            + g1(97)
         vbuf(34) = aby*aby*cdz*cdz*g1(1) &
            + 2.0_dp*aby*aby*cdz*g1(31) &
            + aby*aby*g1(91) &
            + 2.0_dp*aby*cdz*cdz*g1(3) &
            + 4.0_dp*aby*cdz*g1(33) &
            + 2.0_dp*aby*g1(93) &
            + cdz*cdz*g1(8) &
            + 2.0_dp*cdz*g1(38) &
            + g1(98)
         vbuf(35) = aby*abz*cdz*cdz*g1(1) &
            + 2.0_dp*aby*abz*cdz*g1(31) &
            + aby*abz*g1(91) &
            + aby*cdz*cdz*g1(4) &
            + 2.0_dp*aby*cdz*g1(34) &
            + aby*g1(94) &
            + abz*cdz*cdz*g1(3) &
            ...
            + 2.0_dp*cdz*g1(39) &
            + g1(99)
         vbuf(36) = abz*abz*cdz*cdz*g1(1) &
            + 2.0_dp*abz*abz*cdz*g1(31) &
            + abz*abz*g1(91) &
            + 2.0_dp*abz*cdz*cdz*g1(4) &
            + 4.0_dp*abz*cdz*g1(34) &
            + 2.0_dp*abz*g1(94) &
            + cdz*cdz*g1(10) &
            + 2.0_dp*cdz*g1(40) &
            + g1(100)
   ...
   end subroutine pg0202
#endif
end module trc_pg_k0202
