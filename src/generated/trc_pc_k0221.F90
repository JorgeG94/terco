...
contains
   ...
   pure subroutine pci0221(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*g(41) &
            + abx*abx*g(101) &
            + 2.0_dp*abx*cdx*g(42) &
            + 2.0_dp*abx*g(102) &
            + cdx*g(45) &
            + g(105)
         vbuf(2) = abx*aby*cdx*g(41) &
            + abx*aby*g(101) &
            + abx*cdx*g(43) &
            + abx*g(103) &
            + aby*cdx*g(42) &
         ...
         vbuf(3) = abx*abz*cdx*g(41) &
            ...
            + cdx*g(47) &
            + g(107)
         vbuf(4) = aby*aby*cdx*g(41) &
            + aby*aby*g(101) &
            + 2.0_dp*aby*cdx*g(43) &
            + 2.0_dp*aby*g(103) &
            + cdx*g(48) &
            + g(108)
         vbuf(5) = aby*abz*cdx*g(41) &
            + aby*abz*g(101) &
            + aby*cdx*g(44) &
            + aby*g(104) &
            + abz*cdx*g(43) &
            ...
            + cdx*g(49) &
            + g(109)
         vbuf(6) = abz*abz*cdx*g(41) &
            + abz*abz*g(101) &
            + 2.0_dp*abz*cdx*g(44) &
            + 2.0_dp*abz*g(104) &
            + cdx*g(50) &
            + g(110)
         vbuf(7) = abx*abx*cdx*g(51) &
            + abx*abx*g(111) &
            + 2.0_dp*abx*cdx*g(52) &
            + 2.0_dp*abx*g(112) &
            + cdx*g(55) &
            + g(115)
         vbuf(8) = abx*aby*cdx*g(51) &
            + abx*aby*g(111) &
            + abx*cdx*g(53) &
            + abx*g(113) &
            + aby*cdx*g(52) &
         ...
         vbuf(9) = abx*abz*cdx*g(51) &
            ...
            + cdx*g(57) &
            + g(117)
         vbuf(10) = aby*aby*cdx*g(51) &
            + aby*aby*g(111) &
            + 2.0_dp*aby*cdx*g(53) &
            + 2.0_dp*aby*g(113) &
            + cdx*g(58) &
            + g(118)
         vbuf(11) = aby*abz*cdx*g(51) &
            + aby*abz*g(111) &
            + aby*cdx*g(54) &
            + aby*g(114) &
            + abz*cdx*g(53) &
            ...
            + cdx*g(59) &
            + g(119)
         vbuf(12) = abz*abz*cdx*g(51) &
            + abz*abz*g(111) &
            + 2.0_dp*abz*cdx*g(54) &
            + 2.0_dp*abz*g(114) &
            + cdx*g(60) &
            + g(120)
         vbuf(13) = abx*abx*cdx*g(61) &
            + abx*abx*g(121) &
            + 2.0_dp*abx*cdx*g(62) &
            + 2.0_dp*abx*g(122) &
            + cdx*g(65) &
            + g(125)
         vbuf(14) = abx*aby*cdx*g(61) &
            + abx*aby*g(121) &
            + abx*cdx*g(63) &
            + abx*g(123) &
            + aby*cdx*g(62) &
         ...
         vbuf(15) = abx*abz*cdx*g(61) &
            ...
            + cdx*g(67) &
            + g(127)
         vbuf(16) = aby*aby*cdx*g(61) &
            + aby*aby*g(121) &
            + 2.0_dp*aby*cdx*g(63) &
            + 2.0_dp*aby*g(123) &
            + cdx*g(68) &
            + g(128)
         vbuf(17) = aby*abz*cdx*g(61) &
            + aby*abz*g(121) &
            + aby*cdx*g(64) &
            + aby*g(124) &
            + abz*cdx*g(63) &
            ...
            + cdx*g(69) &
            + g(129)
         vbuf(18) = abz*abz*cdx*g(61) &
            + abz*abz*g(121) &
            + 2.0_dp*abz*cdx*g(64) &
            + 2.0_dp*abz*g(124) &
            + cdx*g(70) &
            + g(130)
         vbuf(19) = abx*abx*cdx*g(71) &
            + abx*abx*g(131) &
            + 2.0_dp*abx*cdx*g(72) &
            + 2.0_dp*abx*g(132) &
            + cdx*g(75) &
            + g(135)
         vbuf(20) = abx*aby*cdx*g(71) &
            + abx*aby*g(131) &
            + abx*cdx*g(73) &
            + abx*g(133) &
            + aby*cdx*g(72) &
         ...
         vbuf(21) = abx*abz*cdx*g(71) &
            ...
            + cdx*g(77) &
            + g(137)
         vbuf(22) = aby*aby*cdx*g(71) &
            + aby*aby*g(131) &
            + 2.0_dp*aby*cdx*g(73) &
            + 2.0_dp*aby*g(133) &
            + cdx*g(78) &
            + g(138)
         vbuf(23) = aby*abz*cdx*g(71) &
            + aby*abz*g(131) &
            + aby*cdx*g(74) &
            + aby*g(134) &
            + abz*cdx*g(73) &
            ...
            + cdx*g(79) &
            + g(139)
         vbuf(24) = abz*abz*cdx*g(71) &
            + abz*abz*g(131) &
            + 2.0_dp*abz*cdx*g(74) &
            + 2.0_dp*abz*g(134) &
            + cdx*g(80) &
            + g(140)
         vbuf(25) = abx*abx*cdx*g(81) &
            + abx*abx*g(141) &
            + 2.0_dp*abx*cdx*g(82) &
            + 2.0_dp*abx*g(142) &
            + cdx*g(85) &
            + g(145)
         vbuf(26) = abx*aby*cdx*g(81) &
            + abx*aby*g(141) &
            + abx*cdx*g(83) &
            + abx*g(143) &
            + aby*cdx*g(82) &
         ...
         vbuf(27) = abx*abz*cdx*g(81) &
            ...
            + cdx*g(87) &
            + g(147)
         vbuf(28) = aby*aby*cdx*g(81) &
            + aby*aby*g(141) &
            + 2.0_dp*aby*cdx*g(83) &
            + 2.0_dp*aby*g(143) &
            + cdx*g(88) &
            + g(148)
         vbuf(29) = aby*abz*cdx*g(81) &
            + aby*abz*g(141) &
            + aby*cdx*g(84) &
            + aby*g(144) &
            + abz*cdx*g(83) &
            ...
            + cdx*g(89) &
            + g(149)
         vbuf(30) = abz*abz*cdx*g(81) &
            + abz*abz*g(141) &
            + 2.0_dp*abz*cdx*g(84) &
            + 2.0_dp*abz*g(144) &
            + cdx*g(90) &
            + g(150)
         vbuf(31) = abx*abx*cdx*g(91) &
            + abx*abx*g(151) &
            + 2.0_dp*abx*cdx*g(92) &
            + 2.0_dp*abx*g(152) &
            + cdx*g(95) &
            + g(155)
         vbuf(32) = abx*aby*cdx*g(91) &
            + abx*aby*g(151) &
            + abx*cdx*g(93) &
            + abx*g(153) &
            + aby*cdx*g(92) &
         ...
         vbuf(33) = abx*abz*cdx*g(91) &
            ...
            + cdx*g(97) &
            + g(157)
         vbuf(34) = aby*aby*cdx*g(91) &
            + aby*aby*g(151) &
            + 2.0_dp*aby*cdx*g(93) &
            + 2.0_dp*aby*g(153) &
            + cdx*g(98) &
            + g(158)
         vbuf(35) = aby*abz*cdx*g(91) &
            + aby*abz*g(151) &
            + aby*cdx*g(94) &
            + aby*g(154) &
            + abz*cdx*g(93) &
            ...
            + cdx*g(99) &
            + g(159)
         vbuf(36) = abz*abz*cdx*g(91) &
            + abz*abz*g(151) &
            + 2.0_dp*abz*cdx*g(94) &
            + 2.0_dp*abz*g(154) &
            + cdx*g(100) &
            + g(160)
         vbuf(37) = abx*abx*cdy*g(41) &
            + abx*abx*g(111) &
            + 2.0_dp*abx*cdy*g(42) &
            + 2.0_dp*abx*g(112) &
            + cdy*g(45) &
            + g(115)
         vbuf(38) = abx*aby*cdy*g(41) &
            + abx*aby*g(111) &
            + abx*cdy*g(43) &
            + abx*g(113) &
            + aby*cdy*g(42) &
         ...
         vbuf(39) = abx*abz*cdy*g(41) &
            ...
            + cdy*g(47) &
            + g(117)
         vbuf(40) = aby*aby*cdy*g(41) &
            + aby*aby*g(111) &
            + 2.0_dp*aby*cdy*g(43) &
            + 2.0_dp*aby*g(113) &
            + cdy*g(48) &
            + g(118)
         vbuf(41) = aby*abz*cdy*g(41) &
            + aby*abz*g(111) &
            + aby*cdy*g(44) &
            + aby*g(114) &
            + abz*cdy*g(43) &
            ...
            + cdy*g(49) &
            + g(119)
         vbuf(42) = abz*abz*cdy*g(41) &
            + abz*abz*g(111) &
            + 2.0_dp*abz*cdy*g(44) &
            + 2.0_dp*abz*g(114) &
            + cdy*g(50) &
            + g(120)
         vbuf(43) = abx*abx*cdy*g(51) &
            + abx*abx*g(131) &
            + 2.0_dp*abx*cdy*g(52) &
            + 2.0_dp*abx*g(132) &
            + cdy*g(55) &
            + g(135)
         vbuf(44) = abx*aby*cdy*g(51) &
            + abx*aby*g(131) &
            + abx*cdy*g(53) &
            + abx*g(133) &
            + aby*cdy*g(52) &
         ...
         vbuf(45) = abx*abz*cdy*g(51) &
            ...
            + cdy*g(57) &
            + g(137)
         vbuf(46) = aby*aby*cdy*g(51) &
            + aby*aby*g(131) &
            + 2.0_dp*aby*cdy*g(53) &
            + 2.0_dp*aby*g(133) &
            + cdy*g(58) &
            + g(138)
         vbuf(47) = aby*abz*cdy*g(51) &
            + aby*abz*g(131) &
            + aby*cdy*g(54) &
            + aby*g(134) &
            + abz*cdy*g(53) &
            ...
            + cdy*g(59) &
            + g(139)
         vbuf(48) = abz*abz*cdy*g(51) &
            + abz*abz*g(131) &
            + 2.0_dp*abz*cdy*g(54) &
            + 2.0_dp*abz*g(134) &
            + cdy*g(60) &
            + g(140)
         vbuf(49) = abx*abx*cdy*g(61) &
            + abx*abx*g(141) &
            + 2.0_dp*abx*cdy*g(62) &
            + 2.0_dp*abx*g(142) &
            + cdy*g(65) &
            + g(145)
         vbuf(50) = abx*aby*cdy*g(61) &
            + abx*aby*g(141) &
            + abx*cdy*g(63) &
            + abx*g(143) &
            + aby*cdy*g(62) &
         ...
         vbuf(51) = abx*abz*cdy*g(61) &
            ...
            + cdy*g(67) &
            + g(147)
         vbuf(52) = aby*aby*cdy*g(61) &
            + aby*aby*g(141) &
            + 2.0_dp*aby*cdy*g(63) &
            + 2.0_dp*aby*g(143) &
            + cdy*g(68) &
            + g(148)
         vbuf(53) = aby*abz*cdy*g(61) &
            + aby*abz*g(141) &
            + aby*cdy*g(64) &
            + aby*g(144) &
            + abz*cdy*g(63) &
            ...
            + cdy*g(69) &
            + g(149)
         vbuf(54) = abz*abz*cdy*g(61) &
            + abz*abz*g(141) &
            + 2.0_dp*abz*cdy*g(64) &
            + 2.0_dp*abz*g(144) &
            + cdy*g(70) &
            + g(150)
         vbuf(55) = abx*abx*cdy*g(71) &
            + abx*abx*g(161) &
            + 2.0_dp*abx*cdy*g(72) &
            + 2.0_dp*abx*g(162) &
            + cdy*g(75) &
            + g(165)
         vbuf(56) = abx*aby*cdy*g(71) &
            + abx*aby*g(161) &
            + abx*cdy*g(73) &
            + abx*g(163) &
            + aby*cdy*g(72) &
         ...
         vbuf(57) = abx*abz*cdy*g(71) &
            ...
            + cdy*g(77) &
            + g(167)
         vbuf(58) = aby*aby*cdy*g(71) &
            + aby*aby*g(161) &
            + 2.0_dp*aby*cdy*g(73) &
            + 2.0_dp*aby*g(163) &
            + cdy*g(78) &
            + g(168)
         vbuf(59) = aby*abz*cdy*g(71) &
            + aby*abz*g(161) &
            + aby*cdy*g(74) &
            + aby*g(164) &
            + abz*cdy*g(73) &
            ...
            + cdy*g(79) &
            + g(169)
         vbuf(60) = abz*abz*cdy*g(71) &
            + abz*abz*g(161) &
            + 2.0_dp*abz*cdy*g(74) &
            + 2.0_dp*abz*g(164) &
            + cdy*g(80) &
            + g(170)
         vbuf(61) = abx*abx*cdy*g(81) &
            + abx*abx*g(171) &
            + 2.0_dp*abx*cdy*g(82) &
            + 2.0_dp*abx*g(172) &
            + cdy*g(85) &
            + g(175)
         vbuf(62) = abx*aby*cdy*g(81) &
            + abx*aby*g(171) &
            + abx*cdy*g(83) &
            + abx*g(173) &
            + aby*cdy*g(82) &
         ...
         vbuf(63) = abx*abz*cdy*g(81) &
            ...
            + cdy*g(87) &
            + g(177)
         vbuf(64) = aby*aby*cdy*g(81) &
            + aby*aby*g(171) &
            + 2.0_dp*aby*cdy*g(83) &
            + 2.0_dp*aby*g(173) &
            + cdy*g(88) &
            + g(178)
         vbuf(65) = aby*abz*cdy*g(81) &
            + aby*abz*g(171) &
            + aby*cdy*g(84) &
            + aby*g(174) &
            + abz*cdy*g(83) &
            ...
            + cdy*g(89) &
            + g(179)
         vbuf(66) = abz*abz*cdy*g(81) &
            + abz*abz*g(171) &
            + 2.0_dp*abz*cdy*g(84) &
            + 2.0_dp*abz*g(174) &
            + cdy*g(90) &
            + g(180)
         vbuf(67) = abx*abx*cdy*g(91) &
            + abx*abx*g(181) &
            + 2.0_dp*abx*cdy*g(92) &
            + 2.0_dp*abx*g(182) &
            + cdy*g(95) &
            + g(185)
         vbuf(68) = abx*aby*cdy*g(91) &
            + abx*aby*g(181) &
            + abx*cdy*g(93) &
            + abx*g(183) &
            + aby*cdy*g(92) &
         ...
         vbuf(69) = abx*abz*cdy*g(91) &
            ...
            + cdy*g(97) &
            + g(187)
         vbuf(70) = aby*aby*cdy*g(91) &
            + aby*aby*g(181) &
            + 2.0_dp*aby*cdy*g(93) &
            + 2.0_dp*aby*g(183) &
            + cdy*g(98) &
            + g(188)
         vbuf(71) = aby*abz*cdy*g(91) &
            + aby*abz*g(181) &
            + aby*cdy*g(94) &
            + aby*g(184) &
            + abz*cdy*g(93) &
            ...
            + cdy*g(99) &
            + g(189)
         vbuf(72) = abz*abz*cdy*g(91) &
            + abz*abz*g(181) &
            + 2.0_dp*abz*cdy*g(94) &
            + 2.0_dp*abz*g(184) &
            + cdy*g(100) &
            + g(190)
         vbuf(73) = abx*abx*cdz*g(41) &
            + abx*abx*g(121) &
            + 2.0_dp*abx*cdz*g(42) &
            + 2.0_dp*abx*g(122) &
            + cdz*g(45) &
            + g(125)
         vbuf(74) = abx*aby*cdz*g(41) &
            + abx*aby*g(121) &
            + abx*cdz*g(43) &
            + abx*g(123) &
            + aby*cdz*g(42) &
         ...
         vbuf(75) = abx*abz*cdz*g(41) &
            ...
            + cdz*g(47) &
            + g(127)
         vbuf(76) = aby*aby*cdz*g(41) &
            + aby*aby*g(121) &
            + 2.0_dp*aby*cdz*g(43) &
            + 2.0_dp*aby*g(123) &
            + cdz*g(48) &
            + g(128)
         vbuf(77) = aby*abz*cdz*g(41) &
            + aby*abz*g(121) &
            + aby*cdz*g(44) &
            + aby*g(124) &
            + abz*cdz*g(43) &
            ...
            + cdz*g(49) &
            + g(129)
         vbuf(78) = abz*abz*cdz*g(41) &
            + abz*abz*g(121) &
            + 2.0_dp*abz*cdz*g(44) &
            + 2.0_dp*abz*g(124) &
            + cdz*g(50) &
            + g(130)
         vbuf(79) = abx*abx*cdz*g(51) &
            + abx*abx*g(141) &
            + 2.0_dp*abx*cdz*g(52) &
            + 2.0_dp*abx*g(142) &
            + cdz*g(55) &
            + g(145)
         vbuf(80) = abx*aby*cdz*g(51) &
            + abx*aby*g(141) &
            + abx*cdz*g(53) &
            + abx*g(143) &
            + aby*cdz*g(52) &
         ...
         vbuf(81) = abx*abz*cdz*g(51) &
            ...
            + cdz*g(57) &
            + g(147)
         vbuf(82) = aby*aby*cdz*g(51) &
            + aby*aby*g(141) &
            + 2.0_dp*aby*cdz*g(53) &
            + 2.0_dp*aby*g(143) &
            + cdz*g(58) &
            + g(148)
         vbuf(83) = aby*abz*cdz*g(51) &
            + aby*abz*g(141) &
            + aby*cdz*g(54) &
            + aby*g(144) &
            + abz*cdz*g(53) &
            ...
            + cdz*g(59) &
            + g(149)
         vbuf(84) = abz*abz*cdz*g(51) &
            + abz*abz*g(141) &
            + 2.0_dp*abz*cdz*g(54) &
            + 2.0_dp*abz*g(144) &
            + cdz*g(60) &
            + g(150)
         vbuf(85) = abx*abx*cdz*g(61) &
            + abx*abx*g(151) &
            + 2.0_dp*abx*cdz*g(62) &
            + 2.0_dp*abx*g(152) &
            + cdz*g(65) &
            + g(155)
         vbuf(86) = abx*aby*cdz*g(61) &
            + abx*aby*g(151) &
            + abx*cdz*g(63) &
            + abx*g(153) &
            + aby*cdz*g(62) &
         ...
         vbuf(87) = abx*abz*cdz*g(61) &
            ...
            + cdz*g(67) &
            + g(157)
         vbuf(88) = aby*aby*cdz*g(61) &
            + aby*aby*g(151) &
            + 2.0_dp*aby*cdz*g(63) &
            + 2.0_dp*aby*g(153) &
            + cdz*g(68) &
            + g(158)
         vbuf(89) = aby*abz*cdz*g(61) &
            + aby*abz*g(151) &
            + aby*cdz*g(64) &
            + aby*g(154) &
            + abz*cdz*g(63) &
            ...
            + cdz*g(69) &
            + g(159)
         vbuf(90) = abz*abz*cdz*g(61) &
            + abz*abz*g(151) &
            + 2.0_dp*abz*cdz*g(64) &
            + 2.0_dp*abz*g(154) &
            + cdz*g(70) &
            + g(160)
         vbuf(91) = abx*abx*cdz*g(71) &
            + abx*abx*g(171) &
            + 2.0_dp*abx*cdz*g(72) &
            + 2.0_dp*abx*g(172) &
            + cdz*g(75) &
            + g(175)
         vbuf(92) = abx*aby*cdz*g(71) &
            + abx*aby*g(171) &
            + abx*cdz*g(73) &
            + abx*g(173) &
            + aby*cdz*g(72) &
         ...
         vbuf(93) = abx*abz*cdz*g(71) &
            ...
            + cdz*g(77) &
            + g(177)
         vbuf(94) = aby*aby*cdz*g(71) &
            + aby*aby*g(171) &
            + 2.0_dp*aby*cdz*g(73) &
            + 2.0_dp*aby*g(173) &
            + cdz*g(78) &
            + g(178)
         vbuf(95) = aby*abz*cdz*g(71) &
            + aby*abz*g(171) &
            + aby*cdz*g(74) &
            + aby*g(174) &
            + abz*cdz*g(73) &
            ...
            + cdz*g(79) &
            + g(179)
         vbuf(96) = abz*abz*cdz*g(71) &
            + abz*abz*g(171) &
            + 2.0_dp*abz*cdz*g(74) &
            + 2.0_dp*abz*g(174) &
            + cdz*g(80) &
            + g(180)
         vbuf(97) = abx*abx*cdz*g(81) &
            + abx*abx*g(181) &
            + 2.0_dp*abx*cdz*g(82) &
            + 2.0_dp*abx*g(182) &
            + cdz*g(85) &
            + g(185)
         vbuf(98) = abx*aby*cdz*g(81) &
            + abx*aby*g(181) &
            + abx*cdz*g(83) &
            + abx*g(183) &
            + aby*cdz*g(82) &
         ...
         vbuf(99) = abx*abz*cdz*g(81) &
            ...
            + cdz*g(87) &
            + g(187)
         vbuf(100) = aby*aby*cdz*g(81) &
            + aby*aby*g(181) &
            + 2.0_dp*aby*cdz*g(83) &
            + 2.0_dp*aby*g(183) &
            + cdz*g(88) &
            + g(188)
         vbuf(101) = aby*abz*cdz*g(81) &
            + aby*abz*g(181) &
            + aby*cdz*g(84) &
            + aby*g(184) &
            + abz*cdz*g(83) &
            ...
            + cdz*g(89) &
            + g(189)
         vbuf(102) = abz*abz*cdz*g(81) &
            + abz*abz*g(181) &
            + 2.0_dp*abz*cdz*g(84) &
            + 2.0_dp*abz*g(184) &
            + cdz*g(90) &
            + g(190)
         vbuf(103) = abx*abx*cdz*g(91) &
            + abx*abx*g(191) &
            + 2.0_dp*abx*cdz*g(92) &
            + 2.0_dp*abx*g(192) &
            + cdz*g(95) &
            + g(195)
         vbuf(104) = abx*aby*cdz*g(91) &
            + abx*aby*g(191) &
            + abx*cdz*g(93) &
            + abx*g(193) &
            + aby*cdz*g(92) &
         ...
         vbuf(105) = abx*abz*cdz*g(91) &
            ...
            + cdz*g(97) &
            + g(197)
         vbuf(106) = aby*aby*cdz*g(91) &
            + aby*aby*g(191) &
            + 2.0_dp*aby*cdz*g(93) &
            + 2.0_dp*aby*g(193) &
            + cdz*g(98) &
            + g(198)
         vbuf(107) = aby*abz*cdz*g(91) &
            + aby*abz*g(191) &
            + aby*cdz*g(94) &
            + aby*g(194) &
            + abz*cdz*g(93) &
