!
! Class (02|20) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0220(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(6), jcd(6), kac(6)
      real(dp) :: kad(1), kbc(36), kbd(6)
      real(dp) :: dab(6), dcd(6), dac(6)
      real(dp) :: dad(1), dbc(36), dbd(6)
      ...
      if (gt > gend) return
         ...
         ! --- HRR ---
         vbuf(1) = abx*abx*g1(41) &
            + 2.0_dp*abx*g1(42) &
            + g1(45)
         vbuf(2) = abx*aby*g1(41) &
            + abx*g1(43) &
            + aby*g1(42) &
            + g1(46)
         vbuf(3) = abx*abz*g1(41) &
            + abx*g1(44) &
            + abz*g1(42) &
            + g1(47)
         vbuf(4) = aby*aby*g1(41) &
            + 2.0_dp*aby*g1(43) &
            + g1(48)
         vbuf(5) = aby*abz*g1(41) &
            + aby*g1(44) &
            + abz*g1(43) &
            + g1(49)
         vbuf(6) = abz*abz*g1(41) &
            + 2.0_dp*abz*g1(44) &
            + g1(50)
         vbuf(7) = abx*abx*g1(51) &
            + 2.0_dp*abx*g1(52) &
            + g1(55)
         vbuf(8) = abx*aby*g1(51) &
            + abx*g1(53) &
            + aby*g1(52) &
            + g1(56)
         vbuf(9) = abx*abz*g1(51) &
            + abx*g1(54) &
            + abz*g1(52) &
            + g1(57)
         vbuf(10) = aby*aby*g1(51) &
            + 2.0_dp*aby*g1(53) &
            + g1(58)
         vbuf(11) = aby*abz*g1(51) &
            + aby*g1(54) &
            + abz*g1(53) &
            + g1(59)
         vbuf(12) = abz*abz*g1(51) &
            + 2.0_dp*abz*g1(54) &
            + g1(60)
         vbuf(13) = abx*abx*g1(61) &
            + 2.0_dp*abx*g1(62) &
            + g1(65)
         vbuf(14) = abx*aby*g1(61) &
            + abx*g1(63) &
            + aby*g1(62) &
            + g1(66)
         vbuf(15) = abx*abz*g1(61) &
            + abx*g1(64) &
            + abz*g1(62) &
            + g1(67)
         vbuf(16) = aby*aby*g1(61) &
            + 2.0_dp*aby*g1(63) &
            + g1(68)
         vbuf(17) = aby*abz*g1(61) &
            + aby*g1(64) &
            + abz*g1(63) &
            + g1(69)
         vbuf(18) = abz*abz*g1(61) &
            + 2.0_dp*abz*g1(64) &
            + g1(70)
         vbuf(19) = abx*abx*g1(71) &
            + 2.0_dp*abx*g1(72) &
            + g1(75)
         vbuf(20) = abx*aby*g1(71) &
            + abx*g1(73) &
            + aby*g1(72) &
            + g1(76)
         vbuf(21) = abx*abz*g1(71) &
            + abx*g1(74) &
            + abz*g1(72) &
            + g1(77)
         vbuf(22) = aby*aby*g1(71) &
            + 2.0_dp*aby*g1(73) &
            + g1(78)
         vbuf(23) = aby*abz*g1(71) &
            + aby*g1(74) &
            + abz*g1(73) &
            + g1(79)
         vbuf(24) = abz*abz*g1(71) &
            + 2.0_dp*abz*g1(74) &
            + g1(80)
         vbuf(25) = abx*abx*g1(81) &
            + 2.0_dp*abx*g1(82) &
            + g1(85)
         vbuf(26) = abx*aby*g1(81) &
            + abx*g1(83) &
            + aby*g1(82) &
            + g1(86)
         vbuf(27) = abx*abz*g1(81) &
            + abx*g1(84) &
            + abz*g1(82) &
            + g1(87)
         vbuf(28) = aby*aby*g1(81) &
            + 2.0_dp*aby*g1(83) &
            + g1(88)
         vbuf(29) = aby*abz*g1(81) &
            + aby*g1(84) &
            + abz*g1(83) &
            + g1(89)
         vbuf(30) = abz*abz*g1(81) &
            + 2.0_dp*abz*g1(84) &
            + g1(90)
         vbuf(31) = abx*abx*g1(91) &
            + 2.0_dp*abx*g1(92) &
            + g1(95)
         vbuf(32) = abx*aby*g1(91) &
            + abx*g1(93) &
            + aby*g1(92) &
            + g1(96)
         vbuf(33) = abx*abz*g1(91) &
            + abx*g1(94) &
            + abz*g1(92) &
            + g1(97)
         vbuf(34) = aby*aby*g1(91) &
            + 2.0_dp*aby*g1(93) &
            + g1(98)
         vbuf(35) = aby*abz*g1(91) &
            + aby*g1(94) &
            + abz*g1(93) &
            + g1(99)
         vbuf(36) = abz*abz*g1(91) &
            + 2.0_dp*abz*g1(94) &
            + g1(100)
   ...
   end subroutine pg0220
#endif
end module trc_pg_k0220
