...
contains
   ...
   pure subroutine pci2112(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*cdx*cdx*g(25) &
            + 2.0_dp*abx*cdx*g(85) &
            + abx*g(205) &
            + cdx*cdx*g(31) &
            + 2.0_dp*cdx*g(91) &
            + g(211)
         vbuf(2) = abx*cdx*cdx*g(26) &
            + 2.0_dp*abx*cdx*g(86) &
            + abx*g(206) &
            + cdx*cdx*g(32) &
            + 2.0_dp*cdx*g(92) &
            + g(212)
         vbuf(3) = abx*cdx*cdx*g(27) &
            + 2.0_dp*abx*cdx*g(87) &
            + abx*g(207) &
            + cdx*cdx*g(33) &
            + 2.0_dp*cdx*g(93) &
            + g(213)
         vbuf(4) = abx*cdx*cdx*g(28) &
            + 2.0_dp*abx*cdx*g(88) &
            + abx*g(208) &
            + cdx*cdx*g(34) &
            + 2.0_dp*cdx*g(94) &
            + g(214)
         vbuf(5) = abx*cdx*cdx*g(29) &
            + 2.0_dp*abx*cdx*g(89) &
            + abx*g(209) &
            + cdx*cdx*g(35) &
            + 2.0_dp*cdx*g(95) &
            + g(215)
         vbuf(6) = abx*cdx*cdx*g(30) &
            + 2.0_dp*abx*cdx*g(90) &
            + abx*g(210) &
            + cdx*cdx*g(36) &
            + 2.0_dp*cdx*g(96) &
            + g(216)
         vbuf(7) = aby*cdx*cdx*g(25) &
            + 2.0_dp*aby*cdx*g(85) &
            + aby*g(205) &
            + cdx*cdx*g(32) &
            + 2.0_dp*cdx*g(92) &
            + g(212)
         vbuf(8) = aby*cdx*cdx*g(26) &
            + 2.0_dp*aby*cdx*g(86) &
            + aby*g(206) &
            + cdx*cdx*g(34) &
            + 2.0_dp*cdx*g(94) &
            + g(214)
         vbuf(9) = aby*cdx*cdx*g(27) &
            + 2.0_dp*aby*cdx*g(87) &
            + aby*g(207) &
            + cdx*cdx*g(35) &
            + 2.0_dp*cdx*g(95) &
            + g(215)
         vbuf(10) = aby*cdx*cdx*g(28) &
            + 2.0_dp*aby*cdx*g(88) &
            + aby*g(208) &
            + cdx*cdx*g(37) &
            + 2.0_dp*cdx*g(97) &
         ...
         vbuf(11) = aby*cdx*cdx*g(29) &
            ...
            + 2.0_dp*cdx*g(98) &
            + g(218)
         vbuf(12) = aby*cdx*cdx*g(30) &
            + 2.0_dp*aby*cdx*g(90) &
            + aby*g(210) &
            + cdx*cdx*g(39) &
            + 2.0_dp*cdx*g(99) &
            + g(219)
         vbuf(13) = abz*cdx*cdx*g(25) &
            + 2.0_dp*abz*cdx*g(85) &
            + abz*g(205) &
            + cdx*cdx*g(33) &
            + 2.0_dp*cdx*g(93) &
            + g(213)
         vbuf(14) = abz*cdx*cdx*g(26) &
            + 2.0_dp*abz*cdx*g(86) &
            + abz*g(206) &
            + cdx*cdx*g(35) &
            + 2.0_dp*cdx*g(95) &
            + g(215)
         vbuf(15) = abz*cdx*cdx*g(27) &
            + 2.0_dp*abz*cdx*g(87) &
            + abz*g(207) &
            + cdx*cdx*g(36) &
            + 2.0_dp*cdx*g(96) &
            + g(216)
         vbuf(16) = abz*cdx*cdx*g(28) &
            + 2.0_dp*abz*cdx*g(88) &
            + abz*g(208) &
            + cdx*cdx*g(38) &
            + 2.0_dp*cdx*g(98) &
            + g(218)
         vbuf(17) = abz*cdx*cdx*g(29) &
            + 2.0_dp*abz*cdx*g(89) &
            + abz*g(209) &
            + cdx*cdx*g(39) &
            + 2.0_dp*cdx*g(99) &
            + g(219)
         vbuf(18) = abz*cdx*cdx*g(30) &
            + 2.0_dp*abz*cdx*g(90) &
            + abz*g(210) &
            + cdx*cdx*g(40) &
            + 2.0_dp*cdx*g(100) &
            + g(220)
         vbuf(19) = abx*cdx*cdx*g(45) &
            + 2.0_dp*abx*cdx*g(105) &
            + abx*g(225) &
            + cdx*cdx*g(51) &
            + 2.0_dp*cdx*g(111) &
            + g(231)
         vbuf(20) = abx*cdx*cdx*g(46) &
            + 2.0_dp*abx*cdx*g(106) &
            + abx*g(226) &
            + cdx*cdx*g(52) &
            + 2.0_dp*cdx*g(112) &
            + g(232)
         vbuf(21) = abx*cdx*cdx*g(47) &
            + 2.0_dp*abx*cdx*g(107) &
            + abx*g(227) &
            + cdx*cdx*g(53) &
            + 2.0_dp*cdx*g(113) &
            + g(233)
         vbuf(22) = abx*cdx*cdx*g(48) &
            + 2.0_dp*abx*cdx*g(108) &
            + abx*g(228) &
            + cdx*cdx*g(54) &
            + 2.0_dp*cdx*g(114) &
            + g(234)
         vbuf(23) = abx*cdx*cdx*g(49) &
            + 2.0_dp*abx*cdx*g(109) &
            + abx*g(229) &
            + cdx*cdx*g(55) &
            + 2.0_dp*cdx*g(115) &
            + g(235)
         vbuf(24) = abx*cdx*cdx*g(50) &
            + 2.0_dp*abx*cdx*g(110) &
            + abx*g(230) &
            + cdx*cdx*g(56) &
            + 2.0_dp*cdx*g(116) &
            + g(236)
         vbuf(25) = aby*cdx*cdx*g(45) &
            + 2.0_dp*aby*cdx*g(105) &
            + aby*g(225) &
            + cdx*cdx*g(52) &
            + 2.0_dp*cdx*g(112) &
            + g(232)
         vbuf(26) = aby*cdx*cdx*g(46) &
            + 2.0_dp*aby*cdx*g(106) &
            + aby*g(226) &
            + cdx*cdx*g(54) &
            + 2.0_dp*cdx*g(114) &
            + g(234)
         vbuf(27) = aby*cdx*cdx*g(47) &
            + 2.0_dp*aby*cdx*g(107) &
            + aby*g(227) &
            + cdx*cdx*g(55) &
            + 2.0_dp*cdx*g(115) &
            + g(235)
         vbuf(28) = aby*cdx*cdx*g(48) &
            + 2.0_dp*aby*cdx*g(108) &
            + aby*g(228) &
            + cdx*cdx*g(57) &
            + 2.0_dp*cdx*g(117) &
            + g(237)
         vbuf(29) = aby*cdx*cdx*g(49) &
            + 2.0_dp*aby*cdx*g(109) &
            + aby*g(229) &
            + cdx*cdx*g(58) &
            + 2.0_dp*cdx*g(118) &
            + g(238)
         vbuf(30) = aby*cdx*cdx*g(50) &
            + 2.0_dp*aby*cdx*g(110) &
            + aby*g(230) &
            + cdx*cdx*g(59) &
            + 2.0_dp*cdx*g(119) &
            + g(239)
         vbuf(31) = abz*cdx*cdx*g(45) &
            + 2.0_dp*abz*cdx*g(105) &
            + abz*g(225) &
            + cdx*cdx*g(53) &
            + 2.0_dp*cdx*g(113) &
            + g(233)
         vbuf(32) = abz*cdx*cdx*g(46) &
            + 2.0_dp*abz*cdx*g(106) &
            + abz*g(226) &
            + cdx*cdx*g(55) &
            + 2.0_dp*cdx*g(115) &
            + g(235)
         vbuf(33) = abz*cdx*cdx*g(47) &
            + 2.0_dp*abz*cdx*g(107) &
            + abz*g(227) &
            + cdx*cdx*g(56) &
            + 2.0_dp*cdx*g(116) &
            + g(236)
         vbuf(34) = abz*cdx*cdx*g(48) &
            + 2.0_dp*abz*cdx*g(108) &
            + abz*g(228) &
            + cdx*cdx*g(58) &
            + 2.0_dp*cdx*g(118) &
            + g(238)
         vbuf(35) = abz*cdx*cdx*g(49) &
            + 2.0_dp*abz*cdx*g(109) &
            + abz*g(229) &
            + cdx*cdx*g(59) &
            + 2.0_dp*cdx*g(119) &
            + g(239)
         vbuf(36) = abz*cdx*cdx*g(50) &
            + 2.0_dp*abz*cdx*g(110) &
            + abz*g(230) &
            + cdx*cdx*g(60) &
            + 2.0_dp*cdx*g(120) &
            + g(240)
         vbuf(37) = abx*cdx*cdx*g(65) &
            + 2.0_dp*abx*cdx*g(125) &
            + abx*g(245) &
            + cdx*cdx*g(71) &
            + 2.0_dp*cdx*g(131) &
            + g(251)
         vbuf(38) = abx*cdx*cdx*g(66) &
            + 2.0_dp*abx*cdx*g(126) &
            + abx*g(246) &
            + cdx*cdx*g(72) &
            + 2.0_dp*cdx*g(132) &
            + g(252)
         vbuf(39) = abx*cdx*cdx*g(67) &
            + 2.0_dp*abx*cdx*g(127) &
            + abx*g(247) &
            + cdx*cdx*g(73) &
            + 2.0_dp*cdx*g(133) &
            + g(253)
         vbuf(40) = abx*cdx*cdx*g(68) &
            + 2.0_dp*abx*cdx*g(128) &
            + abx*g(248) &
            + cdx*cdx*g(74) &
            + 2.0_dp*cdx*g(134) &
            + g(254)
         vbuf(41) = abx*cdx*cdx*g(69) &
            + 2.0_dp*abx*cdx*g(129) &
            + abx*g(249) &
            + cdx*cdx*g(75) &
            + 2.0_dp*cdx*g(135) &
            + g(255)
         vbuf(42) = abx*cdx*cdx*g(70) &
            + 2.0_dp*abx*cdx*g(130) &
            + abx*g(250) &
            + cdx*cdx*g(76) &
            + 2.0_dp*cdx*g(136) &
            + g(256)
         vbuf(43) = aby*cdx*cdx*g(65) &
            + 2.0_dp*aby*cdx*g(125) &
            + aby*g(245) &
            + cdx*cdx*g(72) &
            + 2.0_dp*cdx*g(132) &
            + g(252)
         vbuf(44) = aby*cdx*cdx*g(66) &
            + 2.0_dp*aby*cdx*g(126) &
            + aby*g(246) &
            + cdx*cdx*g(74) &
            + 2.0_dp*cdx*g(134) &
            + g(254)
         vbuf(45) = aby*cdx*cdx*g(67) &
            + 2.0_dp*aby*cdx*g(127) &
            + aby*g(247) &
            + cdx*cdx*g(75) &
            + 2.0_dp*cdx*g(135) &
            + g(255)
         vbuf(46) = aby*cdx*cdx*g(68) &
            + 2.0_dp*aby*cdx*g(128) &
            + aby*g(248) &
            + cdx*cdx*g(77) &
            + 2.0_dp*cdx*g(137) &
            + g(257)
         vbuf(47) = aby*cdx*cdx*g(69) &
            + 2.0_dp*aby*cdx*g(129) &
            + aby*g(249) &
            + cdx*cdx*g(78) &
            + 2.0_dp*cdx*g(138) &
            + g(258)
         vbuf(48) = aby*cdx*cdx*g(70) &
            + 2.0_dp*aby*cdx*g(130) &
            + aby*g(250) &
            + cdx*cdx*g(79) &
            + 2.0_dp*cdx*g(139) &
            + g(259)
         vbuf(49) = abz*cdx*cdx*g(65) &
            + 2.0_dp*abz*cdx*g(125) &
            + abz*g(245) &
            + cdx*cdx*g(73) &
            + 2.0_dp*cdx*g(133) &
            + g(253)
         vbuf(50) = abz*cdx*cdx*g(66) &
            + 2.0_dp*abz*cdx*g(126) &
            + abz*g(246) &
            + cdx*cdx*g(75) &
            + 2.0_dp*cdx*g(135) &
            + g(255)
         vbuf(51) = abz*cdx*cdx*g(67) &
            + 2.0_dp*abz*cdx*g(127) &
            + abz*g(247) &
            + cdx*cdx*g(76) &
            + 2.0_dp*cdx*g(136) &
            + g(256)
         vbuf(52) = abz*cdx*cdx*g(68) &
            + 2.0_dp*abz*cdx*g(128) &
            + abz*g(248) &
            + cdx*cdx*g(78) &
            + 2.0_dp*cdx*g(138) &
            + g(258)
         vbuf(53) = abz*cdx*cdx*g(69) &
            + 2.0_dp*abz*cdx*g(129) &
            + abz*g(249) &
            + cdx*cdx*g(79) &
            + 2.0_dp*cdx*g(139) &
            + g(259)
         vbuf(54) = abz*cdx*cdx*g(70) &
            + 2.0_dp*abz*cdx*g(130) &
            + abz*g(250) &
            + cdx*cdx*g(80) &
            + 2.0_dp*cdx*g(140) &
            + g(260)
         vbuf(55) = abx*cdx*cdy*g(25) &
            + abx*cdx*g(105) &
            + abx*cdy*g(85) &
            + abx*g(225) &
            + cdx*cdy*g(31) &
         ...
         vbuf(162) = abz*cdx*cdz*g(70) &
            ...
            + cdz*g(140) &
            + g(320)
         vbuf(163) = abx*cdy*cdy*g(25) &
            + 2.0_dp*abx*cdy*g(105) &
            + abx*g(265) &
            + cdy*cdy*g(31) &
            + 2.0_dp*cdy*g(111) &
            + g(271)
         vbuf(164) = abx*cdy*cdy*g(26) &
            + 2.0_dp*abx*cdy*g(106) &
            + abx*g(266) &
            + cdy*cdy*g(32) &
            + 2.0_dp*cdy*g(112) &
            + g(272)
         vbuf(165) = abx*cdy*cdy*g(27) &
            + 2.0_dp*abx*cdy*g(107) &
            + abx*g(267) &
            + cdy*cdy*g(33) &
            + 2.0_dp*cdy*g(113) &
            + g(273)
         vbuf(166) = abx*cdy*cdy*g(28) &
            + 2.0_dp*abx*cdy*g(108) &
            + abx*g(268) &
            + cdy*cdy*g(34) &
            + 2.0_dp*cdy*g(114) &
            + g(274)
         vbuf(167) = abx*cdy*cdy*g(29) &
            + 2.0_dp*abx*cdy*g(109) &
            + abx*g(269) &
            + cdy*cdy*g(35) &
            + 2.0_dp*cdy*g(115) &
            + g(275)
         vbuf(168) = abx*cdy*cdy*g(30) &
            + 2.0_dp*abx*cdy*g(110) &
            + abx*g(270) &
            + cdy*cdy*g(36) &
            + 2.0_dp*cdy*g(116) &
            + g(276)
         vbuf(169) = aby*cdy*cdy*g(25) &
            + 2.0_dp*aby*cdy*g(105) &
            + aby*g(265) &
            + cdy*cdy*g(32) &
            + 2.0_dp*cdy*g(112) &
            + g(272)
         vbuf(170) = aby*cdy*cdy*g(26) &
            + 2.0_dp*aby*cdy*g(106) &
            + aby*g(266) &
            + cdy*cdy*g(34) &
            + 2.0_dp*cdy*g(114) &
            + g(274)
         vbuf(171) = aby*cdy*cdy*g(27) &
            + 2.0_dp*aby*cdy*g(107) &
            + aby*g(267) &
            + cdy*cdy*g(35) &
            + 2.0_dp*cdy*g(115) &
            + g(275)
         vbuf(172) = aby*cdy*cdy*g(28) &
            + 2.0_dp*aby*cdy*g(108) &
            + aby*g(268) &
            + cdy*cdy*g(37) &
            + 2.0_dp*cdy*g(117) &
            + g(277)
         vbuf(173) = aby*cdy*cdy*g(29) &
            + 2.0_dp*aby*cdy*g(109) &
            + aby*g(269) &
            + cdy*cdy*g(38) &
            + 2.0_dp*cdy*g(118) &
            + g(278)
         vbuf(174) = aby*cdy*cdy*g(30) &
            + 2.0_dp*aby*cdy*g(110) &
            + aby*g(270) &
            + cdy*cdy*g(39) &
            + 2.0_dp*cdy*g(119) &
            + g(279)
         vbuf(175) = abz*cdy*cdy*g(25) &
            + 2.0_dp*abz*cdy*g(105) &
            + abz*g(265) &
            + cdy*cdy*g(33) &
            + 2.0_dp*cdy*g(113) &
            + g(273)
         vbuf(176) = abz*cdy*cdy*g(26) &
            + 2.0_dp*abz*cdy*g(106) &
            + abz*g(266) &
            + cdy*cdy*g(35) &
            + 2.0_dp*cdy*g(115) &
            + g(275)
         vbuf(177) = abz*cdy*cdy*g(27) &
            + 2.0_dp*abz*cdy*g(107) &
            + abz*g(267) &
            + cdy*cdy*g(36) &
            + 2.0_dp*cdy*g(116) &
            + g(276)
         vbuf(178) = abz*cdy*cdy*g(28) &
            + 2.0_dp*abz*cdy*g(108) &
            + abz*g(268) &
            + cdy*cdy*g(38) &
            + 2.0_dp*cdy*g(118) &
            + g(278)
         vbuf(179) = abz*cdy*cdy*g(29) &
            + 2.0_dp*abz*cdy*g(109) &
            + abz*g(269) &
            + cdy*cdy*g(39) &
            + 2.0_dp*cdy*g(119) &
            + g(279)
         vbuf(180) = abz*cdy*cdy*g(30) &
            + 2.0_dp*abz*cdy*g(110) &
            + abz*g(270) &
            + cdy*cdy*g(40) &
            + 2.0_dp*cdy*g(120) &
            + g(280)
         vbuf(181) = abx*cdy*cdy*g(45) &
            + 2.0_dp*abx*cdy*g(145) &
            + abx*g(325) &
            + cdy*cdy*g(51) &
            + 2.0_dp*cdy*g(151) &
            + g(331)
         vbuf(182) = abx*cdy*cdy*g(46) &
            + 2.0_dp*abx*cdy*g(146) &
            + abx*g(326) &
            + cdy*cdy*g(52) &
            + 2.0_dp*cdy*g(152) &
            + g(332)
         vbuf(183) = abx*cdy*cdy*g(47) &
            + 2.0_dp*abx*cdy*g(147) &
            + abx*g(327) &
            + cdy*cdy*g(53) &
            + 2.0_dp*cdy*g(153) &
            + g(333)
         vbuf(184) = abx*cdy*cdy*g(48) &
            + 2.0_dp*abx*cdy*g(148) &
            + abx*g(328) &
            + cdy*cdy*g(54) &
            + 2.0_dp*cdy*g(154) &
            + g(334)
         vbuf(185) = abx*cdy*cdy*g(49) &
            + 2.0_dp*abx*cdy*g(149) &
            + abx*g(329) &
            + cdy*cdy*g(55) &
            + 2.0_dp*cdy*g(155) &
            + g(335)
         vbuf(186) = abx*cdy*cdy*g(50) &
            + 2.0_dp*abx*cdy*g(150) &
            + abx*g(330) &
            + cdy*cdy*g(56) &
            + 2.0_dp*cdy*g(156) &
            + g(336)
         vbuf(187) = aby*cdy*cdy*g(45) &
            + 2.0_dp*aby*cdy*g(145) &
            + aby*g(325) &
            + cdy*cdy*g(52) &
            + 2.0_dp*cdy*g(152) &
            + g(332)
         vbuf(188) = aby*cdy*cdy*g(46) &
            + 2.0_dp*aby*cdy*g(146) &
            + aby*g(326) &
            + cdy*cdy*g(54) &
            + 2.0_dp*cdy*g(154) &
            + g(334)
         vbuf(189) = aby*cdy*cdy*g(47) &
            + 2.0_dp*aby*cdy*g(147) &
            + aby*g(327) &
            + cdy*cdy*g(55) &
            + 2.0_dp*cdy*g(155) &
            + g(335)
         vbuf(190) = aby*cdy*cdy*g(48) &
            + 2.0_dp*aby*cdy*g(148) &
            + aby*g(328) &
            + cdy*cdy*g(57) &
            + 2.0_dp*cdy*g(157) &
            + g(337)
         vbuf(191) = aby*cdy*cdy*g(49) &
            + 2.0_dp*aby*cdy*g(149) &
            + aby*g(329) &
            + cdy*cdy*g(58) &
            + 2.0_dp*cdy*g(158) &
            + g(338)
         vbuf(192) = aby*cdy*cdy*g(50) &
            + 2.0_dp*aby*cdy*g(150) &
            + aby*g(330) &
            + cdy*cdy*g(59) &
            + 2.0_dp*cdy*g(159) &
            + g(339)
         vbuf(193) = abz*cdy*cdy*g(45) &
            + 2.0_dp*abz*cdy*g(145) &
            + abz*g(325) &
            + cdy*cdy*g(53) &
            + 2.0_dp*cdy*g(153) &
            + g(333)
         vbuf(194) = abz*cdy*cdy*g(46) &
            + 2.0_dp*abz*cdy*g(146) &
            + abz*g(326) &
            + cdy*cdy*g(55) &
            + 2.0_dp*cdy*g(155) &
            + g(335)
         vbuf(195) = abz*cdy*cdy*g(47) &
            + 2.0_dp*abz*cdy*g(147) &
            + abz*g(327) &
            + cdy*cdy*g(56) &
            + 2.0_dp*cdy*g(156) &
            + g(336)
         vbuf(196) = abz*cdy*cdy*g(48) &
            + 2.0_dp*abz*cdy*g(148) &
            + abz*g(328) &
            + cdy*cdy*g(58) &
            + 2.0_dp*cdy*g(158) &
            + g(338)
         vbuf(197) = abz*cdy*cdy*g(49) &
            + 2.0_dp*abz*cdy*g(149) &
            + abz*g(329) &
            + cdy*cdy*g(59) &
            + 2.0_dp*cdy*g(159) &
            + g(339)
         vbuf(198) = abz*cdy*cdy*g(50) &
            + 2.0_dp*abz*cdy*g(150) &
            + abz*g(330) &
            + cdy*cdy*g(60) &
            + 2.0_dp*cdy*g(160) &
            + g(340)
         vbuf(199) = abx*cdy*cdy*g(65) &
            + 2.0_dp*abx*cdy*g(165) &
            + abx*g(345) &
            + cdy*cdy*g(71) &
            + 2.0_dp*cdy*g(171) &
            + g(351)
         vbuf(200) = abx*cdy*cdy*g(66) &
            + 2.0_dp*abx*cdy*g(166) &
            + abx*g(346) &
            + cdy*cdy*g(72) &
            + 2.0_dp*cdy*g(172) &
            + g(352)
         vbuf(201) = abx*cdy*cdy*g(67) &
            + 2.0_dp*abx*cdy*g(167) &
            + abx*g(347) &
            + cdy*cdy*g(73) &
            + 2.0_dp*cdy*g(173) &
            + g(353)
         vbuf(202) = abx*cdy*cdy*g(68) &
            + 2.0_dp*abx*cdy*g(168) &
            + abx*g(348) &
            + cdy*cdy*g(74) &
            + 2.0_dp*cdy*g(174) &
            + g(354)
         vbuf(203) = abx*cdy*cdy*g(69) &
            + 2.0_dp*abx*cdy*g(169) &
            + abx*g(349) &
            + cdy*cdy*g(75) &
            + 2.0_dp*cdy*g(175) &
            + g(355)
         vbuf(204) = abx*cdy*cdy*g(70) &
            + 2.0_dp*abx*cdy*g(170) &
            + abx*g(350) &
            + cdy*cdy*g(76) &
            + 2.0_dp*cdy*g(176) &
            + g(356)
         vbuf(205) = aby*cdy*cdy*g(65) &
            + 2.0_dp*aby*cdy*g(165) &
            + aby*g(345) &
            + cdy*cdy*g(72) &
            + 2.0_dp*cdy*g(172) &
            + g(352)
         vbuf(206) = aby*cdy*cdy*g(66) &
            + 2.0_dp*aby*cdy*g(166) &
            + aby*g(346) &
            + cdy*cdy*g(74) &
            + 2.0_dp*cdy*g(174) &
            + g(354)
         vbuf(207) = aby*cdy*cdy*g(67) &
            + 2.0_dp*aby*cdy*g(167) &
            + aby*g(347) &
            + cdy*cdy*g(75) &
            + 2.0_dp*cdy*g(175) &
            + g(355)
         vbuf(208) = aby*cdy*cdy*g(68) &
            + 2.0_dp*aby*cdy*g(168) &
            + aby*g(348) &
            + cdy*cdy*g(77) &
            + 2.0_dp*cdy*g(177) &
            + g(357)
         vbuf(209) = aby*cdy*cdy*g(69) &
            + 2.0_dp*aby*cdy*g(169) &
            + aby*g(349) &
            + cdy*cdy*g(78) &
            + 2.0_dp*cdy*g(178) &
            + g(358)
         vbuf(210) = aby*cdy*cdy*g(70) &
            + 2.0_dp*aby*cdy*g(170) &
            + aby*g(350) &
            + cdy*cdy*g(79) &
            + 2.0_dp*cdy*g(179) &
            + g(359)
         vbuf(211) = abz*cdy*cdy*g(65) &
            + 2.0_dp*abz*cdy*g(165) &
            + abz*g(345) &
            + cdy*cdy*g(73) &
            + 2.0_dp*cdy*g(173) &
            + g(353)
         vbuf(212) = abz*cdy*cdy*g(66) &
            + 2.0_dp*abz*cdy*g(166) &
            + abz*g(346) &
            + cdy*cdy*g(75) &
            + 2.0_dp*cdy*g(175) &
            + g(355)
         vbuf(213) = abz*cdy*cdy*g(67) &
            + 2.0_dp*abz*cdy*g(167) &
            + abz*g(347) &
            + cdy*cdy*g(76) &
            + 2.0_dp*cdy*g(176) &
            + g(356)
         vbuf(214) = abz*cdy*cdy*g(68) &
            + 2.0_dp*abz*cdy*g(168) &
            + abz*g(348) &
            + cdy*cdy*g(78) &
            + 2.0_dp*cdy*g(178) &
            + g(358)
         vbuf(215) = abz*cdy*cdy*g(69) &
            + 2.0_dp*abz*cdy*g(169) &
            + abz*g(349) &
            + cdy*cdy*g(79) &
            + 2.0_dp*cdy*g(179) &
            + g(359)
         vbuf(216) = abz*cdy*cdy*g(70) &
            + 2.0_dp*abz*cdy*g(170) &
            + abz*g(350) &
            + cdy*cdy*g(80) &
            + 2.0_dp*cdy*g(180) &
            + g(360)
         vbuf(217) = abx*cdy*cdz*g(25) &
            + abx*cdy*g(125) &
            + abx*cdz*g(105) &
            + abx*g(285) &
            + cdy*cdz*g(31) &
         ...
         vbuf(270) = abz*cdy*cdz*g(70) &
            ...
            + cdz*g(180) &
            + g(380)
         vbuf(271) = abx*cdz*cdz*g(25) &
            + 2.0_dp*abx*cdz*g(125) &
            + abx*g(305) &
            + cdz*cdz*g(31) &
            + 2.0_dp*cdz*g(131) &
            + g(311)
         vbuf(272) = abx*cdz*cdz*g(26) &
            + 2.0_dp*abx*cdz*g(126) &
            + abx*g(306) &
            + cdz*cdz*g(32) &
            + 2.0_dp*cdz*g(132) &
            + g(312)
         vbuf(273) = abx*cdz*cdz*g(27) &
            + 2.0_dp*abx*cdz*g(127) &
            + abx*g(307) &
            + cdz*cdz*g(33) &
            + 2.0_dp*cdz*g(133) &
            + g(313)
         vbuf(274) = abx*cdz*cdz*g(28) &
            + 2.0_dp*abx*cdz*g(128) &
            + abx*g(308) &
            + cdz*cdz*g(34) &
            + 2.0_dp*cdz*g(134) &
            + g(314)
         vbuf(275) = abx*cdz*cdz*g(29) &
            + 2.0_dp*abx*cdz*g(129) &
            + abx*g(309) &
            + cdz*cdz*g(35) &
            + 2.0_dp*cdz*g(135) &
            + g(315)
         vbuf(276) = abx*cdz*cdz*g(30) &
            + 2.0_dp*abx*cdz*g(130) &
            + abx*g(310) &
            + cdz*cdz*g(36) &
            + 2.0_dp*cdz*g(136) &
            + g(316)
         vbuf(277) = aby*cdz*cdz*g(25) &
            + 2.0_dp*aby*cdz*g(125) &
            + aby*g(305) &
            + cdz*cdz*g(32) &
            + 2.0_dp*cdz*g(132) &
            + g(312)
         vbuf(278) = aby*cdz*cdz*g(26) &
            + 2.0_dp*aby*cdz*g(126) &
            + aby*g(306) &
            + cdz*cdz*g(34) &
            + 2.0_dp*cdz*g(134) &
            + g(314)
         vbuf(279) = aby*cdz*cdz*g(27) &
            + 2.0_dp*aby*cdz*g(127) &
            + aby*g(307) &
            + cdz*cdz*g(35) &
            + 2.0_dp*cdz*g(135) &
            + g(315)
         vbuf(280) = aby*cdz*cdz*g(28) &
            + 2.0_dp*aby*cdz*g(128) &
            + aby*g(308) &
            + cdz*cdz*g(37) &
            + 2.0_dp*cdz*g(137) &
            + g(317)
         vbuf(281) = aby*cdz*cdz*g(29) &
            + 2.0_dp*aby*cdz*g(129) &
            + aby*g(309) &
            + cdz*cdz*g(38) &
            + 2.0_dp*cdz*g(138) &
            + g(318)
         vbuf(282) = aby*cdz*cdz*g(30) &
            + 2.0_dp*aby*cdz*g(130) &
            + aby*g(310) &
            + cdz*cdz*g(39) &
            + 2.0_dp*cdz*g(139) &
            + g(319)
         vbuf(283) = abz*cdz*cdz*g(25) &
            + 2.0_dp*abz*cdz*g(125) &
            + abz*g(305) &
            + cdz*cdz*g(33) &
            + 2.0_dp*cdz*g(133) &
            + g(313)
         vbuf(284) = abz*cdz*cdz*g(26) &
            + 2.0_dp*abz*cdz*g(126) &
            + abz*g(306) &
            + cdz*cdz*g(35) &
            + 2.0_dp*cdz*g(135) &
            + g(315)
         vbuf(285) = abz*cdz*cdz*g(27) &
            + 2.0_dp*abz*cdz*g(127) &
            + abz*g(307) &
            + cdz*cdz*g(36) &
            + 2.0_dp*cdz*g(136) &
            + g(316)
         vbuf(286) = abz*cdz*cdz*g(28) &
            + 2.0_dp*abz*cdz*g(128) &
            + abz*g(308) &
            + cdz*cdz*g(38) &
            + 2.0_dp*cdz*g(138) &
            + g(318)
         vbuf(287) = abz*cdz*cdz*g(29) &
            + 2.0_dp*abz*cdz*g(129) &
            + abz*g(309) &
            + cdz*cdz*g(39) &
            + 2.0_dp*cdz*g(139) &
            + g(319)
         vbuf(288) = abz*cdz*cdz*g(30) &
            + 2.0_dp*abz*cdz*g(130) &
            + abz*g(310) &
            + cdz*cdz*g(40) &
            + 2.0_dp*cdz*g(140) &
            + g(320)
         vbuf(289) = abx*cdz*cdz*g(45) &
            + 2.0_dp*abx*cdz*g(165) &
            + abx*g(365) &
            + cdz*cdz*g(51) &
            + 2.0_dp*cdz*g(171) &
            + g(371)
         vbuf(290) = abx*cdz*cdz*g(46) &
            + 2.0_dp*abx*cdz*g(166) &
            + abx*g(366) &
            + cdz*cdz*g(52) &
            + 2.0_dp*cdz*g(172) &
            + g(372)
         vbuf(291) = abx*cdz*cdz*g(47) &
            + 2.0_dp*abx*cdz*g(167) &
            + abx*g(367) &
            + cdz*cdz*g(53) &
            + 2.0_dp*cdz*g(173) &
            + g(373)
         vbuf(292) = abx*cdz*cdz*g(48) &
            + 2.0_dp*abx*cdz*g(168) &
            + abx*g(368) &
            + cdz*cdz*g(54) &
            + 2.0_dp*cdz*g(174) &
            + g(374)
         vbuf(293) = abx*cdz*cdz*g(49) &
            + 2.0_dp*abx*cdz*g(169) &
            + abx*g(369) &
            + cdz*cdz*g(55) &
            + 2.0_dp*cdz*g(175) &
            + g(375)
         vbuf(294) = abx*cdz*cdz*g(50) &
            + 2.0_dp*abx*cdz*g(170) &
            + abx*g(370) &
            + cdz*cdz*g(56) &
            + 2.0_dp*cdz*g(176) &
            + g(376)
         vbuf(295) = aby*cdz*cdz*g(45) &
            + 2.0_dp*aby*cdz*g(165) &
            + aby*g(365) &
            + cdz*cdz*g(52) &
            + 2.0_dp*cdz*g(172) &
            + g(372)
         vbuf(296) = aby*cdz*cdz*g(46) &
            + 2.0_dp*aby*cdz*g(166) &
            + aby*g(366) &
            + cdz*cdz*g(54) &
            + 2.0_dp*cdz*g(174) &
            + g(374)
         vbuf(297) = aby*cdz*cdz*g(47) &
            + 2.0_dp*aby*cdz*g(167) &
            + aby*g(367) &
            + cdz*cdz*g(55) &
            + 2.0_dp*cdz*g(175) &
            + g(375)
         vbuf(298) = aby*cdz*cdz*g(48) &
            + 2.0_dp*aby*cdz*g(168) &
            + aby*g(368) &
            + cdz*cdz*g(57) &
            + 2.0_dp*cdz*g(177) &
            + g(377)
         vbuf(299) = aby*cdz*cdz*g(49) &
            + 2.0_dp*aby*cdz*g(169) &
            + aby*g(369) &
            + cdz*cdz*g(58) &
            + 2.0_dp*cdz*g(178) &
            + g(378)
         vbuf(300) = aby*cdz*cdz*g(50) &
            + 2.0_dp*aby*cdz*g(170) &
            + aby*g(370) &
            + cdz*cdz*g(59) &
            + 2.0_dp*cdz*g(179) &
            + g(379)
         vbuf(301) = abz*cdz*cdz*g(45) &
            + 2.0_dp*abz*cdz*g(165) &
            + abz*g(365) &
            + cdz*cdz*g(53) &
            + 2.0_dp*cdz*g(173) &
            + g(373)
         vbuf(302) = abz*cdz*cdz*g(46) &
            + 2.0_dp*abz*cdz*g(166) &
            + abz*g(366) &
            + cdz*cdz*g(55) &
            + 2.0_dp*cdz*g(175) &
            + g(375)
         vbuf(303) = abz*cdz*cdz*g(47) &
            + 2.0_dp*abz*cdz*g(167) &
            + abz*g(367) &
            + cdz*cdz*g(56) &
            + 2.0_dp*cdz*g(176) &
            + g(376)
         vbuf(304) = abz*cdz*cdz*g(48) &
            + 2.0_dp*abz*cdz*g(168) &
            + abz*g(368) &
            + cdz*cdz*g(58) &
            + 2.0_dp*cdz*g(178) &
            + g(378)
         vbuf(305) = abz*cdz*cdz*g(49) &
            + 2.0_dp*abz*cdz*g(169) &
            + abz*g(369) &
            + cdz*cdz*g(59) &
            + 2.0_dp*cdz*g(179) &
            + g(379)
         vbuf(306) = abz*cdz*cdz*g(50) &
            + 2.0_dp*abz*cdz*g(170) &
            + abz*g(370) &
            + cdz*cdz*g(60) &
            + 2.0_dp*cdz*g(180) &
            + g(380)
         vbuf(307) = abx*cdz*cdz*g(65) &
            + 2.0_dp*abx*cdz*g(185) &
            + abx*g(385) &
            + cdz*cdz*g(71) &
            + 2.0_dp*cdz*g(191) &
            + g(391)
         vbuf(308) = abx*cdz*cdz*g(66) &
            + 2.0_dp*abx*cdz*g(186) &
            + abx*g(386) &
            + cdz*cdz*g(72) &
            + 2.0_dp*cdz*g(192) &
            + g(392)
         vbuf(309) = abx*cdz*cdz*g(67) &
            + 2.0_dp*abx*cdz*g(187) &
            + abx*g(387) &
            + cdz*cdz*g(73) &
            + 2.0_dp*cdz*g(193) &
            + g(393)
         vbuf(310) = abx*cdz*cdz*g(68) &
            + 2.0_dp*abx*cdz*g(188) &
            + abx*g(388) &
            + cdz*cdz*g(74) &
            + 2.0_dp*cdz*g(194) &
            + g(394)
         vbuf(311) = abx*cdz*cdz*g(69) &
            + 2.0_dp*abx*cdz*g(189) &
            + abx*g(389) &
            + cdz*cdz*g(75) &
            + 2.0_dp*cdz*g(195) &
            + g(395)
         vbuf(312) = abx*cdz*cdz*g(70) &
            + 2.0_dp*abx*cdz*g(190) &
            + abx*g(390) &
            + cdz*cdz*g(76) &
            + 2.0_dp*cdz*g(196) &
            + g(396)
         vbuf(313) = aby*cdz*cdz*g(65) &
            + 2.0_dp*aby*cdz*g(185) &
            + aby*g(385) &
            + cdz*cdz*g(72) &
            + 2.0_dp*cdz*g(192) &
            + g(392)
         vbuf(314) = aby*cdz*cdz*g(66) &
            + 2.0_dp*aby*cdz*g(186) &
            + aby*g(386) &
            + cdz*cdz*g(74) &
            + 2.0_dp*cdz*g(194) &
            + g(394)
         vbuf(315) = aby*cdz*cdz*g(67) &
            + 2.0_dp*aby*cdz*g(187) &
            + aby*g(387) &
            + cdz*cdz*g(75) &
            + 2.0_dp*cdz*g(195) &
            + g(395)
         vbuf(316) = aby*cdz*cdz*g(68) &
            + 2.0_dp*aby*cdz*g(188) &
            + aby*g(388) &
            + cdz*cdz*g(77) &
            + 2.0_dp*cdz*g(197) &
            + g(397)
         vbuf(317) = aby*cdz*cdz*g(69) &
            + 2.0_dp*aby*cdz*g(189) &
            + aby*g(389) &
            + cdz*cdz*g(78) &
            + 2.0_dp*cdz*g(198) &
            + g(398)
         vbuf(318) = aby*cdz*cdz*g(70) &
            + 2.0_dp*aby*cdz*g(190) &
            + aby*g(390) &
            + cdz*cdz*g(79) &
            + 2.0_dp*cdz*g(199) &
            + g(399)
         vbuf(319) = abz*cdz*cdz*g(65) &
            + 2.0_dp*abz*cdz*g(185) &
            + abz*g(385) &
            + cdz*cdz*g(73) &
            + 2.0_dp*cdz*g(193) &
            + g(393)
         vbuf(320) = abz*cdz*cdz*g(66) &
            + 2.0_dp*abz*cdz*g(186) &
            + abz*g(386) &
            + cdz*cdz*g(75) &
            + 2.0_dp*cdz*g(195) &
            + g(395)
         vbuf(321) = abz*cdz*cdz*g(67) &
            + 2.0_dp*abz*cdz*g(187) &
            + abz*g(387) &
            + cdz*cdz*g(76) &
            + 2.0_dp*cdz*g(196) &
            + g(396)
         vbuf(322) = abz*cdz*cdz*g(68) &
            + 2.0_dp*abz*cdz*g(188) &
            + abz*g(388) &
            + cdz*cdz*g(78) &
            + 2.0_dp*cdz*g(198) &
            + g(398)
         vbuf(323) = abz*cdz*cdz*g(69) &
            + 2.0_dp*abz*cdz*g(189) &
            + abz*g(389) &
            + cdz*cdz*g(79) &
            + 2.0_dp*cdz*g(199) &
            + g(399)
         vbuf(324) = abz*cdz*cdz*g(70) &
