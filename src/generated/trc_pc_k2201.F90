...
contains
   ...
   pure subroutine pci2201(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*g(5) &
            + abx*abx*g(40) &
            + 2.0_dp*abx*cdx*g(11) &
            + 2.0_dp*abx*g(46) &
            + cdx*g(21) &
            + g(56)
         vbuf(2) = abx*abx*cdx*g(6) &
            + abx*abx*g(41) &
            + 2.0_dp*abx*cdx*g(12) &
            + 2.0_dp*abx*g(47) &
            + cdx*g(22) &
            + g(57)
         vbuf(3) = abx*abx*cdx*g(7) &
            + abx*abx*g(42) &
            + 2.0_dp*abx*cdx*g(13) &
            + 2.0_dp*abx*g(48) &
            + cdx*g(23) &
            + g(58)
         vbuf(4) = abx*abx*cdx*g(8) &
            + abx*abx*g(43) &
            + 2.0_dp*abx*cdx*g(14) &
            + 2.0_dp*abx*g(49) &
            + cdx*g(24) &
            + g(59)
         vbuf(5) = abx*abx*cdx*g(9) &
            + abx*abx*g(44) &
            + 2.0_dp*abx*cdx*g(15) &
            + 2.0_dp*abx*g(50) &
            + cdx*g(25) &
            + g(60)
         vbuf(6) = abx*abx*cdx*g(10) &
            + abx*abx*g(45) &
            + 2.0_dp*abx*cdx*g(16) &
            + 2.0_dp*abx*g(51) &
            + cdx*g(26) &
            + g(61)
         vbuf(7) = abx*aby*cdx*g(5) &
            + abx*aby*g(40) &
            + abx*cdx*g(12) &
            + abx*g(47) &
            + aby*cdx*g(11) &
         ...
         vbuf(18) = abx*abz*cdx*g(10) &
            ...
            + cdx*g(30) &
            + g(65)
         vbuf(19) = aby*aby*cdx*g(5) &
            + aby*aby*g(40) &
            + 2.0_dp*aby*cdx*g(12) &
            + 2.0_dp*aby*g(47) &
            + cdx*g(24) &
            + g(59)
         vbuf(20) = aby*aby*cdx*g(6) &
            + aby*aby*g(41) &
            + 2.0_dp*aby*cdx*g(14) &
            + 2.0_dp*aby*g(49) &
            + cdx*g(27) &
            + g(62)
         vbuf(21) = aby*aby*cdx*g(7) &
            + aby*aby*g(42) &
            + 2.0_dp*aby*cdx*g(15) &
            + 2.0_dp*aby*g(50) &
            + cdx*g(28) &
            + g(63)
         vbuf(22) = aby*aby*cdx*g(8) &
            + aby*aby*g(43) &
            + 2.0_dp*aby*cdx*g(17) &
            + 2.0_dp*aby*g(52) &
            + cdx*g(31) &
            + g(66)
         vbuf(23) = aby*aby*cdx*g(9) &
            + aby*aby*g(44) &
            + 2.0_dp*aby*cdx*g(18) &
            + 2.0_dp*aby*g(53) &
            + cdx*g(32) &
            + g(67)
         vbuf(24) = aby*aby*cdx*g(10) &
            + aby*aby*g(45) &
            + 2.0_dp*aby*cdx*g(19) &
            + 2.0_dp*aby*g(54) &
            + cdx*g(33) &
            + g(68)
         vbuf(25) = aby*abz*cdx*g(5) &
            + aby*abz*g(40) &
            + aby*cdx*g(13) &
            + aby*g(48) &
            + abz*cdx*g(12) &
         ...
         vbuf(30) = aby*abz*cdx*g(10) &
            ...
            + cdx*g(34) &
            + g(69)
         vbuf(31) = abz*abz*cdx*g(5) &
            + abz*abz*g(40) &
            + 2.0_dp*abz*cdx*g(13) &
            + 2.0_dp*abz*g(48) &
            + cdx*g(26) &
            + g(61)
         vbuf(32) = abz*abz*cdx*g(6) &
            + abz*abz*g(41) &
            + 2.0_dp*abz*cdx*g(15) &
            + 2.0_dp*abz*g(50) &
            + cdx*g(29) &
            + g(64)
         vbuf(33) = abz*abz*cdx*g(7) &
            + abz*abz*g(42) &
            + 2.0_dp*abz*cdx*g(16) &
            + 2.0_dp*abz*g(51) &
            + cdx*g(30) &
            + g(65)
         vbuf(34) = abz*abz*cdx*g(8) &
            + abz*abz*g(43) &
            + 2.0_dp*abz*cdx*g(18) &
            + 2.0_dp*abz*g(53) &
            + cdx*g(33) &
            + g(68)
         vbuf(35) = abz*abz*cdx*g(9) &
            + abz*abz*g(44) &
            + 2.0_dp*abz*cdx*g(19) &
            + 2.0_dp*abz*g(54) &
            + cdx*g(34) &
            + g(69)
         vbuf(36) = abz*abz*cdx*g(10) &
            + abz*abz*g(45) &
            + 2.0_dp*abz*cdx*g(20) &
            + 2.0_dp*abz*g(55) &
            + cdx*g(35) &
            + g(70)
         vbuf(37) = abx*abx*cdy*g(5) &
            + abx*abx*g(75) &
            + 2.0_dp*abx*cdy*g(11) &
            + 2.0_dp*abx*g(81) &
            + cdy*g(21) &
            + g(91)
         vbuf(38) = abx*abx*cdy*g(6) &
            + abx*abx*g(76) &
            + 2.0_dp*abx*cdy*g(12) &
            + 2.0_dp*abx*g(82) &
            + cdy*g(22) &
            + g(92)
         vbuf(39) = abx*abx*cdy*g(7) &
            + abx*abx*g(77) &
            + 2.0_dp*abx*cdy*g(13) &
            + 2.0_dp*abx*g(83) &
            + cdy*g(23) &
            + g(93)
         vbuf(40) = abx*abx*cdy*g(8) &
            + abx*abx*g(78) &
            + 2.0_dp*abx*cdy*g(14) &
            + 2.0_dp*abx*g(84) &
            + cdy*g(24) &
            + g(94)
         vbuf(41) = abx*abx*cdy*g(9) &
            + abx*abx*g(79) &
            + 2.0_dp*abx*cdy*g(15) &
            + 2.0_dp*abx*g(85) &
            + cdy*g(25) &
            + g(95)
         vbuf(42) = abx*abx*cdy*g(10) &
            + abx*abx*g(80) &
            + 2.0_dp*abx*cdy*g(16) &
            + 2.0_dp*abx*g(86) &
            + cdy*g(26) &
            + g(96)
         vbuf(43) = abx*aby*cdy*g(5) &
            + abx*aby*g(75) &
            + abx*cdy*g(12) &
            + abx*g(82) &
            + aby*cdy*g(11) &
         ...
         vbuf(54) = abx*abz*cdy*g(10) &
            ...
            + cdy*g(30) &
            + g(100)
         vbuf(55) = aby*aby*cdy*g(5) &
            + aby*aby*g(75) &
            + 2.0_dp*aby*cdy*g(12) &
            + 2.0_dp*aby*g(82) &
            + cdy*g(24) &
            + g(94)
         vbuf(56) = aby*aby*cdy*g(6) &
            + aby*aby*g(76) &
            + 2.0_dp*aby*cdy*g(14) &
            + 2.0_dp*aby*g(84) &
            + cdy*g(27) &
            + g(97)
         vbuf(57) = aby*aby*cdy*g(7) &
            + aby*aby*g(77) &
            + 2.0_dp*aby*cdy*g(15) &
            + 2.0_dp*aby*g(85) &
            + cdy*g(28) &
            + g(98)
         vbuf(58) = aby*aby*cdy*g(8) &
            + aby*aby*g(78) &
            + 2.0_dp*aby*cdy*g(17) &
            + 2.0_dp*aby*g(87) &
            + cdy*g(31) &
            + g(101)
         vbuf(59) = aby*aby*cdy*g(9) &
            + aby*aby*g(79) &
            + 2.0_dp*aby*cdy*g(18) &
            + 2.0_dp*aby*g(88) &
            + cdy*g(32) &
            + g(102)
         vbuf(60) = aby*aby*cdy*g(10) &
            + aby*aby*g(80) &
            + 2.0_dp*aby*cdy*g(19) &
            + 2.0_dp*aby*g(89) &
            + cdy*g(33) &
            + g(103)
         vbuf(61) = aby*abz*cdy*g(5) &
            + aby*abz*g(75) &
            + aby*cdy*g(13) &
            + aby*g(83) &
            + abz*cdy*g(12) &
         ...
         vbuf(66) = aby*abz*cdy*g(10) &
            ...
            + cdy*g(34) &
            + g(104)
         vbuf(67) = abz*abz*cdy*g(5) &
            + abz*abz*g(75) &
            + 2.0_dp*abz*cdy*g(13) &
            + 2.0_dp*abz*g(83) &
            + cdy*g(26) &
            + g(96)
         vbuf(68) = abz*abz*cdy*g(6) &
            + abz*abz*g(76) &
            + 2.0_dp*abz*cdy*g(15) &
            + 2.0_dp*abz*g(85) &
            + cdy*g(29) &
            + g(99)
         vbuf(69) = abz*abz*cdy*g(7) &
            + abz*abz*g(77) &
            + 2.0_dp*abz*cdy*g(16) &
            + 2.0_dp*abz*g(86) &
            + cdy*g(30) &
            + g(100)
         vbuf(70) = abz*abz*cdy*g(8) &
            + abz*abz*g(78) &
            + 2.0_dp*abz*cdy*g(18) &
            + 2.0_dp*abz*g(88) &
            + cdy*g(33) &
            + g(103)
         vbuf(71) = abz*abz*cdy*g(9) &
            + abz*abz*g(79) &
            + 2.0_dp*abz*cdy*g(19) &
            + 2.0_dp*abz*g(89) &
            + cdy*g(34) &
            + g(104)
         vbuf(72) = abz*abz*cdy*g(10) &
            + abz*abz*g(80) &
            + 2.0_dp*abz*cdy*g(20) &
            + 2.0_dp*abz*g(90) &
            + cdy*g(35) &
            + g(105)
         vbuf(73) = abx*abx*cdz*g(5) &
            + abx*abx*g(110) &
            + 2.0_dp*abx*cdz*g(11) &
            + 2.0_dp*abx*g(116) &
            + cdz*g(21) &
            + g(126)
         vbuf(74) = abx*abx*cdz*g(6) &
            + abx*abx*g(111) &
            + 2.0_dp*abx*cdz*g(12) &
            + 2.0_dp*abx*g(117) &
            + cdz*g(22) &
            + g(127)
         vbuf(75) = abx*abx*cdz*g(7) &
            + abx*abx*g(112) &
            + 2.0_dp*abx*cdz*g(13) &
            + 2.0_dp*abx*g(118) &
            + cdz*g(23) &
            + g(128)
         vbuf(76) = abx*abx*cdz*g(8) &
            + abx*abx*g(113) &
            + 2.0_dp*abx*cdz*g(14) &
            + 2.0_dp*abx*g(119) &
            + cdz*g(24) &
            + g(129)
         vbuf(77) = abx*abx*cdz*g(9) &
            + abx*abx*g(114) &
            + 2.0_dp*abx*cdz*g(15) &
            + 2.0_dp*abx*g(120) &
            + cdz*g(25) &
            + g(130)
         vbuf(78) = abx*abx*cdz*g(10) &
            + abx*abx*g(115) &
            + 2.0_dp*abx*cdz*g(16) &
            + 2.0_dp*abx*g(121) &
            + cdz*g(26) &
            + g(131)
         vbuf(79) = abx*aby*cdz*g(5) &
            + abx*aby*g(110) &
            + abx*cdz*g(12) &
            + abx*g(117) &
            + aby*cdz*g(11) &
         ...
         vbuf(90) = abx*abz*cdz*g(10) &
            ...
            + cdz*g(30) &
            + g(135)
         vbuf(91) = aby*aby*cdz*g(5) &
            + aby*aby*g(110) &
            + 2.0_dp*aby*cdz*g(12) &
            + 2.0_dp*aby*g(117) &
            + cdz*g(24) &
            + g(129)
         vbuf(92) = aby*aby*cdz*g(6) &
            + aby*aby*g(111) &
            + 2.0_dp*aby*cdz*g(14) &
            + 2.0_dp*aby*g(119) &
            + cdz*g(27) &
            + g(132)
         vbuf(93) = aby*aby*cdz*g(7) &
            + aby*aby*g(112) &
            + 2.0_dp*aby*cdz*g(15) &
            + 2.0_dp*aby*g(120) &
            + cdz*g(28) &
            + g(133)
         vbuf(94) = aby*aby*cdz*g(8) &
            + aby*aby*g(113) &
            + 2.0_dp*aby*cdz*g(17) &
            + 2.0_dp*aby*g(122) &
            + cdz*g(31) &
            + g(136)
         vbuf(95) = aby*aby*cdz*g(9) &
            + aby*aby*g(114) &
            + 2.0_dp*aby*cdz*g(18) &
            + 2.0_dp*aby*g(123) &
            + cdz*g(32) &
            + g(137)
         vbuf(96) = aby*aby*cdz*g(10) &
            + aby*aby*g(115) &
            + 2.0_dp*aby*cdz*g(19) &
            + 2.0_dp*aby*g(124) &
            + cdz*g(33) &
            + g(138)
         vbuf(97) = aby*abz*cdz*g(5) &
            + aby*abz*g(110) &
            + aby*cdz*g(13) &
            + aby*g(118) &
            + abz*cdz*g(12) &
         ...
         vbuf(102) = aby*abz*cdz*g(10) &
            ...
            + cdz*g(34) &
            + g(139)
         vbuf(103) = abz*abz*cdz*g(5) &
            + abz*abz*g(110) &
            + 2.0_dp*abz*cdz*g(13) &
            + 2.0_dp*abz*g(118) &
            + cdz*g(26) &
            + g(131)
         vbuf(104) = abz*abz*cdz*g(6) &
            + abz*abz*g(111) &
            + 2.0_dp*abz*cdz*g(15) &
            + 2.0_dp*abz*g(120) &
            + cdz*g(29) &
            + g(134)
         vbuf(105) = abz*abz*cdz*g(7) &
            + abz*abz*g(112) &
            + 2.0_dp*abz*cdz*g(16) &
            + 2.0_dp*abz*g(121) &
            + cdz*g(30) &
            + g(135)
         vbuf(106) = abz*abz*cdz*g(8) &
            + abz*abz*g(113) &
            + 2.0_dp*abz*cdz*g(18) &
            + 2.0_dp*abz*g(123) &
            + cdz*g(33) &
            + g(138)
         vbuf(107) = abz*abz*cdz*g(9) &
            + abz*abz*g(114) &
            + 2.0_dp*abz*cdz*g(19) &
            + 2.0_dp*abz*g(124) &
            + cdz*g(34) &
            + g(139)
         vbuf(108) = abz*abz*cdz*g(10) &
            + abz*abz*g(115) &
            + 2.0_dp*abz*cdz*g(20) &
            + 2.0_dp*abz*g(125) &
            + cdz*g(35) &
