!
! Class (01|01) cooperative kernel, CUDA Fortran.
!
...
module trc_pg_k0101
   ...
   integer, parameter :: CDC = 4, ABC = 16, NTC = 64

contains

   attributes(global) subroutine pg0101(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(3), jcd(3), kac(1)
      real(dp) :: kad(3), kbc(3), kbd(9)
      real(dp) :: dab(3), dcd(3), dac(1)
      real(dp) :: dad(3), dbc(3), dbd(9)
         ...
         do cd0 = 1, nccd, CDC
            ...
            v(16,0) = qcz*v(4,0) + wqz*v(4,1) &
               ...
               cur = 0
                        ...
                        tcl(17) = tcl(17) + wcol(2)*v(1, 0)
                        tcl(18) = tcl(18) + wcol(2)*v(2, 0)
                        tcl(19) = tcl(19) + wcol(2)*v(3, 0)
                        tcl(20) = tcl(20) + wcol(2)*v(4, 0)
                        tcl(21) = tcl(21) + wcol(2)*v(5, 0)
                        tcl(22) = tcl(22) + wcol(2)*v(6, 0)
                        tcl(23) = tcl(23) + wcol(2)*v(7, 0)
                        tcl(24) = tcl(24) + wcol(2)*v(8, 0)
                        tcl(25) = tcl(25) + wcol(2)*v(9, 0)
                        tcl(26) = tcl(26) + wcol(2)*v(10, 0)
                        tcl(27) = tcl(27) + wcol(2)*v(11, 0)
                        tcl(28) = tcl(28) + wcol(2)*v(12, 0)
                        tcl(29) = tcl(29) + wcol(2)*v(13, 0)
                        tcl(30) = tcl(30) + wcol(2)*v(14, 0)
                        tcl(31) = tcl(31) + wcol(2)*v(15, 0)
                        tcl(32) = tcl(32) + wcol(2)*v(16, 0)
                        tcl(33) = tcl(33) + wcol(3)*v(1, 0)
                        tcl(34) = tcl(34) + wcol(3)*v(2, 0)
                        tcl(35) = tcl(35) + wcol(3)*v(3, 0)
                        tcl(36) = tcl(36) + wcol(3)*v(4, 0)
                        tcl(37) = tcl(37) + wcol(3)*v(5, 0)
                        tcl(38) = tcl(38) + wcol(3)*v(6, 0)
                        tcl(39) = tcl(39) + wcol(3)*v(7, 0)
                        tcl(40) = tcl(40) + wcol(3)*v(8, 0)
                        tcl(41) = tcl(41) + wcol(3)*v(9, 0)
                        tcl(42) = tcl(42) + wcol(3)*v(10, 0)
                        tcl(43) = tcl(43) + wcol(3)*v(11, 0)
                        tcl(44) = tcl(44) + wcol(3)*v(12, 0)
                        tcl(45) = tcl(45) + wcol(3)*v(13, 0)
                        tcl(46) = tcl(46) + wcol(3)*v(14, 0)
                        tcl(47) = tcl(47) + wcol(3)*v(15, 0)
                        tcl(48) = tcl(48) + wcol(3)*v(16, 0)
                        tcl(49) = tcl(49) + wcol(4)*v(1, 0)
                        tcl(50) = tcl(50) + wcol(4)*v(2, 0)
                        tcl(51) = tcl(51) + wcol(4)*v(3, 0)
                        tcl(52) = tcl(52) + wcol(4)*v(4, 0)
                        tcl(53) = tcl(53) + wcol(4)*v(5, 0)
                        tcl(54) = tcl(54) + wcol(4)*v(6, 0)
                        tcl(55) = tcl(55) + wcol(4)*v(7, 0)
                        tcl(56) = tcl(56) + wcol(4)*v(8, 0)
                        tcl(57) = tcl(57) + wcol(4)*v(9, 0)
                        tcl(58) = tcl(58) + wcol(4)*v(10, 0)
                        tcl(59) = tcl(59) + wcol(4)*v(11, 0)
                        tcl(60) = tcl(60) + wcol(4)*v(12, 0)
                        tcl(61) = tcl(61) + wcol(4)*v(13, 0)
                        tcl(62) = tcl(62) + wcol(4)*v(14, 0)
                        tcl(63) = tcl(63) + wcol(4)*v(15, 0)
                        tcl(64) = tcl(64) + wcol(4)*v(16, 0)
                     end if
                  end do   ! kq0
                  ...
                  if (tau <= nabc) then
                     do c = 1, ncdc
                        ...
                        if (combo >= cb0 .and. combo < cb0 + nbt) then
                           do x = 1, 16
                              Gs(x, combo - cb0 + 1) = gown(x + (c - 1)*16)
                           end do
                        end if
                     end do
                  end if
   ...
   end subroutine pg0101
#endif
end module trc_pg_k0101
