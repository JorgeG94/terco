   ...
   pure subroutine pci1220(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(9) = abx*abz*g(84) &
            ...
            + abz*g(87) &
            + g(96)
         vbuf(10) = aby*aby*g(82) &
            + 2.0_dp*aby*g(86) &
            + g(94)
         vbuf(11) = aby*aby*g(83) &
            + 2.0_dp*aby*g(88) &
            + g(97)
         vbuf(12) = aby*aby*g(84) &
            + 2.0_dp*aby*g(89) &
            + g(98)
         vbuf(13) = aby*abz*g(82) &
            + aby*g(87) &
            + abz*g(86) &
            + g(95)
         vbuf(14) = aby*abz*g(83) &
            + aby*g(89) &
            + abz*g(88) &
            + g(98)
         vbuf(15) = aby*abz*g(84) &
            + aby*g(90) &
            + abz*g(89) &
            + g(99)
         vbuf(16) = abz*abz*g(82) &
            + 2.0_dp*abz*g(87) &
            + g(96)
         vbuf(17) = abz*abz*g(83) &
            + 2.0_dp*abz*g(89) &
            + g(99)
         vbuf(18) = abz*abz*g(84) &
            + 2.0_dp*abz*g(90) &
            + g(100)
         vbuf(19) = abx*abx*g(102) &
            + 2.0_dp*abx*g(105) &
            + g(111)
         vbuf(20) = abx*abx*g(103) &
            + 2.0_dp*abx*g(106) &
            + g(112)
         vbuf(21) = abx*abx*g(104) &
            + 2.0_dp*abx*g(107) &
            + g(113)
         vbuf(22) = abx*aby*g(102) &
            + abx*g(106) &
            + aby*g(105) &
            + g(112)
         vbuf(23) = abx*aby*g(103) &
            + abx*g(108) &
            + aby*g(106) &
            + g(114)
         vbuf(24) = abx*aby*g(104) &
            + abx*g(109) &
            + aby*g(107) &
            + g(115)
         vbuf(25) = abx*abz*g(102) &
            + abx*g(107) &
            + abz*g(105) &
            + g(113)
         vbuf(26) = abx*abz*g(103) &
            + abx*g(109) &
            + abz*g(106) &
            + g(115)
         vbuf(27) = abx*abz*g(104) &
            + abx*g(110) &
            + abz*g(107) &
            + g(116)
         vbuf(28) = aby*aby*g(102) &
            + 2.0_dp*aby*g(106) &
            + g(114)
         vbuf(29) = aby*aby*g(103) &
            + 2.0_dp*aby*g(108) &
            + g(117)
         vbuf(30) = aby*aby*g(104) &
            + 2.0_dp*aby*g(109) &
            + g(118)
         vbuf(31) = aby*abz*g(102) &
            + aby*g(107) &
            + abz*g(106) &
            + g(115)
         vbuf(32) = aby*abz*g(103) &
            + aby*g(109) &
            + abz*g(108) &
            + g(118)
         vbuf(33) = aby*abz*g(104) &
            + aby*g(110) &
            + abz*g(109) &
            + g(119)
         vbuf(34) = abz*abz*g(102) &
            + 2.0_dp*abz*g(107) &
            + g(116)
         vbuf(35) = abz*abz*g(103) &
            + 2.0_dp*abz*g(109) &
            + g(119)
         vbuf(36) = abz*abz*g(104) &
            + 2.0_dp*abz*g(110) &
            + g(120)
         vbuf(37) = abx*abx*g(122) &
            + 2.0_dp*abx*g(125) &
            + g(131)
         vbuf(38) = abx*abx*g(123) &
            + 2.0_dp*abx*g(126) &
            + g(132)
         vbuf(39) = abx*abx*g(124) &
            + 2.0_dp*abx*g(127) &
            + g(133)
         vbuf(40) = abx*aby*g(122) &
            + abx*g(126) &
            + aby*g(125) &
            + g(132)
         vbuf(41) = abx*aby*g(123) &
            + abx*g(128) &
            + aby*g(126) &
            + g(134)
         vbuf(42) = abx*aby*g(124) &
            + abx*g(129) &
            + aby*g(127) &
            + g(135)
         vbuf(43) = abx*abz*g(122) &
            + abx*g(127) &
            + abz*g(125) &
            + g(133)
         vbuf(44) = abx*abz*g(123) &
            + abx*g(129) &
            + abz*g(126) &
            + g(135)
         vbuf(45) = abx*abz*g(124) &
            + abx*g(130) &
            + abz*g(127) &
            + g(136)
         vbuf(46) = aby*aby*g(122) &
            + 2.0_dp*aby*g(126) &
            + g(134)
         vbuf(47) = aby*aby*g(123) &
            + 2.0_dp*aby*g(128) &
            + g(137)
         vbuf(48) = aby*aby*g(124) &
            + 2.0_dp*aby*g(129) &
            + g(138)
         vbuf(49) = aby*abz*g(122) &
            + aby*g(127) &
            + abz*g(126) &
            + g(135)
         vbuf(50) = aby*abz*g(123) &
            + aby*g(129) &
            + abz*g(128) &
            + g(138)
         vbuf(51) = aby*abz*g(124) &
            + aby*g(130) &
            + abz*g(129) &
            + g(139)
         vbuf(52) = abz*abz*g(122) &
            + 2.0_dp*abz*g(127) &
            + g(136)
         vbuf(53) = abz*abz*g(123) &
            + 2.0_dp*abz*g(129) &
            + g(139)
         vbuf(54) = abz*abz*g(124) &
            + 2.0_dp*abz*g(130) &
            + g(140)
         vbuf(55) = abx*abx*g(142) &
            + 2.0_dp*abx*g(145) &
            + g(151)
         vbuf(56) = abx*abx*g(143) &
            + 2.0_dp*abx*g(146) &
            + g(152)
         vbuf(57) = abx*abx*g(144) &
            + 2.0_dp*abx*g(147) &
            + g(153)
         vbuf(58) = abx*aby*g(142) &
            + abx*g(146) &
            + aby*g(145) &
            + g(152)
         vbuf(59) = abx*aby*g(143) &
            + abx*g(148) &
            + aby*g(146) &
            + g(154)
         vbuf(60) = abx*aby*g(144) &
            + abx*g(149) &
            + aby*g(147) &
            + g(155)
         vbuf(61) = abx*abz*g(142) &
            + abx*g(147) &
            + abz*g(145) &
            + g(153)
         vbuf(62) = abx*abz*g(143) &
            + abx*g(149) &
            + abz*g(146) &
            + g(155)
         vbuf(63) = abx*abz*g(144) &
            + abx*g(150) &
            + abz*g(147) &
            + g(156)
         vbuf(64) = aby*aby*g(142) &
            + 2.0_dp*aby*g(146) &
            + g(154)
         vbuf(65) = aby*aby*g(143) &
            + 2.0_dp*aby*g(148) &
            + g(157)
         vbuf(66) = aby*aby*g(144) &
            + 2.0_dp*aby*g(149) &
            + g(158)
         vbuf(67) = aby*abz*g(142) &
            + aby*g(147) &
            + abz*g(146) &
            + g(155)
         vbuf(68) = aby*abz*g(143) &
            + aby*g(149) &
            + abz*g(148) &
            + g(158)
         vbuf(69) = aby*abz*g(144) &
            + aby*g(150) &
            + abz*g(149) &
            + g(159)
         vbuf(70) = abz*abz*g(142) &
            + 2.0_dp*abz*g(147) &
            + g(156)
         vbuf(71) = abz*abz*g(143) &
            + 2.0_dp*abz*g(149) &
            + g(159)
         vbuf(72) = abz*abz*g(144) &
            + 2.0_dp*abz*g(150) &
            + g(160)
         vbuf(73) = abx*abx*g(162) &
            + 2.0_dp*abx*g(165) &
            + g(171)
         vbuf(74) = abx*abx*g(163) &
            + 2.0_dp*abx*g(166) &
            + g(172)
         vbuf(75) = abx*abx*g(164) &
            + 2.0_dp*abx*g(167) &
            + g(173)
         vbuf(76) = abx*aby*g(162) &
            + abx*g(166) &
            + aby*g(165) &
            + g(172)
         vbuf(77) = abx*aby*g(163) &
            + abx*g(168) &
            + aby*g(166) &
            + g(174)
         vbuf(78) = abx*aby*g(164) &
            + abx*g(169) &
            + aby*g(167) &
            + g(175)
         vbuf(79) = abx*abz*g(162) &
            + abx*g(167) &
            + abz*g(165) &
            + g(173)
         vbuf(80) = abx*abz*g(163) &
            + abx*g(169) &
            + abz*g(166) &
            + g(175)
         vbuf(81) = abx*abz*g(164) &
            + abx*g(170) &
            + abz*g(167) &
            + g(176)
         vbuf(82) = aby*aby*g(162) &
            + 2.0_dp*aby*g(166) &
            + g(174)
         vbuf(83) = aby*aby*g(163) &
            + 2.0_dp*aby*g(168) &
            + g(177)
         vbuf(84) = aby*aby*g(164) &
            + 2.0_dp*aby*g(169) &
            + g(178)
         vbuf(85) = aby*abz*g(162) &
            + aby*g(167) &
            + abz*g(166) &
            + g(175)
         vbuf(86) = aby*abz*g(163) &
            + aby*g(169) &
            + abz*g(168) &
            + g(178)
         vbuf(87) = aby*abz*g(164) &
            + aby*g(170) &
            + abz*g(169) &
            + g(179)
         vbuf(88) = abz*abz*g(162) &
            + 2.0_dp*abz*g(167) &
            + g(176)
         vbuf(89) = abz*abz*g(163) &
            + 2.0_dp*abz*g(169) &
            + g(179)
         vbuf(90) = abz*abz*g(164) &
            + 2.0_dp*abz*g(170) &
            + g(180)
         vbuf(91) = abx*abx*g(182) &
            + 2.0_dp*abx*g(185) &
            + g(191)
         vbuf(92) = abx*abx*g(183) &
            + 2.0_dp*abx*g(186) &
            + g(192)
         vbuf(93) = abx*abx*g(184) &
            + 2.0_dp*abx*g(187) &
            + g(193)
         vbuf(94) = abx*aby*g(182) &
            + abx*g(186) &
            + aby*g(185) &
            + g(192)
         vbuf(95) = abx*aby*g(183) &
            + abx*g(188) &
            + aby*g(186) &
            + g(194)
         vbuf(96) = abx*aby*g(184) &
            + abx*g(189) &
            + aby*g(187) &
            + g(195)
         vbuf(97) = abx*abz*g(182) &
            + abx*g(187) &
            + abz*g(185) &
            + g(193)
         vbuf(98) = abx*abz*g(183) &
            + abx*g(189) &
            + abz*g(186) &
            + g(195)
         vbuf(99) = abx*abz*g(184) &
            + abx*g(190) &
            + abz*g(187) &
            + g(196)
         vbuf(100) = aby*aby*g(182) &
            + 2.0_dp*aby*g(186) &
            + g(194)
         vbuf(101) = aby*aby*g(183) &
            + 2.0_dp*aby*g(188) &
            + g(197)
         vbuf(102) = aby*aby*g(184) &
            + 2.0_dp*aby*g(189) &
            + g(198)
         vbuf(103) = aby*abz*g(182) &
            + aby*g(187) &
            + abz*g(186) &
            + g(195)
         vbuf(104) = aby*abz*g(183) &
            + aby*g(189) &
            + abz*g(188) &
            + g(198)
         vbuf(105) = aby*abz*g(184) &
            + aby*g(190) &
            + abz*g(189) &
            + g(199)
         vbuf(106) = abz*abz*g(182) &
            + 2.0_dp*abz*g(187) &
            + g(196)
         vbuf(107) = abz*abz*g(183) &
            + 2.0_dp*abz*g(189) &
            + g(199)
         vbuf(108) = abz*abz*g(184) &
            + 2.0_dp*abz*g(190) &
            + g(200)
