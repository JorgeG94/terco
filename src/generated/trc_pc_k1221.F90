...
contains
   ...
   pure subroutine pci1221(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(1) = abx*abx*cdx*g(82) &
            + abx*abx*g(202) &
            + 2.0_dp*abx*cdx*g(85) &
            + 2.0_dp*abx*g(205) &
            + cdx*g(91) &
            + g(211)
         vbuf(2) = abx*abx*cdx*g(83) &
            + abx*abx*g(203) &
            + 2.0_dp*abx*cdx*g(86) &
            + 2.0_dp*abx*g(206) &
            + cdx*g(92) &
            + g(212)
         vbuf(3) = abx*abx*cdx*g(84) &
            + abx*abx*g(204) &
            + 2.0_dp*abx*cdx*g(87) &
            + 2.0_dp*abx*g(207) &
            + cdx*g(93) &
            + g(213)
         vbuf(4) = abx*aby*cdx*g(82) &
            + abx*aby*g(202) &
            + abx*cdx*g(86) &
            + abx*g(206) &
            + aby*cdx*g(85) &
         ...
         vbuf(9) = abx*abz*cdx*g(84) &
            ...
            + cdx*g(96) &
            + g(216)
         vbuf(10) = aby*aby*cdx*g(82) &
            + aby*aby*g(202) &
            + 2.0_dp*aby*cdx*g(86) &
            + 2.0_dp*aby*g(206) &
            + cdx*g(94) &
            + g(214)
         vbuf(11) = aby*aby*cdx*g(83) &
            + aby*aby*g(203) &
            + 2.0_dp*aby*cdx*g(88) &
            + 2.0_dp*aby*g(208) &
            + cdx*g(97) &
            + g(217)
         vbuf(12) = aby*aby*cdx*g(84) &
            + aby*aby*g(204) &
            + 2.0_dp*aby*cdx*g(89) &
            + 2.0_dp*aby*g(209) &
            + cdx*g(98) &
            + g(218)
         vbuf(13) = aby*abz*cdx*g(82) &
            + aby*abz*g(202) &
            + aby*cdx*g(87) &
            + aby*g(207) &
            + abz*cdx*g(86) &
         ...
         vbuf(15) = aby*abz*cdx*g(84) &
            ...
            + cdx*g(99) &
            + g(219)
         vbuf(16) = abz*abz*cdx*g(82) &
            + abz*abz*g(202) &
            + 2.0_dp*abz*cdx*g(87) &
            + 2.0_dp*abz*g(207) &
            + cdx*g(96) &
            + g(216)
         vbuf(17) = abz*abz*cdx*g(83) &
            + abz*abz*g(203) &
            + 2.0_dp*abz*cdx*g(89) &
            + 2.0_dp*abz*g(209) &
            + cdx*g(99) &
            + g(219)
         vbuf(18) = abz*abz*cdx*g(84) &
            + abz*abz*g(204) &
            + 2.0_dp*abz*cdx*g(90) &
            + 2.0_dp*abz*g(210) &
            + cdx*g(100) &
            + g(220)
         vbuf(19) = abx*abx*cdx*g(102) &
            + abx*abx*g(222) &
            + 2.0_dp*abx*cdx*g(105) &
            + 2.0_dp*abx*g(225) &
            + cdx*g(111) &
            + g(231)
         vbuf(20) = abx*abx*cdx*g(103) &
            + abx*abx*g(223) &
            + 2.0_dp*abx*cdx*g(106) &
            + 2.0_dp*abx*g(226) &
            + cdx*g(112) &
            + g(232)
         vbuf(21) = abx*abx*cdx*g(104) &
            + abx*abx*g(224) &
            + 2.0_dp*abx*cdx*g(107) &
            + 2.0_dp*abx*g(227) &
            + cdx*g(113) &
            + g(233)
         vbuf(22) = abx*aby*cdx*g(102) &
            + abx*aby*g(222) &
            + abx*cdx*g(106) &
            + abx*g(226) &
            + aby*cdx*g(105) &
         ...
         vbuf(27) = abx*abz*cdx*g(104) &
            ...
            + cdx*g(116) &
            + g(236)
         vbuf(28) = aby*aby*cdx*g(102) &
            + aby*aby*g(222) &
            + 2.0_dp*aby*cdx*g(106) &
            + 2.0_dp*aby*g(226) &
            + cdx*g(114) &
            + g(234)
         vbuf(29) = aby*aby*cdx*g(103) &
            + aby*aby*g(223) &
            + 2.0_dp*aby*cdx*g(108) &
            + 2.0_dp*aby*g(228) &
            + cdx*g(117) &
            + g(237)
         vbuf(30) = aby*aby*cdx*g(104) &
            + aby*aby*g(224) &
            + 2.0_dp*aby*cdx*g(109) &
            + 2.0_dp*aby*g(229) &
            + cdx*g(118) &
            + g(238)
         vbuf(31) = aby*abz*cdx*g(102) &
            + aby*abz*g(222) &
            + aby*cdx*g(107) &
            + aby*g(227) &
            + abz*cdx*g(106) &
         ...
         vbuf(33) = aby*abz*cdx*g(104) &
            ...
            + cdx*g(119) &
            + g(239)
         vbuf(34) = abz*abz*cdx*g(102) &
            + abz*abz*g(222) &
            + 2.0_dp*abz*cdx*g(107) &
            + 2.0_dp*abz*g(227) &
            + cdx*g(116) &
            + g(236)
         vbuf(35) = abz*abz*cdx*g(103) &
            + abz*abz*g(223) &
            + 2.0_dp*abz*cdx*g(109) &
            + 2.0_dp*abz*g(229) &
            + cdx*g(119) &
            + g(239)
         vbuf(36) = abz*abz*cdx*g(104) &
            + abz*abz*g(224) &
            + 2.0_dp*abz*cdx*g(110) &
            + 2.0_dp*abz*g(230) &
            + cdx*g(120) &
            + g(240)
         vbuf(37) = abx*abx*cdx*g(122) &
            + abx*abx*g(242) &
            + 2.0_dp*abx*cdx*g(125) &
            + 2.0_dp*abx*g(245) &
            + cdx*g(131) &
            + g(251)
         vbuf(38) = abx*abx*cdx*g(123) &
            + abx*abx*g(243) &
            + 2.0_dp*abx*cdx*g(126) &
            + 2.0_dp*abx*g(246) &
            + cdx*g(132) &
            + g(252)
         vbuf(39) = abx*abx*cdx*g(124) &
            + abx*abx*g(244) &
            + 2.0_dp*abx*cdx*g(127) &
            + 2.0_dp*abx*g(247) &
            + cdx*g(133) &
            + g(253)
         vbuf(40) = abx*aby*cdx*g(122) &
            + abx*aby*g(242) &
            + abx*cdx*g(126) &
            + abx*g(246) &
            + aby*cdx*g(125) &
         ...
         vbuf(45) = abx*abz*cdx*g(124) &
            ...
            + cdx*g(136) &
            + g(256)
         vbuf(46) = aby*aby*cdx*g(122) &
            + aby*aby*g(242) &
            + 2.0_dp*aby*cdx*g(126) &
            + 2.0_dp*aby*g(246) &
            + cdx*g(134) &
            + g(254)
         vbuf(47) = aby*aby*cdx*g(123) &
            + aby*aby*g(243) &
            + 2.0_dp*aby*cdx*g(128) &
            + 2.0_dp*aby*g(248) &
            + cdx*g(137) &
            + g(257)
         vbuf(48) = aby*aby*cdx*g(124) &
            + aby*aby*g(244) &
            + 2.0_dp*aby*cdx*g(129) &
            + 2.0_dp*aby*g(249) &
            + cdx*g(138) &
            + g(258)
         vbuf(49) = aby*abz*cdx*g(122) &
            + aby*abz*g(242) &
            + aby*cdx*g(127) &
            + aby*g(247) &
            + abz*cdx*g(126) &
         ...
         vbuf(51) = aby*abz*cdx*g(124) &
            ...
            + cdx*g(139) &
            + g(259)
         vbuf(52) = abz*abz*cdx*g(122) &
            + abz*abz*g(242) &
            + 2.0_dp*abz*cdx*g(127) &
            + 2.0_dp*abz*g(247) &
            + cdx*g(136) &
            + g(256)
         vbuf(53) = abz*abz*cdx*g(123) &
            + abz*abz*g(243) &
            + 2.0_dp*abz*cdx*g(129) &
            + 2.0_dp*abz*g(249) &
            + cdx*g(139) &
            + g(259)
         vbuf(54) = abz*abz*cdx*g(124) &
            + abz*abz*g(244) &
            + 2.0_dp*abz*cdx*g(130) &
            + 2.0_dp*abz*g(250) &
            + cdx*g(140) &
            + g(260)
         vbuf(55) = abx*abx*cdx*g(142) &
            + abx*abx*g(262) &
            + 2.0_dp*abx*cdx*g(145) &
            + 2.0_dp*abx*g(265) &
            + cdx*g(151) &
            + g(271)
         vbuf(56) = abx*abx*cdx*g(143) &
            + abx*abx*g(263) &
            + 2.0_dp*abx*cdx*g(146) &
            + 2.0_dp*abx*g(266) &
            + cdx*g(152) &
            + g(272)
         vbuf(57) = abx*abx*cdx*g(144) &
            + abx*abx*g(264) &
            + 2.0_dp*abx*cdx*g(147) &
            + 2.0_dp*abx*g(267) &
            + cdx*g(153) &
            + g(273)
         vbuf(58) = abx*aby*cdx*g(142) &
            + abx*aby*g(262) &
            + abx*cdx*g(146) &
            + abx*g(266) &
            + aby*cdx*g(145) &
         ...
         vbuf(63) = abx*abz*cdx*g(144) &
            ...
            + cdx*g(156) &
            + g(276)
         vbuf(64) = aby*aby*cdx*g(142) &
            + aby*aby*g(262) &
            + 2.0_dp*aby*cdx*g(146) &
            + 2.0_dp*aby*g(266) &
            + cdx*g(154) &
            + g(274)
         vbuf(65) = aby*aby*cdx*g(143) &
            + aby*aby*g(263) &
            + 2.0_dp*aby*cdx*g(148) &
            + 2.0_dp*aby*g(268) &
            + cdx*g(157) &
            + g(277)
         vbuf(66) = aby*aby*cdx*g(144) &
            + aby*aby*g(264) &
            + 2.0_dp*aby*cdx*g(149) &
            + 2.0_dp*aby*g(269) &
            + cdx*g(158) &
            + g(278)
         vbuf(67) = aby*abz*cdx*g(142) &
            + aby*abz*g(262) &
            + aby*cdx*g(147) &
            + aby*g(267) &
            + abz*cdx*g(146) &
         ...
         vbuf(69) = aby*abz*cdx*g(144) &
            ...
            + cdx*g(159) &
            + g(279)
         vbuf(70) = abz*abz*cdx*g(142) &
            + abz*abz*g(262) &
            + 2.0_dp*abz*cdx*g(147) &
            + 2.0_dp*abz*g(267) &
            + cdx*g(156) &
            + g(276)
         vbuf(71) = abz*abz*cdx*g(143) &
            + abz*abz*g(263) &
            + 2.0_dp*abz*cdx*g(149) &
            + 2.0_dp*abz*g(269) &
            + cdx*g(159) &
            + g(279)
         vbuf(72) = abz*abz*cdx*g(144) &
            + abz*abz*g(264) &
            + 2.0_dp*abz*cdx*g(150) &
            + 2.0_dp*abz*g(270) &
            + cdx*g(160) &
            + g(280)
         vbuf(73) = abx*abx*cdx*g(162) &
            + abx*abx*g(282) &
            + 2.0_dp*abx*cdx*g(165) &
            + 2.0_dp*abx*g(285) &
            + cdx*g(171) &
            + g(291)
         vbuf(74) = abx*abx*cdx*g(163) &
            + abx*abx*g(283) &
            + 2.0_dp*abx*cdx*g(166) &
            + 2.0_dp*abx*g(286) &
            + cdx*g(172) &
            + g(292)
         vbuf(75) = abx*abx*cdx*g(164) &
            + abx*abx*g(284) &
            + 2.0_dp*abx*cdx*g(167) &
            + 2.0_dp*abx*g(287) &
            + cdx*g(173) &
            + g(293)
         vbuf(76) = abx*aby*cdx*g(162) &
            + abx*aby*g(282) &
            + abx*cdx*g(166) &
            + abx*g(286) &
            + aby*cdx*g(165) &
         ...
         vbuf(81) = abx*abz*cdx*g(164) &
            ...
            + cdx*g(176) &
            + g(296)
         vbuf(82) = aby*aby*cdx*g(162) &
            + aby*aby*g(282) &
            + 2.0_dp*aby*cdx*g(166) &
            + 2.0_dp*aby*g(286) &
            + cdx*g(174) &
            + g(294)
         vbuf(83) = aby*aby*cdx*g(163) &
            + aby*aby*g(283) &
            + 2.0_dp*aby*cdx*g(168) &
            + 2.0_dp*aby*g(288) &
            + cdx*g(177) &
            + g(297)
         vbuf(84) = aby*aby*cdx*g(164) &
            + aby*aby*g(284) &
            + 2.0_dp*aby*cdx*g(169) &
            + 2.0_dp*aby*g(289) &
            + cdx*g(178) &
            + g(298)
         vbuf(85) = aby*abz*cdx*g(162) &
            + aby*abz*g(282) &
            + aby*cdx*g(167) &
            + aby*g(287) &
            + abz*cdx*g(166) &
         ...
         vbuf(87) = aby*abz*cdx*g(164) &
            ...
            + cdx*g(179) &
            + g(299)
         vbuf(88) = abz*abz*cdx*g(162) &
            + abz*abz*g(282) &
            + 2.0_dp*abz*cdx*g(167) &
            + 2.0_dp*abz*g(287) &
            + cdx*g(176) &
            + g(296)
         vbuf(89) = abz*abz*cdx*g(163) &
            + abz*abz*g(283) &
            + 2.0_dp*abz*cdx*g(169) &
            + 2.0_dp*abz*g(289) &
            + cdx*g(179) &
            + g(299)
         vbuf(90) = abz*abz*cdx*g(164) &
            + abz*abz*g(284) &
            + 2.0_dp*abz*cdx*g(170) &
            + 2.0_dp*abz*g(290) &
            + cdx*g(180) &
            + g(300)
         vbuf(91) = abx*abx*cdx*g(182) &
            + abx*abx*g(302) &
            + 2.0_dp*abx*cdx*g(185) &
            + 2.0_dp*abx*g(305) &
            + cdx*g(191) &
            + g(311)
         vbuf(92) = abx*abx*cdx*g(183) &
            + abx*abx*g(303) &
            + 2.0_dp*abx*cdx*g(186) &
            + 2.0_dp*abx*g(306) &
            + cdx*g(192) &
            + g(312)
         vbuf(93) = abx*abx*cdx*g(184) &
            + abx*abx*g(304) &
            + 2.0_dp*abx*cdx*g(187) &
            + 2.0_dp*abx*g(307) &
            + cdx*g(193) &
            + g(313)
         vbuf(94) = abx*aby*cdx*g(182) &
            + abx*aby*g(302) &
            + abx*cdx*g(186) &
            + abx*g(306) &
            + aby*cdx*g(185) &
         ...
         vbuf(99) = abx*abz*cdx*g(184) &
            ...
            + cdx*g(196) &
            + g(316)
         vbuf(100) = aby*aby*cdx*g(182) &
            + aby*aby*g(302) &
            + 2.0_dp*aby*cdx*g(186) &
            + 2.0_dp*aby*g(306) &
            + cdx*g(194) &
            + g(314)
         vbuf(101) = aby*aby*cdx*g(183) &
            + aby*aby*g(303) &
            + 2.0_dp*aby*cdx*g(188) &
            + 2.0_dp*aby*g(308) &
            + cdx*g(197) &
            + g(317)
         vbuf(102) = aby*aby*cdx*g(184) &
            + aby*aby*g(304) &
            + 2.0_dp*aby*cdx*g(189) &
            + 2.0_dp*aby*g(309) &
            + cdx*g(198) &
            + g(318)
         vbuf(103) = aby*abz*cdx*g(182) &
            + aby*abz*g(302) &
            + aby*cdx*g(187) &
            + aby*g(307) &
            + abz*cdx*g(186) &
         ...
         vbuf(105) = aby*abz*cdx*g(184) &
            ...
            + cdx*g(199) &
            + g(319)
         vbuf(106) = abz*abz*cdx*g(182) &
            + abz*abz*g(302) &
            + 2.0_dp*abz*cdx*g(187) &
            + 2.0_dp*abz*g(307) &
            + cdx*g(196) &
            + g(316)
         vbuf(107) = abz*abz*cdx*g(183) &
            + abz*abz*g(303) &
            + 2.0_dp*abz*cdx*g(189) &
            + 2.0_dp*abz*g(309) &
            + cdx*g(199) &
            + g(319)
         vbuf(108) = abz*abz*cdx*g(184) &
            + abz*abz*g(304) &
            + 2.0_dp*abz*cdx*g(190) &
            + 2.0_dp*abz*g(310) &
            + cdx*g(200) &
            + g(320)
         vbuf(109) = abx*abx*cdy*g(82) &
            + abx*abx*g(222) &
            + 2.0_dp*abx*cdy*g(85) &
            + 2.0_dp*abx*g(225) &
            + cdy*g(91) &
            + g(231)
         vbuf(110) = abx*abx*cdy*g(83) &
            + abx*abx*g(223) &
            + 2.0_dp*abx*cdy*g(86) &
            + 2.0_dp*abx*g(226) &
            + cdy*g(92) &
            + g(232)
         vbuf(111) = abx*abx*cdy*g(84) &
            + abx*abx*g(224) &
            + 2.0_dp*abx*cdy*g(87) &
            + 2.0_dp*abx*g(227) &
            + cdy*g(93) &
            + g(233)
         vbuf(112) = abx*aby*cdy*g(82) &
            + abx*aby*g(222) &
            + abx*cdy*g(86) &
            + abx*g(226) &
            + aby*cdy*g(85) &
         ...
         vbuf(117) = abx*abz*cdy*g(84) &
            ...
            + cdy*g(96) &
            + g(236)
         vbuf(118) = aby*aby*cdy*g(82) &
            + aby*aby*g(222) &
            + 2.0_dp*aby*cdy*g(86) &
            + 2.0_dp*aby*g(226) &
            + cdy*g(94) &
            + g(234)
         vbuf(119) = aby*aby*cdy*g(83) &
            + aby*aby*g(223) &
            + 2.0_dp*aby*cdy*g(88) &
            + 2.0_dp*aby*g(228) &
            + cdy*g(97) &
            + g(237)
         vbuf(120) = aby*aby*cdy*g(84) &
            + aby*aby*g(224) &
            + 2.0_dp*aby*cdy*g(89) &
            + 2.0_dp*aby*g(229) &
            + cdy*g(98) &
            + g(238)
         vbuf(121) = aby*abz*cdy*g(82) &
            + aby*abz*g(222) &
            + aby*cdy*g(87) &
            + aby*g(227) &
            + abz*cdy*g(86) &
         ...
         vbuf(123) = aby*abz*cdy*g(84) &
            ...
            + cdy*g(99) &
            + g(239)
         vbuf(124) = abz*abz*cdy*g(82) &
            + abz*abz*g(222) &
            + 2.0_dp*abz*cdy*g(87) &
            + 2.0_dp*abz*g(227) &
            + cdy*g(96) &
            + g(236)
         vbuf(125) = abz*abz*cdy*g(83) &
            + abz*abz*g(223) &
            + 2.0_dp*abz*cdy*g(89) &
            + 2.0_dp*abz*g(229) &
            + cdy*g(99) &
            + g(239)
         vbuf(126) = abz*abz*cdy*g(84) &
            + abz*abz*g(224) &
            + 2.0_dp*abz*cdy*g(90) &
            + 2.0_dp*abz*g(230) &
            + cdy*g(100) &
            + g(240)
         vbuf(127) = abx*abx*cdy*g(102) &
            + abx*abx*g(262) &
            + 2.0_dp*abx*cdy*g(105) &
            + 2.0_dp*abx*g(265) &
            + cdy*g(111) &
            + g(271)
         vbuf(128) = abx*abx*cdy*g(103) &
            + abx*abx*g(263) &
            + 2.0_dp*abx*cdy*g(106) &
            + 2.0_dp*abx*g(266) &
            + cdy*g(112) &
            + g(272)
         vbuf(129) = abx*abx*cdy*g(104) &
            + abx*abx*g(264) &
            + 2.0_dp*abx*cdy*g(107) &
            + 2.0_dp*abx*g(267) &
            + cdy*g(113) &
            + g(273)
         vbuf(130) = abx*aby*cdy*g(102) &
            + abx*aby*g(262) &
            + abx*cdy*g(106) &
            + abx*g(266) &
            + aby*cdy*g(105) &
         ...
         vbuf(135) = abx*abz*cdy*g(104) &
            ...
            + cdy*g(116) &
            + g(276)
         vbuf(136) = aby*aby*cdy*g(102) &
            + aby*aby*g(262) &
            + 2.0_dp*aby*cdy*g(106) &
            + 2.0_dp*aby*g(266) &
            + cdy*g(114) &
            + g(274)
         vbuf(137) = aby*aby*cdy*g(103) &
            + aby*aby*g(263) &
            + 2.0_dp*aby*cdy*g(108) &
            + 2.0_dp*aby*g(268) &
            + cdy*g(117) &
            + g(277)
         vbuf(138) = aby*aby*cdy*g(104) &
            + aby*aby*g(264) &
            + 2.0_dp*aby*cdy*g(109) &
            + 2.0_dp*aby*g(269) &
            + cdy*g(118) &
            + g(278)
         vbuf(139) = aby*abz*cdy*g(102) &
            + aby*abz*g(262) &
            + aby*cdy*g(107) &
            + aby*g(267) &
            + abz*cdy*g(106) &
         ...
         vbuf(141) = aby*abz*cdy*g(104) &
            ...
            + cdy*g(119) &
            + g(279)
         vbuf(142) = abz*abz*cdy*g(102) &
            + abz*abz*g(262) &
            + 2.0_dp*abz*cdy*g(107) &
            + 2.0_dp*abz*g(267) &
            + cdy*g(116) &
            + g(276)
         vbuf(143) = abz*abz*cdy*g(103) &
            + abz*abz*g(263) &
            + 2.0_dp*abz*cdy*g(109) &
            + 2.0_dp*abz*g(269) &
            + cdy*g(119) &
            + g(279)
         vbuf(144) = abz*abz*cdy*g(104) &
            + abz*abz*g(264) &
            + 2.0_dp*abz*cdy*g(110) &
            + 2.0_dp*abz*g(270) &
            + cdy*g(120) &
            + g(280)
         vbuf(145) = abx*abx*cdy*g(122) &
            + abx*abx*g(282) &
            + 2.0_dp*abx*cdy*g(125) &
            + 2.0_dp*abx*g(285) &
            + cdy*g(131) &
            + g(291)
         vbuf(146) = abx*abx*cdy*g(123) &
            + abx*abx*g(283) &
            + 2.0_dp*abx*cdy*g(126) &
            + 2.0_dp*abx*g(286) &
            + cdy*g(132) &
            + g(292)
         vbuf(147) = abx*abx*cdy*g(124) &
            + abx*abx*g(284) &
            + 2.0_dp*abx*cdy*g(127) &
            + 2.0_dp*abx*g(287) &
            + cdy*g(133) &
            + g(293)
         vbuf(148) = abx*aby*cdy*g(122) &
            + abx*aby*g(282) &
            + abx*cdy*g(126) &
            + abx*g(286) &
            + aby*cdy*g(125) &
         ...
         vbuf(153) = abx*abz*cdy*g(124) &
            ...
            + cdy*g(136) &
            + g(296)
         vbuf(154) = aby*aby*cdy*g(122) &
            + aby*aby*g(282) &
            + 2.0_dp*aby*cdy*g(126) &
            + 2.0_dp*aby*g(286) &
            + cdy*g(134) &
            + g(294)
         vbuf(155) = aby*aby*cdy*g(123) &
            + aby*aby*g(283) &
            + 2.0_dp*aby*cdy*g(128) &
            + 2.0_dp*aby*g(288) &
            + cdy*g(137) &
            + g(297)
         vbuf(156) = aby*aby*cdy*g(124) &
            + aby*aby*g(284) &
            + 2.0_dp*aby*cdy*g(129) &
            + 2.0_dp*aby*g(289) &
            + cdy*g(138) &
            + g(298)
         vbuf(157) = aby*abz*cdy*g(122) &
            + aby*abz*g(282) &
            + aby*cdy*g(127) &
            + aby*g(287) &
            + abz*cdy*g(126) &
         ...
         vbuf(159) = aby*abz*cdy*g(124) &
            ...
            + cdy*g(139) &
            + g(299)
         vbuf(160) = abz*abz*cdy*g(122) &
            + abz*abz*g(282) &
            + 2.0_dp*abz*cdy*g(127) &
            + 2.0_dp*abz*g(287) &
            + cdy*g(136) &
            + g(296)
         vbuf(161) = abz*abz*cdy*g(123) &
            + abz*abz*g(283) &
            + 2.0_dp*abz*cdy*g(129) &
            + 2.0_dp*abz*g(289) &
            + cdy*g(139) &
            + g(299)
         vbuf(162) = abz*abz*cdy*g(124) &
            + abz*abz*g(284) &
            + 2.0_dp*abz*cdy*g(130) &
            + 2.0_dp*abz*g(290) &
            + cdy*g(140) &
            + g(300)
         vbuf(163) = abx*abx*cdy*g(142) &
            + abx*abx*g(322) &
            + 2.0_dp*abx*cdy*g(145) &
            + 2.0_dp*abx*g(325) &
            + cdy*g(151) &
            + g(331)
         vbuf(164) = abx*abx*cdy*g(143) &
            + abx*abx*g(323) &
            + 2.0_dp*abx*cdy*g(146) &
            + 2.0_dp*abx*g(326) &
            + cdy*g(152) &
            + g(332)
         vbuf(165) = abx*abx*cdy*g(144) &
            + abx*abx*g(324) &
            + 2.0_dp*abx*cdy*g(147) &
            + 2.0_dp*abx*g(327) &
            + cdy*g(153) &
            + g(333)
         vbuf(166) = abx*aby*cdy*g(142) &
            + abx*aby*g(322) &
            + abx*cdy*g(146) &
            + abx*g(326) &
            + aby*cdy*g(145) &
         ...
         vbuf(171) = abx*abz*cdy*g(144) &
            ...
            + cdy*g(156) &
            + g(336)
         vbuf(172) = aby*aby*cdy*g(142) &
            + aby*aby*g(322) &
            + 2.0_dp*aby*cdy*g(146) &
            + 2.0_dp*aby*g(326) &
            + cdy*g(154) &
            + g(334)
         vbuf(173) = aby*aby*cdy*g(143) &
            + aby*aby*g(323) &
            + 2.0_dp*aby*cdy*g(148) &
            + 2.0_dp*aby*g(328) &
            + cdy*g(157) &
            + g(337)
         vbuf(174) = aby*aby*cdy*g(144) &
            + aby*aby*g(324) &
            + 2.0_dp*aby*cdy*g(149) &
            + 2.0_dp*aby*g(329) &
            + cdy*g(158) &
            + g(338)
         vbuf(175) = aby*abz*cdy*g(142) &
            + aby*abz*g(322) &
            + aby*cdy*g(147) &
            + aby*g(327) &
            + abz*cdy*g(146) &
         ...
         vbuf(177) = aby*abz*cdy*g(144) &
            ...
            + cdy*g(159) &
            + g(339)
         vbuf(178) = abz*abz*cdy*g(142) &
            + abz*abz*g(322) &
            + 2.0_dp*abz*cdy*g(147) &
            + 2.0_dp*abz*g(327) &
            + cdy*g(156) &
            + g(336)
         vbuf(179) = abz*abz*cdy*g(143) &
            + abz*abz*g(323) &
            + 2.0_dp*abz*cdy*g(149) &
            + 2.0_dp*abz*g(329) &
            + cdy*g(159) &
            + g(339)
         vbuf(180) = abz*abz*cdy*g(144) &
            + abz*abz*g(324) &
            + 2.0_dp*abz*cdy*g(150) &
            + 2.0_dp*abz*g(330) &
            + cdy*g(160) &
            + g(340)
         vbuf(181) = abx*abx*cdy*g(162) &
            + abx*abx*g(342) &
            + 2.0_dp*abx*cdy*g(165) &
            + 2.0_dp*abx*g(345) &
            + cdy*g(171) &
            + g(351)
         vbuf(182) = abx*abx*cdy*g(163) &
            + abx*abx*g(343) &
            + 2.0_dp*abx*cdy*g(166) &
            + 2.0_dp*abx*g(346) &
            + cdy*g(172) &
            + g(352)
         vbuf(183) = abx*abx*cdy*g(164) &
            + abx*abx*g(344) &
            + 2.0_dp*abx*cdy*g(167) &
            + 2.0_dp*abx*g(347) &
            + cdy*g(173) &
            + g(353)
         vbuf(184) = abx*aby*cdy*g(162) &
            + abx*aby*g(342) &
            + abx*cdy*g(166) &
            + abx*g(346) &
            + aby*cdy*g(165) &
         ...
         vbuf(189) = abx*abz*cdy*g(164) &
            ...
            + cdy*g(176) &
            + g(356)
         vbuf(190) = aby*aby*cdy*g(162) &
            + aby*aby*g(342) &
            + 2.0_dp*aby*cdy*g(166) &
            + 2.0_dp*aby*g(346) &
            + cdy*g(174) &
            + g(354)
         vbuf(191) = aby*aby*cdy*g(163) &
            + aby*aby*g(343) &
            + 2.0_dp*aby*cdy*g(168) &
            + 2.0_dp*aby*g(348) &
            + cdy*g(177) &
            + g(357)
         vbuf(192) = aby*aby*cdy*g(164) &
            + aby*aby*g(344) &
            + 2.0_dp*aby*cdy*g(169) &
            + 2.0_dp*aby*g(349) &
            + cdy*g(178) &
            + g(358)
         vbuf(193) = aby*abz*cdy*g(162) &
            + aby*abz*g(342) &
            + aby*cdy*g(167) &
            + aby*g(347) &
            + abz*cdy*g(166) &
         ...
         vbuf(195) = aby*abz*cdy*g(164) &
            ...
            + cdy*g(179) &
            + g(359)
         vbuf(196) = abz*abz*cdy*g(162) &
            + abz*abz*g(342) &
            + 2.0_dp*abz*cdy*g(167) &
            + 2.0_dp*abz*g(347) &
            + cdy*g(176) &
            + g(356)
         vbuf(197) = abz*abz*cdy*g(163) &
            + abz*abz*g(343) &
            + 2.0_dp*abz*cdy*g(169) &
            + 2.0_dp*abz*g(349) &
            + cdy*g(179) &
            + g(359)
         vbuf(198) = abz*abz*cdy*g(164) &
            + abz*abz*g(344) &
            + 2.0_dp*abz*cdy*g(170) &
            + 2.0_dp*abz*g(350) &
            + cdy*g(180) &
            + g(360)
         vbuf(199) = abx*abx*cdy*g(182) &
            + abx*abx*g(362) &
            + 2.0_dp*abx*cdy*g(185) &
            + 2.0_dp*abx*g(365) &
            + cdy*g(191) &
            + g(371)
         vbuf(200) = abx*abx*cdy*g(183) &
            + abx*abx*g(363) &
            + 2.0_dp*abx*cdy*g(186) &
            + 2.0_dp*abx*g(366) &
            + cdy*g(192) &
            + g(372)
         vbuf(201) = abx*abx*cdy*g(184) &
            + abx*abx*g(364) &
            + 2.0_dp*abx*cdy*g(187) &
            + 2.0_dp*abx*g(367) &
            + cdy*g(193) &
            + g(373)
         vbuf(202) = abx*aby*cdy*g(182) &
            + abx*aby*g(362) &
            + abx*cdy*g(186) &
            + abx*g(366) &
            + aby*cdy*g(185) &
         ...
         vbuf(207) = abx*abz*cdy*g(184) &
            ...
            + cdy*g(196) &
            + g(376)
         vbuf(208) = aby*aby*cdy*g(182) &
            + aby*aby*g(362) &
            + 2.0_dp*aby*cdy*g(186) &
            + 2.0_dp*aby*g(366) &
            + cdy*g(194) &
            + g(374)
         vbuf(209) = aby*aby*cdy*g(183) &
            + aby*aby*g(363) &
            + 2.0_dp*aby*cdy*g(188) &
            + 2.0_dp*aby*g(368) &
            + cdy*g(197) &
            + g(377)
         vbuf(210) = aby*aby*cdy*g(184) &
            + aby*aby*g(364) &
            + 2.0_dp*aby*cdy*g(189) &
            + 2.0_dp*aby*g(369) &
            + cdy*g(198) &
            + g(378)
         vbuf(211) = aby*abz*cdy*g(182) &
            + aby*abz*g(362) &
            + aby*cdy*g(187) &
            + aby*g(367) &
            + abz*cdy*g(186) &
         ...
         vbuf(213) = aby*abz*cdy*g(184) &
            ...
            + cdy*g(199) &
            + g(379)
         vbuf(214) = abz*abz*cdy*g(182) &
            + abz*abz*g(362) &
            + 2.0_dp*abz*cdy*g(187) &
            + 2.0_dp*abz*g(367) &
            + cdy*g(196) &
            + g(376)
         vbuf(215) = abz*abz*cdy*g(183) &
            + abz*abz*g(363) &
            + 2.0_dp*abz*cdy*g(189) &
            + 2.0_dp*abz*g(369) &
            + cdy*g(199) &
            + g(379)
         vbuf(216) = abz*abz*cdy*g(184) &
            + abz*abz*g(364) &
            + 2.0_dp*abz*cdy*g(190) &
            + 2.0_dp*abz*g(370) &
            + cdy*g(200) &
            + g(380)
         vbuf(217) = abx*abx*cdz*g(82) &
            + abx*abx*g(242) &
            + 2.0_dp*abx*cdz*g(85) &
            + 2.0_dp*abx*g(245) &
            + cdz*g(91) &
            + g(251)
         vbuf(218) = abx*abx*cdz*g(83) &
            + abx*abx*g(243) &
            + 2.0_dp*abx*cdz*g(86) &
            + 2.0_dp*abx*g(246) &
            + cdz*g(92) &
            + g(252)
         vbuf(219) = abx*abx*cdz*g(84) &
            + abx*abx*g(244) &
            + 2.0_dp*abx*cdz*g(87) &
            + 2.0_dp*abx*g(247) &
            + cdz*g(93) &
            + g(253)
         vbuf(220) = abx*aby*cdz*g(82) &
            + abx*aby*g(242) &
            + abx*cdz*g(86) &
            + abx*g(246) &
            + aby*cdz*g(85) &
         ...
         vbuf(225) = abx*abz*cdz*g(84) &
            ...
            + cdz*g(96) &
            + g(256)
         vbuf(226) = aby*aby*cdz*g(82) &
            + aby*aby*g(242) &
            + 2.0_dp*aby*cdz*g(86) &
            + 2.0_dp*aby*g(246) &
            + cdz*g(94) &
            + g(254)
         vbuf(227) = aby*aby*cdz*g(83) &
            + aby*aby*g(243) &
            + 2.0_dp*aby*cdz*g(88) &
            + 2.0_dp*aby*g(248) &
            + cdz*g(97) &
            + g(257)
         vbuf(228) = aby*aby*cdz*g(84) &
            + aby*aby*g(244) &
            + 2.0_dp*aby*cdz*g(89) &
            + 2.0_dp*aby*g(249) &
            + cdz*g(98) &
            + g(258)
         vbuf(229) = aby*abz*cdz*g(82) &
            + aby*abz*g(242) &
            + aby*cdz*g(87) &
            + aby*g(247) &
            + abz*cdz*g(86) &
         ...
         vbuf(231) = aby*abz*cdz*g(84) &
            ...
            + cdz*g(99) &
            + g(259)
         vbuf(232) = abz*abz*cdz*g(82) &
            + abz*abz*g(242) &
            + 2.0_dp*abz*cdz*g(87) &
            + 2.0_dp*abz*g(247) &
            + cdz*g(96) &
            + g(256)
         vbuf(233) = abz*abz*cdz*g(83) &
            + abz*abz*g(243) &
            + 2.0_dp*abz*cdz*g(89) &
            + 2.0_dp*abz*g(249) &
            + cdz*g(99) &
            + g(259)
         vbuf(234) = abz*abz*cdz*g(84) &
            + abz*abz*g(244) &
            + 2.0_dp*abz*cdz*g(90) &
            + 2.0_dp*abz*g(250) &
            + cdz*g(100) &
            + g(260)
         vbuf(235) = abx*abx*cdz*g(102) &
            + abx*abx*g(282) &
            + 2.0_dp*abx*cdz*g(105) &
            + 2.0_dp*abx*g(285) &
            + cdz*g(111) &
            + g(291)
         vbuf(236) = abx*abx*cdz*g(103) &
            + abx*abx*g(283) &
            + 2.0_dp*abx*cdz*g(106) &
            + 2.0_dp*abx*g(286) &
            + cdz*g(112) &
            + g(292)
         vbuf(237) = abx*abx*cdz*g(104) &
            + abx*abx*g(284) &
            + 2.0_dp*abx*cdz*g(107) &
            + 2.0_dp*abx*g(287) &
            + cdz*g(113) &
            + g(293)
         vbuf(238) = abx*aby*cdz*g(102) &
            + abx*aby*g(282) &
            + abx*cdz*g(106) &
            + abx*g(286) &
            + aby*cdz*g(105) &
         ...
         vbuf(243) = abx*abz*cdz*g(104) &
            ...
            + cdz*g(116) &
            + g(296)
         vbuf(244) = aby*aby*cdz*g(102) &
            + aby*aby*g(282) &
            + 2.0_dp*aby*cdz*g(106) &
            + 2.0_dp*aby*g(286) &
            + cdz*g(114) &
            + g(294)
         vbuf(245) = aby*aby*cdz*g(103) &
            + aby*aby*g(283) &
            + 2.0_dp*aby*cdz*g(108) &
            + 2.0_dp*aby*g(288) &
            + cdz*g(117) &
            + g(297)
         vbuf(246) = aby*aby*cdz*g(104) &
            + aby*aby*g(284) &
            + 2.0_dp*aby*cdz*g(109) &
            + 2.0_dp*aby*g(289) &
            + cdz*g(118) &
            + g(298)
         vbuf(247) = aby*abz*cdz*g(102) &
            + aby*abz*g(282) &
            + aby*cdz*g(107) &
            + aby*g(287) &
            + abz*cdz*g(106) &
         ...
         vbuf(249) = aby*abz*cdz*g(104) &
            ...
            + cdz*g(119) &
            + g(299)
         vbuf(250) = abz*abz*cdz*g(102) &
            + abz*abz*g(282) &
            + 2.0_dp*abz*cdz*g(107) &
            + 2.0_dp*abz*g(287) &
            + cdz*g(116) &
            + g(296)
         vbuf(251) = abz*abz*cdz*g(103) &
            + abz*abz*g(283) &
            + 2.0_dp*abz*cdz*g(109) &
            + 2.0_dp*abz*g(289) &
            + cdz*g(119) &
            + g(299)
         vbuf(252) = abz*abz*cdz*g(104) &
            + abz*abz*g(284) &
            + 2.0_dp*abz*cdz*g(110) &
            + 2.0_dp*abz*g(290) &
            + cdz*g(120) &
            + g(300)
         vbuf(253) = abx*abx*cdz*g(122) &
            + abx*abx*g(302) &
            + 2.0_dp*abx*cdz*g(125) &
            + 2.0_dp*abx*g(305) &
            + cdz*g(131) &
            + g(311)
         vbuf(254) = abx*abx*cdz*g(123) &
            + abx*abx*g(303) &
            + 2.0_dp*abx*cdz*g(126) &
            + 2.0_dp*abx*g(306) &
            + cdz*g(132) &
            + g(312)
         vbuf(255) = abx*abx*cdz*g(124) &
            + abx*abx*g(304) &
            + 2.0_dp*abx*cdz*g(127) &
            + 2.0_dp*abx*g(307) &
            + cdz*g(133) &
            + g(313)
         vbuf(256) = abx*aby*cdz*g(122) &
            + abx*aby*g(302) &
            + abx*cdz*g(126) &
            + abx*g(306) &
            + aby*cdz*g(125) &
         ...
         vbuf(261) = abx*abz*cdz*g(124) &
            ...
            + cdz*g(136) &
            + g(316)
         vbuf(262) = aby*aby*cdz*g(122) &
            + aby*aby*g(302) &
            + 2.0_dp*aby*cdz*g(126) &
            + 2.0_dp*aby*g(306) &
            + cdz*g(134) &
            + g(314)
         vbuf(263) = aby*aby*cdz*g(123) &
            + aby*aby*g(303) &
            + 2.0_dp*aby*cdz*g(128) &
            + 2.0_dp*aby*g(308) &
            + cdz*g(137) &
            + g(317)
         vbuf(264) = aby*aby*cdz*g(124) &
            + aby*aby*g(304) &
            + 2.0_dp*aby*cdz*g(129) &
            + 2.0_dp*aby*g(309) &
            + cdz*g(138) &
            + g(318)
         vbuf(265) = aby*abz*cdz*g(122) &
            + aby*abz*g(302) &
            + aby*cdz*g(127) &
            + aby*g(307) &
            + abz*cdz*g(126) &
         ...
         vbuf(267) = aby*abz*cdz*g(124) &
            ...
            + cdz*g(139) &
            + g(319)
         vbuf(268) = abz*abz*cdz*g(122) &
            + abz*abz*g(302) &
            + 2.0_dp*abz*cdz*g(127) &
            + 2.0_dp*abz*g(307) &
            + cdz*g(136) &
            + g(316)
         vbuf(269) = abz*abz*cdz*g(123) &
            + abz*abz*g(303) &
            + 2.0_dp*abz*cdz*g(129) &
            + 2.0_dp*abz*g(309) &
            + cdz*g(139) &
            + g(319)
         vbuf(270) = abz*abz*cdz*g(124) &
            + abz*abz*g(304) &
            + 2.0_dp*abz*cdz*g(130) &
            + 2.0_dp*abz*g(310) &
            + cdz*g(140) &
            + g(320)
         vbuf(271) = abx*abx*cdz*g(142) &
            + abx*abx*g(342) &
            + 2.0_dp*abx*cdz*g(145) &
            + 2.0_dp*abx*g(345) &
            + cdz*g(151) &
            + g(351)
         vbuf(272) = abx*abx*cdz*g(143) &
            + abx*abx*g(343) &
            + 2.0_dp*abx*cdz*g(146) &
            + 2.0_dp*abx*g(346) &
            + cdz*g(152) &
            + g(352)
         vbuf(273) = abx*abx*cdz*g(144) &
            + abx*abx*g(344) &
            + 2.0_dp*abx*cdz*g(147) &
            + 2.0_dp*abx*g(347) &
            + cdz*g(153) &
            + g(353)
         vbuf(274) = abx*aby*cdz*g(142) &
            + abx*aby*g(342) &
            + abx*cdz*g(146) &
            + abx*g(346) &
            + aby*cdz*g(145) &
         ...
         vbuf(279) = abx*abz*cdz*g(144) &
            ...
            + cdz*g(156) &
            + g(356)
         vbuf(280) = aby*aby*cdz*g(142) &
            + aby*aby*g(342) &
            + 2.0_dp*aby*cdz*g(146) &
            + 2.0_dp*aby*g(346) &
            + cdz*g(154) &
            + g(354)
         vbuf(281) = aby*aby*cdz*g(143) &
            + aby*aby*g(343) &
            + 2.0_dp*aby*cdz*g(148) &
            + 2.0_dp*aby*g(348) &
            + cdz*g(157) &
            + g(357)
         vbuf(282) = aby*aby*cdz*g(144) &
            + aby*aby*g(344) &
            + 2.0_dp*aby*cdz*g(149) &
            + 2.0_dp*aby*g(349) &
            + cdz*g(158) &
            + g(358)
         vbuf(283) = aby*abz*cdz*g(142) &
            + aby*abz*g(342) &
            + aby*cdz*g(147) &
            + aby*g(347) &
            + abz*cdz*g(146) &
         ...
         vbuf(285) = aby*abz*cdz*g(144) &
            ...
            + cdz*g(159) &
            + g(359)
         vbuf(286) = abz*abz*cdz*g(142) &
            + abz*abz*g(342) &
            + 2.0_dp*abz*cdz*g(147) &
            + 2.0_dp*abz*g(347) &
            + cdz*g(156) &
            + g(356)
         vbuf(287) = abz*abz*cdz*g(143) &
            + abz*abz*g(343) &
            + 2.0_dp*abz*cdz*g(149) &
            + 2.0_dp*abz*g(349) &
            + cdz*g(159) &
            + g(359)
         vbuf(288) = abz*abz*cdz*g(144) &
            + abz*abz*g(344) &
            + 2.0_dp*abz*cdz*g(150) &
            + 2.0_dp*abz*g(350) &
            + cdz*g(160) &
            + g(360)
         vbuf(289) = abx*abx*cdz*g(162) &
            + abx*abx*g(362) &
            + 2.0_dp*abx*cdz*g(165) &
            + 2.0_dp*abx*g(365) &
            + cdz*g(171) &
            + g(371)
         vbuf(290) = abx*abx*cdz*g(163) &
            + abx*abx*g(363) &
            + 2.0_dp*abx*cdz*g(166) &
            + 2.0_dp*abx*g(366) &
            + cdz*g(172) &
            + g(372)
         vbuf(291) = abx*abx*cdz*g(164) &
            + abx*abx*g(364) &
            + 2.0_dp*abx*cdz*g(167) &
            + 2.0_dp*abx*g(367) &
            + cdz*g(173) &
            + g(373)
         vbuf(292) = abx*aby*cdz*g(162) &
            + abx*aby*g(362) &
            + abx*cdz*g(166) &
            + abx*g(366) &
            + aby*cdz*g(165) &
         ...
         vbuf(297) = abx*abz*cdz*g(164) &
            ...
            + cdz*g(176) &
            + g(376)
         vbuf(298) = aby*aby*cdz*g(162) &
            + aby*aby*g(362) &
            + 2.0_dp*aby*cdz*g(166) &
            + 2.0_dp*aby*g(366) &
            + cdz*g(174) &
            + g(374)
         vbuf(299) = aby*aby*cdz*g(163) &
            + aby*aby*g(363) &
            + 2.0_dp*aby*cdz*g(168) &
            + 2.0_dp*aby*g(368) &
            + cdz*g(177) &
            + g(377)
         vbuf(300) = aby*aby*cdz*g(164) &
            + aby*aby*g(364) &
            + 2.0_dp*aby*cdz*g(169) &
            + 2.0_dp*aby*g(369) &
            + cdz*g(178) &
            + g(378)
         vbuf(301) = aby*abz*cdz*g(162) &
            + aby*abz*g(362) &
            + aby*cdz*g(167) &
            + aby*g(367) &
            + abz*cdz*g(166) &
         ...
         vbuf(303) = aby*abz*cdz*g(164) &
            ...
            + cdz*g(179) &
            + g(379)
         vbuf(304) = abz*abz*cdz*g(162) &
            + abz*abz*g(362) &
            + 2.0_dp*abz*cdz*g(167) &
            + 2.0_dp*abz*g(367) &
            + cdz*g(176) &
            + g(376)
         vbuf(305) = abz*abz*cdz*g(163) &
            + abz*abz*g(363) &
            + 2.0_dp*abz*cdz*g(169) &
            + 2.0_dp*abz*g(369) &
            + cdz*g(179) &
            + g(379)
         vbuf(306) = abz*abz*cdz*g(164) &
            + abz*abz*g(364) &
            + 2.0_dp*abz*cdz*g(170) &
            + 2.0_dp*abz*g(370) &
            + cdz*g(180) &
            + g(380)
         vbuf(307) = abx*abx*cdz*g(182) &
            + abx*abx*g(382) &
            + 2.0_dp*abx*cdz*g(185) &
            + 2.0_dp*abx*g(385) &
            + cdz*g(191) &
            + g(391)
         vbuf(308) = abx*abx*cdz*g(183) &
            + abx*abx*g(383) &
            + 2.0_dp*abx*cdz*g(186) &
            + 2.0_dp*abx*g(386) &
            + cdz*g(192) &
            + g(392)
         vbuf(309) = abx*abx*cdz*g(184) &
            + abx*abx*g(384) &
            + 2.0_dp*abx*cdz*g(187) &
            + 2.0_dp*abx*g(387) &
            + cdz*g(193) &
            + g(393)
         vbuf(310) = abx*aby*cdz*g(182) &
            + abx*aby*g(382) &
            + abx*cdz*g(186) &
            + abx*g(386) &
            + aby*cdz*g(185) &
         ...
         vbuf(315) = abx*abz*cdz*g(184) &
            ...
            + cdz*g(196) &
            + g(396)
         vbuf(316) = aby*aby*cdz*g(182) &
            + aby*aby*g(382) &
            + 2.0_dp*aby*cdz*g(186) &
            + 2.0_dp*aby*g(386) &
            + cdz*g(194) &
            + g(394)
         vbuf(317) = aby*aby*cdz*g(183) &
            + aby*aby*g(383) &
            + 2.0_dp*aby*cdz*g(188) &
            + 2.0_dp*aby*g(388) &
            + cdz*g(197) &
            + g(397)
         vbuf(318) = aby*aby*cdz*g(184) &
            + aby*aby*g(384) &
            + 2.0_dp*aby*cdz*g(189) &
            + 2.0_dp*aby*g(389) &
            + cdz*g(198) &
            + g(398)
         vbuf(319) = aby*abz*cdz*g(182) &
            + aby*abz*g(382) &
            + aby*cdz*g(187) &
            + aby*g(387) &
            + abz*cdz*g(186) &
         ...
         vbuf(321) = aby*abz*cdz*g(184) &
            ...
            + cdz*g(199) &
            + g(399)
         vbuf(322) = abz*abz*cdz*g(182) &
            + abz*abz*g(382) &
            + 2.0_dp*abz*cdz*g(187) &
            + 2.0_dp*abz*g(387) &
            + cdz*g(196) &
            + g(396)
         vbuf(323) = abz*abz*cdz*g(183) &
            + abz*abz*g(383) &
            + 2.0_dp*abz*cdz*g(189) &
            + 2.0_dp*abz*g(389) &
            + cdz*g(199) &
            + g(399)
         vbuf(324) = abz*abz*cdz*g(184) &
            + abz*abz*g(384) &
