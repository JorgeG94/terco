   ...
   pure subroutine pci0220(gt, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, &
      ...
      ! locate the segment
         ...
         vbuf(9) = abx*abz*g(51) &
            ...
            + abz*g(52) &
            + g(57)
         vbuf(10) = aby*aby*g(51) &
            + 2.0_dp*aby*g(53) &
            + g(58)
         vbuf(11) = aby*abz*g(51) &
            + aby*g(54) &
            + abz*g(53) &
            + g(59)
         vbuf(12) = abz*abz*g(51) &
            + 2.0_dp*abz*g(54) &
            + g(60)
         vbuf(13) = abx*abx*g(61) &
            + 2.0_dp*abx*g(62) &
            + g(65)
         vbuf(14) = abx*aby*g(61) &
            + abx*g(63) &
            + aby*g(62) &
            + g(66)
         vbuf(15) = abx*abz*g(61) &
            + abx*g(64) &
            + abz*g(62) &
            + g(67)
         vbuf(16) = aby*aby*g(61) &
            + 2.0_dp*aby*g(63) &
            + g(68)
         vbuf(17) = aby*abz*g(61) &
            + aby*g(64) &
            + abz*g(63) &
            + g(69)
         vbuf(18) = abz*abz*g(61) &
            + 2.0_dp*abz*g(64) &
            + g(70)
         vbuf(19) = abx*abx*g(71) &
            + 2.0_dp*abx*g(72) &
            + g(75)
         vbuf(20) = abx*aby*g(71) &
            + abx*g(73) &
            + aby*g(72) &
            + g(76)
         vbuf(21) = abx*abz*g(71) &
            + abx*g(74) &
            + abz*g(72) &
            + g(77)
         vbuf(22) = aby*aby*g(71) &
            + 2.0_dp*aby*g(73) &
            + g(78)
         vbuf(23) = aby*abz*g(71) &
            + aby*g(74) &
            + abz*g(73) &
            + g(79)
         vbuf(24) = abz*abz*g(71) &
            + 2.0_dp*abz*g(74) &
            + g(80)
         vbuf(25) = abx*abx*g(81) &
            + 2.0_dp*abx*g(82) &
            + g(85)
         vbuf(26) = abx*aby*g(81) &
            + abx*g(83) &
            + aby*g(82) &
            + g(86)
         vbuf(27) = abx*abz*g(81) &
            + abx*g(84) &
            + abz*g(82) &
            + g(87)
         vbuf(28) = aby*aby*g(81) &
            + 2.0_dp*aby*g(83) &
            + g(88)
         vbuf(29) = aby*abz*g(81) &
            + aby*g(84) &
            + abz*g(83) &
            + g(89)
         vbuf(30) = abz*abz*g(81) &
            + 2.0_dp*abz*g(84) &
            + g(90)
         vbuf(31) = abx*abx*g(91) &
            + 2.0_dp*abx*g(92) &
            + g(95)
         vbuf(32) = abx*aby*g(91) &
            + abx*g(93) &
            + aby*g(92) &
            + g(96)
         vbuf(33) = abx*abz*g(91) &
            + abx*g(94) &
            + abz*g(92) &
            + g(97)
         vbuf(34) = aby*aby*g(91) &
            + 2.0_dp*aby*g(93) &
            + g(98)
         vbuf(35) = aby*abz*g(91) &
            + aby*g(94) &
            + abz*g(93) &
            + g(99)
         vbuf(36) = abz*abz*g(91) &
            + 2.0_dp*abz*g(94) &
            + g(100)
