!
! Class (01|11) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0111(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: v(40, 0:1), g1(40), vbuf(27)
      ...
      real(dp) :: jab(3), jcd(9), kac(3)
      real(dp) :: kad(3), kbc(9), kbd(9)
      real(dp) :: dab(3), dcd(9), dac(3)
      ...
      if (gt > gend) return
         ...
         vbuf(6) = abz*cdx*g1(9) &
            ...
            + cdx*g1(12) &
            + g1(24)
         vbuf(7) = abx*cdx*g1(13) &
            + abx*g1(25) &
            + cdx*g1(14) &
            + g1(26)
         vbuf(8) = aby*cdx*g1(13) &
            + aby*g1(25) &
            + cdx*g1(15) &
            + g1(27)
         vbuf(9) = abz*cdx*g1(13) &
            + abz*g1(25) &
            + cdx*g1(16) &
            + g1(28)
         vbuf(10) = abx*cdy*g1(5) &
            + abx*g1(21) &
            + cdy*g1(6) &
            + g1(22)
         vbuf(11) = aby*cdy*g1(5) &
            + aby*g1(21) &
            + cdy*g1(7) &
            + g1(23)
         vbuf(12) = abz*cdy*g1(5) &
            + abz*g1(21) &
            + cdy*g1(8) &
            + g1(24)
         vbuf(13) = abx*cdy*g1(9) &
            + abx*g1(29) &
            + cdy*g1(10) &
            + g1(30)
         vbuf(14) = aby*cdy*g1(9) &
            + aby*g1(29) &
            + cdy*g1(11) &
            + g1(31)
         vbuf(15) = abz*cdy*g1(9) &
            + abz*g1(29) &
            + cdy*g1(12) &
            + g1(32)
         vbuf(16) = abx*cdy*g1(13) &
            + abx*g1(33) &
            + cdy*g1(14) &
            + g1(34)
         vbuf(17) = aby*cdy*g1(13) &
            + aby*g1(33) &
            + cdy*g1(15) &
            + g1(35)
         vbuf(18) = abz*cdy*g1(13) &
            + abz*g1(33) &
            + cdy*g1(16) &
            + g1(36)
         vbuf(19) = abx*cdz*g1(5) &
            + abx*g1(25) &
            + cdz*g1(6) &
            + g1(26)
         vbuf(20) = aby*cdz*g1(5) &
            + aby*g1(25) &
            + cdz*g1(7) &
            + g1(27)
         vbuf(21) = abz*cdz*g1(5) &
            + abz*g1(25) &
            + cdz*g1(8) &
            + g1(28)
         vbuf(22) = abx*cdz*g1(9) &
            + abx*g1(33) &
            + cdz*g1(10) &
            + g1(34)
         vbuf(23) = aby*cdz*g1(9) &
            + aby*g1(33) &
            + cdz*g1(11) &
            + g1(35)
         vbuf(24) = abz*cdz*g1(9) &
            + abz*g1(33) &
            + cdz*g1(12) &
            + g1(36)
         vbuf(25) = abx*cdz*g1(13) &
            + abx*g1(37) &
            + cdz*g1(14) &
            + g1(38)
         vbuf(26) = aby*cdz*g1(13) &
            + aby*g1(37) &
            + cdz*g1(15) &
            + g1(39)
         vbuf(27) = abz*cdz*g1(13) &
            + abz*g1(37) &
            + cdz*g1(16) &
            + g1(40)
   ...
   end subroutine pg0111
#endif
end module trc_pg_k0111
