!
! Class (00|22) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0022(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      if (gt > gend) return
         ...
         vbuf(9) = cdx*cdy*g1(7) &
            ...
            + cdy*g1(13) &
            + g1(25)
         vbuf(10) = cdx*cdy*g1(8) &
            + cdx*g1(17) &
            + cdy*g1(14) &
            + g1(27)
         vbuf(11) = cdx*cdy*g1(9) &
            + cdx*g1(18) &
            + cdy*g1(15) &
            + g1(28)
         vbuf(12) = cdx*cdy*g1(10) &
            + cdx*g1(19) &
            + cdy*g1(16) &
            + g1(29)
         vbuf(13) = cdx*cdz*g1(5) &
            + cdx*g1(13) &
            + cdz*g1(11) &
            + g1(23)
         vbuf(14) = cdx*cdz*g1(6) &
            + cdx*g1(15) &
            + cdz*g1(12) &
            + g1(25)
         vbuf(15) = cdx*cdz*g1(7) &
            + cdx*g1(16) &
            + cdz*g1(13) &
            + g1(26)
         vbuf(16) = cdx*cdz*g1(8) &
            + cdx*g1(18) &
            + cdz*g1(14) &
            + g1(28)
         vbuf(17) = cdx*cdz*g1(9) &
            + cdx*g1(19) &
            + cdz*g1(15) &
            + g1(29)
         vbuf(18) = cdx*cdz*g1(10) &
            + cdx*g1(20) &
            + cdz*g1(16) &
            + g1(30)
         vbuf(19) = cdy*cdy*g1(5) &
            + 2.0_dp*cdy*g1(12) &
            + g1(24)
         vbuf(20) = cdy*cdy*g1(6) &
            + 2.0_dp*cdy*g1(14) &
            + g1(27)
         vbuf(21) = cdy*cdy*g1(7) &
            + 2.0_dp*cdy*g1(15) &
            + g1(28)
         vbuf(22) = cdy*cdy*g1(8) &
            + 2.0_dp*cdy*g1(17) &
            + g1(31)
         vbuf(23) = cdy*cdy*g1(9) &
            + 2.0_dp*cdy*g1(18) &
            + g1(32)
         vbuf(24) = cdy*cdy*g1(10) &
            + 2.0_dp*cdy*g1(19) &
            + g1(33)
         vbuf(25) = cdy*cdz*g1(5) &
            + cdy*g1(13) &
            + cdz*g1(12) &
            + g1(25)
         vbuf(26) = cdy*cdz*g1(6) &
            + cdy*g1(15) &
            + cdz*g1(14) &
            + g1(28)
         vbuf(27) = cdy*cdz*g1(7) &
            + cdy*g1(16) &
            + cdz*g1(15) &
            + g1(29)
         vbuf(28) = cdy*cdz*g1(8) &
            + cdy*g1(18) &
            + cdz*g1(17) &
            + g1(32)
         vbuf(29) = cdy*cdz*g1(9) &
            + cdy*g1(19) &
            + cdz*g1(18) &
            + g1(33)
         vbuf(30) = cdy*cdz*g1(10) &
            + cdy*g1(20) &
            + cdz*g1(19) &
            + g1(34)
         vbuf(31) = cdz*cdz*g1(5) &
            + 2.0_dp*cdz*g1(13) &
            + g1(26)
         vbuf(32) = cdz*cdz*g1(6) &
            + 2.0_dp*cdz*g1(15) &
            + g1(29)
         vbuf(33) = cdz*cdz*g1(7) &
            + 2.0_dp*cdz*g1(16) &
            + g1(30)
         vbuf(34) = cdz*cdz*g1(8) &
            + 2.0_dp*cdz*g1(18) &
            + g1(33)
         vbuf(35) = cdz*cdz*g1(9) &
            + 2.0_dp*cdz*g1(19) &
            + g1(34)
         vbuf(36) = cdz*cdz*g1(10) &
            + 2.0_dp*cdz*g1(20) &
            + g1(35)
   ...
   end subroutine pg0022
#endif
end module trc_pg_k0022
