!
! Class (00|21) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg0021(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(1), jcd(18), kac(6)
      real(dp) :: kad(3), kbc(6), kbd(3)
      real(dp) :: dab(1), dcd(18), dac(6)
      real(dp) :: dad(3), dbc(6), dbd(3)
   ...
   end subroutine pg0021
#endif
end module trc_pg_k0021
