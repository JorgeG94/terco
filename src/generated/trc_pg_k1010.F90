!
! Class (10|10) cooperative kernel, CUDA Fortran.
!
...
contains
   ...
   attributes(global) subroutine pg1010(g0, gend, nranks, lo, hi, nseg, sOff, sA, sNB, sOA, sOB, sD, npair, sp_i, sp_j, sp_q, thresh, jfac, kfac, dsh, nbas, npp, nao, sh_l, ao_off, pp_off, pp_n, pp_p, pp_r, pp_ra, pp_rb, pp_c, pp_cs, pp_ki, pp_kj, ncoltot, ncoef, ps_np, ps_ncol, ps_soff, ps_coff, col_ao, ps_coef, boys_d, ndens, dmat, jmat)
      ...
      real(dp) :: jab(3), jcd(3), kac(9)
      real(dp) :: kad(3), kbc(3), kbd(1)
      real(dp) :: dab(3), dcd(3), dac(9)
      real(dp) :: dad(3), dbc(3), dbd(1)
   ...
   end subroutine pg1010
#endif
end module trc_pg_k1010
